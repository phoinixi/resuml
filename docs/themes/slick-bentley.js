...
var Ot=Object.create;var W=Object.defineProperty;var zt=Object.getOwnPropertyDescriptor;var vt=Object.getOwnPropertyNames;var Lt=Object.getPrototypeOf,bt=Object.prototype.hasOwnProperty;var v=(A=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(A,{get:(t,e)=>(typeof require<"u"?require:t)[e]}):A)(function(A){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+A+'" is not supported')});var GA=(A,t)=>()=>(A&&(t=A(A=0)),t);var w=(A,t)=>()=>(t||A((t={exports:{}}).exports,t),t.exports),jt=(A,t)=>{for(var e in t)W(A,e,{get:t[e],enumerable:!0})},TA=(A,t,e,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let B of vt(t))!bt.call(A,B)&&B!==e&&W(A,B,{get:()=>t[B],enumerable:!(n=zt(t,B))||n.enumerable});return A};var Kt=(A,t,e)=>(e=A!=null?Ot(Lt(A)):{},TA(t||!A||!A.__esModule?W(e,"default",{value:A,enumerable:!0}):e,A)),PA=A=>TA(W({},"__esModule",{value:!0}),A);var Q=GA(()=>{});var aA={};jt(aA,{createReadStream:()=>WA,createWriteStream:()=>ZA,default:()=>Xt,existsSync:()=>LA,lstatSync:()=>KA,mkdirSync:()=>jA,readFileSync:()=>zA,readdirSync:()=>vA,rmdirSync:()=>VA,statSync:()=>QA,unlinkSync:()=>XA,writeFileSync:()=>bA});function rA(A){return String(A).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function OA(A){var t=rA(A);if(Z[t]!==void 0)return Z[t];for(var e=Object.keys(Z),n=0;n<e.length;n++)if(t.endsWith("/"+e[n])||t===e[n])return Z[e[n]]}function EA(A){var t=rA(A);if((t===""||t===".")&&T["."]!==void 0)return T["."];if(T[t]!==void 0)return T[t];for(var e=Object.keys(T),n=0;n<e.length;n++)if(t.endsWith("/"+e[n])||t===e[n])return T[e[n]]}var Z,T,zA,vA,LA,bA,jA,QA,KA,XA,VA,WA,ZA,Xt,oA=GA(()=>{"use strict";Q();Z={"package.json":`{
