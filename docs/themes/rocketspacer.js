var In=Object.create;var E=Object.defineProperty;var Rn=Object.getOwnPropertyDescriptor;var Mn=Object.getOwnPropertyNames;var Wn=Object.getPrototypeOf,zn=Object.prototype.hasOwnProperty;var O=(n,r)=>()=>(n&&(r=n(n=0)),r);var y=(n,r)=>()=>(r||n((r={exports:{}}).exports,r),r.exports),q=(n,r)=>{for(var e in r)E(n,e,{get:r[e],enumerable:!0})},H=(n,r,e,t)=>{if(r&&typeof r=="object"||typeof r=="function")for(let s of Mn(r))!zn.call(n,s)&&s!==e&&E(n,s,{get:()=>r[s],enumerable:!(t=Rn(r,s))||t.enumerable});return n};var Jn=(n,r,e)=>(e=n!=null?In(Wn(n)):{},H(r||!n||!n.__esModule?E(e,"default",{value:n,enumerable:!0}):e,n)),j=n=>H(E({},"__esModule",{value:!0}),n);var l=O(()=>{});var T={};q(T,{basename:()=>S,default:()=>Vn,dirname:()=>P,extname:()=>D,isAbsolute:()=>Z,join:()=>G,normalize:()=>Y,parse:()=>K,relative:()=>Q,resolve:()=>X,sep:()=>$});var G,X,P,S,D,$,Z,Y,Q,K,Vn,F=O(()=>{"use strict";l();G=function(){return[].slice.call(arguments).join("/")},X=function(){return[].slice.call(arguments).join("/")},P=function(n){return n.split("/").slice(0,-1).join("/")},S=function(n,r){var e=n.split("/").pop()||"";return r&&e.endsWith(r)?e.slice(0,-r.length):e},D=function(n){var r=n.match(/\.[^.]+$/);return r?r[0]:""},$="/",Z=function(n){return n.charAt(0)==="/"},Y=function(n){return n},Q=function(n,r){return r},K=function(n){return{root:"",dir:P(n),base:S(n),ext:D(n),name:S(n,D(n))}},Vn={join:G,resolve:X,dirname:P,basename:S,extname:D,sep:$,isAbsolute:Z,normalize:Y,relative:Q,parse:K}});var M={};q(M,{createReadStream:()=>pn,createWriteStream:()=>un,default:()=>Bn,existsSync:()=>rn,lstatSync:()=>on,mkdirSync:()=>an,readFileSync:()=>en,readdirSync:()=>tn,rmdirSync:()=>ln,statSync:()=>R,unlinkSync:()=>cn,writeFileSync:()=>sn});function I(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function nn(n){var r=I(n);if(A[r]!==void 0)return A[r];for(var e=Object.keys(A),t=0;t<e.length;t++)if(r.endsWith("/"+e[t])||r===e[t])return A[e[t]]}function N(n){var r=I(n);if(L[r]!==void 0)return L[r];for(var e=Object.keys(L),t=0;t<e.length;t++)if(r.endsWith("/"+e[t])||r===e[t])return L[e[t]]}var A,L,en,tn,rn,sn,an,R,on,cn,ln,pn,un,Bn,W=O(()=>{"use strict";l();A={"assets/stylesheets/style.css":`@import url('https://fonts.googleapis.com/css?family=Lato:300,400,700');
...
`,u.message+="Or, if you meant to create an async function, pass `async: true` as an option.")),u}var _=e.client?r:function(B){var Fn=function(Nn,U){var C=o.shallowCopy(o.createNullProtoObjWherePossible(),B);return U&&(C=o.shallowCopy(C,U)),ae(Nn,e)(C)};return r.apply(e.context,[B||o.createNullProtoObjWherePossible(),a,Fn,wn])};if(e.filename&&typeof Object.defineProperty=="function"){var b=e.filename,Tn=x.basename(b,x.extname(b));try{Object.defineProperty(_,"name",{value:Tn,writable:!1,enumerable:!1,configurable:!0})}catch{}}return _},generateSource:function(){var n=this.opts;n.rmWhitespace&&(this.templateText=this.templateText.replace(/[\r\n]+/g,`
...
`)}};i.escapeXML=o.escapeXML;i.__express=i.renderFile;i.VERSION=Yn;i.name=ee;typeof window<"u"&&(window.ejs=i)});var jn=y((xe,En)=>{l();var oe=["January","February","March","April","May","June","July","August","September","October","November","December"];En.exports=n=>{if(!n)return n;let r=new Date(n);return`${oe[r.getMonth()]} ${r.getFullYear()}`}});var Dn=y((_e,Sn)=>{l();var ce=jn();Sn.exports={prettyDate:ce}});var On=y(Cn=>{l();var An=(F(),j(T)),Ln=(W(),j(M)),le=_n(),pe=Dn();Cn.render=n=>{let r=An.join("/","views/resume.ejs"),e=le.compile(Ln.readFileSync(r,"utf8"),{filename:r,context:{...pe}}),t=Ln.readFileSync(An.join("/","assets/stylesheets/style.css"),"utf8");return e({css:t,resume:n})}});l();var v=Jn(On(),1),Pn=v.default??v,De=Pn.render??v.render,Ae=Pn.pdfRenderOptions??v.pdfRenderOptions;export{Ae as pdfRenderOptions,De as render};
