...
var Qi=Object.create;var De=Object.defineProperty;var Yi=Object.getOwnPropertyDescriptor;var Zi=Object.getOwnPropertyNames;var ki=Object.getPrototypeOf,na=Object.prototype.hasOwnProperty;var Ot=(f,v)=>()=>(f&&(v=f(f=0)),v);var En=(f,v)=>()=>(v||f((v={exports:{}}).exports,v),v.exports),ea=(f,v)=>{for(var R in v)De(f,R,{get:v[R],enumerable:!0})},St=(f,v,R,D)=>{if(v&&typeof v=="object"||typeof v=="function")for(let O of Zi(v))!na.call(f,O)&&O!==R&&De(f,O,{get:()=>v[O],enumerable:!(D=Yi(v,O))||D.enumerable});return f};var ta=(f,v,R)=>(R=f!=null?Qi(ki(f)):{},St(v||!f||!f.__esModule?De(R,"default",{value:f,enumerable:!0}):R,f)),ra=f=>St(De({},"__esModule",{value:!0}),f);var A=Ot(()=>{});var Lt={};ea(Lt,{createReadStream:()=>Nt,createWriteStream:()=>At,default:()=>ia,existsSync:()=>Ft,lstatSync:()=>Pt,mkdirSync:()=>Mt,readFileSync:()=>Tt,readdirSync:()=>jt,rmdirSync:()=>zt,statSync:()=>Qe,unlinkSync:()=>Ut,writeFileSync:()=>It});function Je(f){return String(f).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Rt(f){var v=Je(f);if(Ee[v]!==void 0)return Ee[v];for(var R=Object.keys(Ee),D=0;D<R.length;D++)if(v.endsWith("/"+R[D])||v===R[D])return Ee[R[D]]}function Ve(f){var v=Je(f);if((v===""||v===".")&&Xn["."]!==void 0)return Xn["."];if(Xn[v]!==void 0)return Xn[v];for(var R=Object.keys(Xn),D=0;D<R.length;D++)if(v.endsWith("/"+R[D])||v===R[D])return Xn[R[D]]}var Ee,Xn,Tt,jt,Ft,It,Mt,Qe,Pt,Ut,zt,Nt,At,ia,qt=Ot(()=>{"use strict";A();Ee={"package.json":`{
...
*/`;try{var pn=K(a,"return "+w+X).apply(f,s)}catch(dn){throw dn.source=w,dn}return e?pn(e):(pn.source=w,pn)}function Ki(n,e,t){n=(n=+n)>-1?n:0;var r=-1,i=F(n);for(e=ln(e,t,1);++r<n;)i[r]=e(r);return i}function Wi(n){return n==null?"":In(n).replace(Cr,_r)}function Xi(n){var e=++D;return In(n??"")+e}function $i(n){return n=new Nn(n),n.__chain__=!0,n}function Gi(n,e){return e(n),n}function Vi(){return this.__chain__=!0,this}function Ji(){return In(this.__wrapped__)}function Et(){return this.__wrapped__}return o.after=xi,o.assign=ye,o.at=Vr,o.bind=_t,o.bindAll=Ci,o.bindKey=Di,o.chain=$i,o.compact=si,o.compose=Ei,o.constant=Ui,o.countBy=Jr,o.create=Sr,o.createCallback=zi,o.curry=Oi,o.debounce=xt,o.defaults=Ae,o.defer=Si,o.delay=Ri,o.difference=ui,o.filter=_e,o.flatten=pi,o.forEach=sn,o.forEachRight=xe,o.forIn=Tn,o.forInRight=jr,o.forOwn=$,o.forOwnRight=st,o.functions=re,o.groupBy=Yr,o.indexBy=Zr,o.initial=hi,o.intersection=di,o.invert=ut,o.invoke=kr,o.keys=an,o.map=ae,o.mapValues=Br,o.max=ht,o.memoize=Ti,o.merge=Kr,o.min=ni,o.omit=Wr,o.once=ji,o.pairs=Xr,o.partial=Fi,o.partialRight=Ii,o.pick=$r,o.pluck=He,o.property=Dt,o.pull=mi,o.range=vi,o.reject=ei,o.remove=bi,o.rest=We,o.shuffle=ct,o.sortBy=ii,o.tap=Gi,o.throttle=Mi,o.times=Ki,o.toArray=ai,o.transform=Gr,o.union=yi,o.uniq=bt,o.values=we,o.where=oi,o.without=wi,o.wrap=Pi,o.xor=_i,o.zip=yt,o.zipObject=wt,o.collect=ae,o.drop=We,o.each=sn,o.eachRight=xe,o.extend=ye,o.methods=re,o.object=wt,o.select=_e,o.tail=We,o.unique=bt,o.unzip=yt,$e(o),o.clone=Er,o.cloneDeep=Or,o.contains=lt,o.escape=Ni,o.every=pt,o.find=qe,o.findIndex=fi,o.findKey=Rr,o.findLast=Qr,o.findLastIndex=li,o.findLastKey=Tr,o.has=Fr,o.identity=Xe,o.indexOf=mt,o.isArguments=be,o.isArray=Z,o.isBoolean=Ir,o.isDate=Mr,o.isElement=Pr,o.isEmpty=Ur,o.isEqual=zr,o.isFinite=Nr,o.isFunction=J,o.isNaN=Ar,o.isNull=Lr,o.isNumber=ft,o.isObject=on,o.isPlainObject=Le,o.isRegExp=qr,o.isString=ie,o.isUndefined=Hr,o.lastIndexOf=gi,o.mixin=$e,o.noConflict=Ai,o.noop=Ct,o.now=An,o.parseInt=Li,o.random=qi,o.reduce=Be,o.reduceRight=dt,o.result=Hi,o.runInContext=Te,o.size=ri,o.some=gt,o.sortedIndex=vt,o.template=Bi,o.unescape=Wi,o.uniqueId=Xi,o.all=pt,o.any=gt,o.detect=qe,o.findWhere=qe,o.foldl=Be,o.foldr=dt,o.include=lt,o.inject=Be,$e((function(){var n={};return $(o,function(e,t){o.prototype[t]||(n[t]=e)}),n})(),!1),o.first=Ke,o.last=ci,o.sample=ti,o.take=Ke,o.head=Ke,$(o,function(n,e){var t=e!=="sample";o.prototype[e]||(o.prototype[e]=function(r,i){var a=this.__chain__,s=n(this.__wrapped__,r,i);return!a&&(r==null||i&&!(t&&typeof r=="function"))?s:new Nn(s,a)})}),o.VERSION="2.4.2",o.prototype.chain=Vi,o.prototype.toString=Ji,o.prototype.value=Et,o.prototype.valueOf=Et,sn(["join","pop","shift"],function(n){var e=Bn[n];o.prototype[n]=function(){var t=this.__chain__,r=e.apply(this.__wrapped__,arguments);return t?new Nn(r,t):r}}),sn(["push","reverse","sort","unshift"],function(n){var e=Bn[n];o.prototype[n]=function(){return e.apply(this.__wrapped__,arguments),this}}),sn(["concat","slice","splice"],function(n){var e=Bn[n];o.prototype[n]=function(){return new Nn(e.apply(this.__wrapped__,arguments),this.__chain__)}}),o}var Fn=Te();typeof define=="function"&&typeof define.amd=="object"&&define.amd?(L._=Fn,define(function(){return Fn})):G&&vn?Vn?(vn.exports=Fn)._=Fn:G._=Fn:L._=Fn}).call($n)});var tr=En(he=>{A();(function(f,v){if(typeof he=="object"&&he)v(he);else{var R={};v(R),typeof define=="function"&&define.amd?define(R):f.Mustache=R}})(he,function(f){var v=RegExp.prototype.test;function R(b,y){return v.call(b,y)}var D=/\S/;function O(b){return!R(D,b)}var M=Object.prototype.toString,P=Array.isArray||function(b){return M.call(b)==="[object Array]"};function U(b){return typeof b=="function"}function k(b){return b.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&")}var cn={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"};function gn(b){return String(b).replace(/[&<>"'\/]/g,function(y){return cn[y]})}function _n(b){if(!P(b)||b.length!==2)throw new Error("Invalid tags: "+b);return[new RegExp(k(b[0])+"\\s*"),new RegExp("\\s*"+k(b[1]))]}var On=/\s*/,Y=/\s+/,nn=/\s*=/,qn=/\s*\}/,jn=/#|\^|\/|>|\{|&|=|!/;function Un(b,y){y=y||f.tags,b=b||"",typeof y=="string"&&(y=y.split(Y));var x=_n(y),u=new h(b),p=[],m=[],g=[],N=!1,I=!1;function H(){if(N&&!I)for(;g.length;)delete m[g.pop()];else g=[];N=!1,I=!1}for(var mn,L,G,vn,Vn,en;!u.eos();){if(mn=u.pos,G=u.scanUntil(x[0]),G)for(var xn=0,Hn=G.length;xn<Hn;++xn)vn=G.charAt(xn),O(vn)?g.push(m.length):I=!0,m.push(["text",vn,mn,mn+1]),mn+=1,vn===`
`&&H();if(!u.scan(x[0]))break;if(N=!0,L=u.scan(jn)||"name",u.scan(On),L==="="?(G=u.scanUntil(nn),u.scan(nn),u.scanUntil(x[1])):L==="{"?(G=u.scanUntil(new RegExp("\\s*"+k("}"+y[1]))),u.scan(qn),u.scanUntil(x[1]),L="&"):G=u.scanUntil(x[1]),!u.scan(x[1]))throw new Error("Unclosed tag at "+u.pos);if(Vn=[L,G,mn,u.pos],m.push(Vn),L==="#"||L==="^")p.push(Vn);else if(L==="/"){if(en=p.pop(),!en)throw new Error('Unopened section "'+G+'" at '+mn);if(en[1]!==G)throw new Error('Unclosed section "'+en[1]+'" at '+mn)}else L==="name"||L==="{"||L==="&"?I=!0:L==="="&&(x=_n(y=G.split(Y)))}if(en=p.pop(),en)throw new Error('Unclosed section "'+en[1]+'" at '+u.pos);return zn(Gn(m))}function Gn(b){for(var y=[],x,u,p=0,m=b.length;p<m;++p)x=b[p],x&&(x[0]==="text"&&u&&u[0]==="text"?(u[1]+=x[1],u[3]=x[3]):(y.push(x),u=x));return y}function zn(b){for(var y=[],x=y,u=[],p,m,g=0,N=b.length;g<N;++g)switch(p=b[g],p[0]){case"#":case"^":x.push(p),u.push(p),x=p[4]=[];break;case"/":m=u.pop(),m[5]=p[2],x=u.length>0?u[u.length-1][4]:y;break;default:x.push(p)}return y}function h(b){this.string=b,this.tail=b,this.pos=0}h.prototype.eos=function(){return this.tail===""},h.prototype.scan=function(b){var y=this.tail.match(b);if(y&&y.index===0){var x=y[0];return this.tail=this.tail.substring(x.length),this.pos+=x.length,x}return""},h.prototype.scanUntil=function(b){var y=this.tail.search(b),x;switch(y){case-1:x=this.tail,this.tail="";break;case 0:x="";break;default:x=this.tail.substring(0,y),this.tail=this.tail.substring(y)}return this.pos+=x.length,x};function E(b,y){this.view=b??{},this.cache={".":this.view},this.parent=y}E.prototype.push=function(b){return new E(b,this)},E.prototype.lookup=function(b){var y;if(b in this.cache)y=this.cache[b];else{for(var x=this;x;){if(b.indexOf(".")>0){y=x.view;for(var u=b.split("."),p=0;y!=null&&p<u.length;)y=y[u[p++]]}else y=x.view[b];if(y!=null)break;x=x.parent}this.cache[b]=y}return U(y)&&(y=y.call(this.view)),y};function d(){this.cache={}}d.prototype.clearCache=function(){this.cache={}},d.prototype.parse=function(b,y){var x=this.cache,u=x[b];return u==null&&(u=x[b]=Un(b,y)),u},d.prototype.render=function(b,y,x){var u=this.parse(b),p=y instanceof E?y:new E(y);return this.renderTokens(u,p,x,b)},d.prototype.renderTokens=function(b,y,x,u){var p="",m=this;function g(vn){return m.render(vn,y,x)}for(var N,I,H=0,mn=b.length;H<mn;++H)switch(N=b[H],N[0]){case"#":if(I=y.lookup(N[1]),!I)continue;if(P(I))for(var L=0,G=I.length;L<G;++L)p+=this.renderTokens(N[4],y.push(I[L]),x,u);else if(typeof I=="object"||typeof I=="string")p+=this.renderTokens(N[4],y.push(I),x,u);else if(U(I)){if(typeof u!="string")throw new Error("Cannot use higher-order sections without the original template");I=I.call(y.view,u.slice(N[3],N[5]),g),I!=null&&(p+=I)}else p+=this.renderTokens(N[4],y,x,u);break;case"^":I=y.lookup(N[1]),(!I||P(I)&&I.length===0)&&(p+=this.renderTokens(N[4],y,x,u));break;case">":if(!x)continue;I=U(x)?x(N[1]):x[N[1]],I!=null&&(p+=this.renderTokens(this.parse(I),y,x,I));break;case"&":I=y.lookup(N[1]),I!=null&&(p+=I);break;case"name":I=y.lookup(N[1]),I!=null&&(p+=f.escape(I));break;case"text":p+=N[1];break}return p},f.name="mustache.js",f.version="0.8.1",f.tags=["{{","}}"];var j=new d;f.clearCache=function(){return j.clearCache()},f.parse=function(b,y){return j.parse(b,y)},f.render=function(b,y,x){return j.render(b,y,x)},f.to_html=function(b,y,x,u){var p=f.render(b,y,x);if(U(u))u(p);else return p},f.escape=gn,f.Scanner=h,f.Context=E,f.Writer=d})});var ir=En((Pa,rr)=>{A();function la(f,v){var R=new Date(f).getTime(),D=new Date(v).getTime(),O=(D-R)/1e3,M=Math.ceil(O/3600*24),P=Math.floor(O/(3600*24*30.5)),U=Math.floor(O/(3600*24*365.25));return U>0?U+" jaren":P+" maanden"}rr.exports.duration=la});var or=En((za,ar)=>{A();var pa=(qt(),ra(Lt)),ha=nr(),Ye=er(),da=tr(),de=ir();function ca(f){f.bio&&f.bio.email&&f.bio.email.personal&&(f.bio.gravatar=ha.url(f.bio.email.personal,{s:"100",r:"pg",d:"mm"})),Ye.each(f.work,function(D,O){D.endDate&&D.startDate?(console.log("work",D.endDate),f.work[O].duration=de.duration(D.startDate,D.endDate),f.work[O].startDate=D.startDate):(console.log("work",D.startDate),f.work[O].duration=de.duration(D.startDate,Date.now()),f.work[O].startDate=D.startDate)}),Ye.each(f.volunteer,function(D,O){D.endDate&&D.startDate?(console.log("volunteer",D.endDate),f.volunteer[O].duration=de.duration(D.startDate,D.endDate),f.volunteer[O].startDate=D.startDate):(console.log("volunteer",D.startDate),f.volunteer[O].duration=de.duration(D.startDate,Date.now()),f.volunteer[O].startDate=D.startDate)}),Ye.each(f.education,function(D,O){D.endDate&&D.startDate&&(f.education[O].duration=de.duration(D.startDate,D.endDate),f.education[O].startDate=D.startDate,f.education[O].endDate=D.endDate)});var v=pa.readFileSync("//resume.hbs","utf8"),R=da.render(v,f);return R}ar.exports={render:ca}});A();var Ln=ta(or(),1),sr=Ln.default??Ln,Aa=sr.render??Ln.render,La=sr.pdfRenderOptions??Ln.pdfRenderOptions;export{La as pdfRenderOptions,Aa as render};
