...
var Be=Object.create;var Y=Object.defineProperty;var Fe=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var Ue=Object.getPrototypeOf,We=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Mt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),ze=(t,e)=>{for(var n in e)Y(t,n,{get:e[n],enumerable:!0})},qt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of je(e))!We.call(t,s)&&s!==n&&Y(t,s,{get:()=>e[s],enumerable:!(i=Fe(e,s))||i.enumerable});return t};var Ge=(t,e,n)=>(n=t!=null?Be(Ue(t)):{},qt(e||!t||!t.__esModule?Y(n,"default",{value:t,enumerable:!0}):n,t)),Vt=t=>qt(Y({},"__esModule",{value:!0}),t);var u=Mt(()=>{});var pt={};ze(pt,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>Ke,existsSync:()=>Ut,lstatSync:()=>Gt,mkdirSync:()=>zt,readFileSync:()=>Ft,readdirSync:()=>jt,rmdirSync:()=>Jt,statSync:()=>ut,unlinkSync:()=>Kt,writeFileSync:()=>Wt});function ct(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Bt(t){var e=ct(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}function lt(t){var e=ct(t);if((e===""||e===".")&&q["."]!==void 0)return q["."];if(q[e]!==void 0)return q[e];for(var n=Object.keys(q),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return q[n[i]]}var X,q,Ft,jt,Ut,Wt,zt,ut,Gt,Kt,Jt,Yt,Xt,Ke,ft=Mt(()=>{"use strict";u();X={"package.json":`{
  "name": "jsonresume-theme-flat_projects",
  "version": "0.3.10",
  "description": "A theme for JSON Resume",
  "author": "Sam Fonseca",
  "repository": {
    "type": "git",
    "url": "http://github.com/samdfonseca/jsonresume-theme-flat"
  },
  "scripts": {
    "start": "resume serve"
  },
