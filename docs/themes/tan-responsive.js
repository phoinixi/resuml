var Vg=Object.create;var De=Object.defineProperty;var jg=Object.getOwnPropertyDescriptor;var n0=Object.getOwnPropertyNames;var t0=Object.getPrototypeOf,r0=Object.prototype.hasOwnProperty;var Ff=(u,A)=>()=>(u&&(A=u(u=0)),A);var Tt=(u,A)=>()=>(A||u((A={exports:{}}).exports,A),A.exports),e0=(u,A)=>{for(var L in A)De(u,L,{get:A[L],enumerable:!0})},Bf=(u,A,L,h)=>{if(A&&typeof A=="object"||typeof A=="function")for(let E of n0(A))!r0.call(u,E)&&E!==L&&De(u,E,{get:()=>A[E],enumerable:!(h=jg(A,E))||h.enumerable});return u};var i0=(u,A,L)=>(L=u!=null?Vg(t0(u)):{},Bf(A||!u||!u.__esModule?De(L,"default",{value:u,enumerable:!0}):L,u)),u0=u=>Bf(De({},"__esModule",{value:!0}),u);var sn=Ff(()=>{});var Kf={};e0(Kf,{createReadStream:()=>Gf,createWriteStream:()=>Yf,default:()=>a0,existsSync:()=>Of,lstatSync:()=>Hf,mkdirSync:()=>Nf,readFileSync:()=>Pf,readdirSync:()=>Wf,rmdirSync:()=>qf,statSync:()=>tu,unlinkSync:()=>zf,writeFileSync:()=>kf});function nu(u){return String(u).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Uf(u){var A=nu(u);if(Ee[A]!==void 0)return Ee[A];for(var L=Object.keys(Ee),h=0;h<L.length;h++)if(A.endsWith("/"+L[h])||A===L[h])return Ee[L[h]]}function ji(u){var A=nu(u);if(Ie[A]!==void 0)return Ie[A];for(var L=Object.keys(Ie),h=0;h<L.length;h++)if(A.endsWith("/"+L[h])||A===L[h])return Ie[L[h]]}var Ee,Ie,Pf,Wf,Of,kf,Nf,tu,Hf,zf,qf,Gf,Yf,a0,$f=Ff(()=>{"use strict";sn();Ee={"package.json":`{
