var Fe=Object.create;var K=Object.defineProperty;var Ve=Object.getOwnPropertyDescriptor;var qe=Object.getOwnPropertyNames;var Je=Object.getPrototypeOf,We=Object.prototype.hasOwnProperty;var V=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,r)=>(typeof require<"u"?require:e)[r]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Ht=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Ue=(t,e)=>{for(var r in e)K(t,r,{get:e[r],enumerable:!0})},Rt=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of qe(e))!We.call(t,i)&&i!==r&&K(t,i,{get:()=>e[i],enumerable:!(n=Ve(e,i))||n.enumerable});return t};var ze=(t,e,r)=>(r=t!=null?Fe(Je(t)):{},Rt(e||!t||!t.__esModule?K(r,"default",{value:t,enumerable:!0}):r,t)),Bt=t=>Rt(K({},"__esModule",{value:!0}),t);var c=Ht(()=>{});var ut={};Ue(ut,{createReadStream:()=>Qt,createWriteStream:()=>Yt,default:()=>Ge,existsSync:()=>Jt,lstatSync:()=>zt,mkdirSync:()=>Ut,readFileSync:()=>Vt,readdirSync:()=>qt,rmdirSync:()=>Kt,statSync:()=>ct,unlinkSync:()=>Gt,writeFileSync:()=>Wt});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ft(t){var e=pt(t);if(Q[e]!==void 0)return Q[e];for(var r=Object.keys(Q),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return Q[r[n]]}function lt(t){var e=pt(t);if(Y[e]!==void 0)return Y[e];for(var r=Object.keys(Y),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return Y[r[n]]}var Q,Y,Vt,qt,Jt,Wt,Ut,ct,zt,Gt,Kt,Qt,Yt,Ge,dt=Ht(()=>{"use strict";c();Q={"index.html":`<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">\r
<html>\r
<head>\r
