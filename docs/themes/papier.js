...
`,"package.json":`{
  "name": "jsonresume-theme-papier",
  "version": "0.1.3",
  "description": "Un th\xE8me pour JSON Resume",
  "author": "Tim Daubensch\xFCtz",
  "repository": {
    "type": "git",
    "url": "https://github.com/omigeot/jsonresume-theme-papier"
  },
  "license": "MIT",
  "dependencies": {
    "handlebars": "^2.0.0-alpha.4"
  },
  "homepage": "https://github.com/omigeot/jsonresume-theme-papier",
  "main": "index.js",
  "scripts": {
    "start": "resume serve"
  },
          	...
          	{{/if}}
			        <div class="row">
			          <div class="content-cat big-text">
			          	{{#if $first}}
											Exp\xE9rience professionelle
			          	{{/if}}
			          
								 {{#if startDate}}
										{{#if endDate}}
			            		<p>De {{startDate}} \xE0 {{endDate}}</p>
			            	{{/if}}
									{{/if}}
