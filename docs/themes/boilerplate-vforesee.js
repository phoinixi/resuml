var te=Object.create;var J=Object.defineProperty;var re=Object.getOwnPropertyDescriptor;var ee=Object.getOwnPropertyNames;var ne=Object.getPrototypeOf,ie=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(r,e)=>(typeof require<"u"?require:r)[e]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var pt=(t,r)=>()=>(t&&(r=t(t=0)),r);var g=(t,r)=>()=>(r||t((r={exports:{}}).exports,r),r.exports),Wt=(t,r)=>{for(var e in r)J(t,e,{get:r[e],enumerable:!0})},Ut=(t,r,e,n)=>{if(r&&typeof r=="object"||typeof r=="function")for(let i of ee(r))!ie.call(t,i)&&i!==e&&J(t,i,{get:()=>r[i],enumerable:!(n=re(r,i))||n.enumerable});return t};var se=(t,r,e)=>(e=t!=null?te(ne(t)):{},Ut(r||!t||!t.__esModule?J(e,"default",{value:t,enumerable:!0}):e,t)),ft=t=>Ut(J({},"__esModule",{value:!0}),t);var u=pt(()=>{});var vt={};Wt(vt,{createReadStream:()=>tr,createWriteStream:()=>rr,default:()=>ae,existsSync:()=>Jt,lstatSync:()=>Zt,mkdirSync:()=>Xt,readFileSync:()=>Kt,readdirSync:()=>zt,rmdirSync:()=>$t,statSync:()=>mt,unlinkSync:()=>Qt,writeFileSync:()=>Yt});function gt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Gt(t){var r=gt(t);if(Y[r]!==void 0)return Y[r];for(var e=Object.keys(Y),n=0;n<e.length;n++)if(r.endsWith("/"+e[n])||r===e[n])return Y[e[n]]}function dt(t){var r=gt(t);if(X[r]!==void 0)return X[r];for(var e=Object.keys(X),n=0;n<e.length;n++)if(r.endsWith("/"+e[n])||r===e[n])return X[e[n]]}var Y,X,Kt,zt,Jt,Yt,Xt,mt,Zt,Qt,$t,tr,rr,ae,bt=pt(()=>{"use strict";u();Y={"package.json":`{\r
