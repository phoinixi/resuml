var Li=Object.create;var Le=Object.defineProperty;var Ei=Object.getOwnPropertyDescriptor;var Mi=Object.getOwnPropertyNames;var Ai=Object.getPrototypeOf,Oi=Object.prototype.hasOwnProperty;var ft=(t,e)=>()=>(t&&(e=t(t=0)),e);var v=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),dr=(t,e)=>{for(var r in e)Le(t,r,{get:e[r],enumerable:!0})},pr=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Mi(e))!Oi.call(t,i)&&i!==r&&Le(t,i,{get:()=>e[i],enumerable:!(n=Ei(e,i))||n.enumerable});return t};var Ii=(t,e,r)=>(r=t!=null?Li(Ai(t)):{},pr(e||!t||!t.__esModule?Le(r,"default",{value:t,enumerable:!0}):r,t)),fr=t=>pr(Le({},"__esModule",{value:!0}),t);var d=ft(()=>{});var Pr={};dr(Pr,{createReadStream:()=>wr,createWriteStream:()=>Cr,default:()=>Ni,existsSync:()=>br,lstatSync:()=>yr,mkdirSync:()=>_r,readFileSync:()=>gr,readdirSync:()=>vr,rmdirSync:()=>Sr,statSync:()=>vt,unlinkSync:()=>xr,writeFileSync:()=>kr});function gt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function mr(t){var e=gt(t);if(Ee[e]!==void 0)return Ee[e];for(var r=Object.keys(Ee),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return Ee[r[n]]}function mt(t){var e=gt(t);if(Me[e]!==void 0)return Me[e];for(var r=Object.keys(Me),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return Me[r[n]]}var Ee,Me,gr,vr,br,kr,_r,vt,yr,xr,Sr,wr,Cr,Ni,Lr=ft(()=>{"use strict";d();Ee={"package.json":`{
