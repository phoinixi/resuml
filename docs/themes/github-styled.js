...
var Li=Object.create;var Ee=Object.defineProperty;var Ei=Object.getOwnPropertyDescriptor;var Mi=Object.getOwnPropertyNames;var Ai=Object.getPrototypeOf,Oi=Object.prototype.hasOwnProperty;var pt=(t,e)=>()=>(t&&(e=t(t=0)),e);var v=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),fr=(t,e)=>{for(var r in e)Ee(t,r,{get:e[r],enumerable:!0})},dr=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Mi(e))!Oi.call(t,i)&&i!==r&&Ee(t,i,{get:()=>e[i],enumerable:!(n=Ei(e,i))||n.enumerable});return t};var Ii=(t,e,r)=>(r=t!=null?Li(Ai(t)):{},dr(e||!t||!t.__esModule?Ee(r,"default",{value:t,enumerable:!0}):r,t)),pr=t=>dr(Ee({},"__esModule",{value:!0}),t);var f=pt(()=>{});var Pr={};fr(Pr,{createReadStream:()=>wr,createWriteStream:()=>Cr,default:()=>Ni,existsSync:()=>br,lstatSync:()=>yr,mkdirSync:()=>_r,readFileSync:()=>mr,readdirSync:()=>vr,rmdirSync:()=>Sr,statSync:()=>vt,unlinkSync:()=>xr,writeFileSync:()=>kr});function mt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function gr(t){var e=mt(t);if(Me[e]!==void 0)return Me[e];for(var r=Object.keys(Me),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return Me[r[n]]}function gt(t){var e=mt(t);if((e===""||e===".")&&te["."]!==void 0)return te["."];if(te[e]!==void 0)return te[e];for(var r=Object.keys(te),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return te[r[n]]}var Me,te,mr,vr,br,kr,_r,vt,yr,xr,Sr,wr,Cr,Ni,Lr=pt(()=>{"use strict";f();Me={"package.json":`{
