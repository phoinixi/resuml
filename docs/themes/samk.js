var Mi=Object.create;var Ce=Object.defineProperty;var Ai=Object.getOwnPropertyDescriptor;var Oi=Object.getOwnPropertyNames;var Ii=Object.getPrototypeOf,Ni=Object.prototype.hasOwnProperty;var dt=(t,e)=>()=>(t&&(e=t(t=0)),e);var v=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),pr=(t,e)=>{for(var r in e)Ce(t,r,{get:e[r],enumerable:!0})},fr=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Oi(e))!Ni.call(t,i)&&i!==r&&Ce(t,i,{get:()=>e[i],enumerable:!(n=Ai(e,i))||n.enumerable});return t};var Di=(t,e,r)=>(r=t!=null?Mi(Ii(t)):{},fr(e||!t||!t.__esModule?Ce(r,"default",{value:t,enumerable:!0}):r,t)),dr=t=>fr(Ce({},"__esModule",{value:!0}),t);var p=dt(()=>{});var Cr={};pr(Cr,{createReadStream:()=>wr,createWriteStream:()=>Pr,default:()=>Ri,existsSync:()=>_r,lstatSync:()=>kr,mkdirSync:()=>Sr,readFileSync:()=>gr,readdirSync:()=>vr,rmdirSync:()=>Lr,statSync:()=>vt,unlinkSync:()=>br,writeFileSync:()=>yr});function gt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function mr(t){var e=gt(t);if(Ee[e]!==void 0)return Ee[e];for(var r=Object.keys(Ee),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return Ee[r[n]]}function mt(t){var e=gt(t);if(xe[e]!==void 0)return xe[e];for(var r=Object.keys(xe),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return xe[r[n]]}var Ee,xe,gr,vr,_r,yr,Sr,vt,kr,br,Lr,wr,Pr,Ri,Er=dt(()=>{"use strict";p();Ee={"package.json":`{
