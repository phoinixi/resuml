...
var Be=Object.create;var Y=Object.defineProperty;var qe=Object.getOwnPropertyDescriptor;var Ve=Object.getOwnPropertyNames;var je=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Mt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Ue=(t,e)=>{for(var n in e)Y(t,n,{get:e[n],enumerable:!0})},Ft=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Ve(e))!ze.call(t,s)&&s!==n&&Y(t,s,{get:()=>e[s],enumerable:!(i=qe(e,s))||i.enumerable});return t};var Ge=(t,e,n)=>(n=t!=null?Be(je(t)):{},Ft(e||!t||!t.__esModule?Y(n,"default",{value:t,enumerable:!0}):n,t)),Bt=t=>Ft(Y({},"__esModule",{value:!0}),t);var p=Mt(()=>{});var ut={};Ue(ut,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>We,existsSync:()=>zt,lstatSync:()=>Wt,mkdirSync:()=>Gt,readFileSync:()=>Vt,readdirSync:()=>jt,rmdirSync:()=>Kt,statSync:()=>pt,unlinkSync:()=>Jt,writeFileSync:()=>Ut});function ct(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function qt(t){var e=ct(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}function ht(t){var e=ct(t);if((e===""||e===".")&&F["."]!==void 0)return F["."];if(F[e]!==void 0)return F[e];for(var n=Object.keys(F),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return F[n[i]]}var X,F,Vt,jt,zt,Ut,Gt,pt,Wt,Jt,Kt,Yt,Xt,We,dt=Mt(()=>{"use strict";p();X={"index.html":`<!doctype html>
...
<html>
	...
	<header id="header">
		<div class="container">
			<div class="row">
				<img data-src="holder.js/100x100" class="media-object img-circle center-block" alt="{{resume.basics.name}}" src="{{resume.basics.picture}}" itemprop="image">
				<br>
				<div class="col-sm-9 col-sm-push-3">
					<h1>
						{{resume.basics.name}}
		...
		<div class="col-sm-9">
			...
			<div class="col-sm-12">
				<h4 class="strike-through">
					<span>{{company}}</span>
					<span class="date">
						{{startDate}} \u2014 {{#if endDate}}{{endDate}}{{else}}Heden{{/if}}
					</span>
				</h4>
				{{#website}}
				<div class="website pull-right">
