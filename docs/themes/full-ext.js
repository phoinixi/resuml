var et=Object.create;var Y=Object.defineProperty;var rt=Object.getOwnPropertyDescriptor;var tt=Object.getOwnPropertyNames;var nt=Object.getPrototypeOf,it=Object.prototype.hasOwnProperty;var V=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(r,t)=>(typeof require<"u"?require:r)[t]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var fe=(e,r)=>()=>(e&&(r=e(e=0)),r);var m=(e,r)=>()=>(r||e((r={exports:{}}).exports,r),r.exports),Ue=(e,r)=>{for(var t in r)Y(e,t,{get:r[t],enumerable:!0})},We=(e,r,t,n)=>{if(r&&typeof r=="object"||typeof r=="function")for(let i of tt(r))!it.call(e,i)&&i!==t&&Y(e,i,{get:()=>r[i],enumerable:!(n=rt(r,i))||n.enumerable});return e};var st=(e,r,t)=>(t=e!=null?et(nt(e)):{},We(r||!e||!e.__esModule?Y(t,"default",{value:e,enumerable:!0}):t,e)),de=e=>We(Y({},"__esModule",{value:!0}),e);var p=fe(()=>{});var be={};Ue(be,{createReadStream:()=>rr,createWriteStream:()=>tr,default:()=>at,existsSync:()=>Ye,lstatSync:()=>Qe,mkdirSync:()=>Ze,readFileSync:()=>Ke,readdirSync:()=>Je,rmdirSync:()=>er,statSync:()=>ve,unlinkSync:()=>$e,writeFileSync:()=>Xe});function ge(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ge(e){var r=ge(e);if(X[r]!==void 0)return X[r];for(var t=Object.keys(X),n=0;n<t.length;n++)if(r.endsWith("/"+t[n])||r===t[n])return X[t[n]]}function me(e){var r=ge(e);if(Z[r]!==void 0)return Z[r];for(var t=Object.keys(Z),n=0;n<t.length;n++)if(r.endsWith("/"+t[n])||r===t[n])return Z[t[n]]}var X,Z,Ke,Je,Ye,Xe,Ze,ve,Qe,$e,er,rr,tr,at,ye=fe(()=>{"use strict";p();X={"package.json":`{\r
