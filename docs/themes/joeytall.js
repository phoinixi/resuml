var Ft=Object.create;var K=Object.defineProperty;var qt=Object.getOwnPropertyDescriptor;var jt=Object.getOwnPropertyNames;var Ut=Object.getPrototypeOf,Wt=Object.prototype.hasOwnProperty;var q=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,n)=>(typeof require<"u"?require:t)[n]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var Be=(e,t)=>()=>(e&&(t=e(e=0)),t);var m=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Gt=(e,t)=>{for(var n in t)K(e,n,{get:t[n],enumerable:!0})},Me=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of jt(t))!Wt.call(e,s)&&s!==n&&K(e,s,{get:()=>t[s],enumerable:!(i=qt(t,s))||i.enumerable});return e};var zt=(e,t,n)=>(n=e!=null?Ft(Ut(e)):{},Me(t||!e||!e.__esModule?K(n,"default",{value:e,enumerable:!0}):n,e)),Ve=e=>Me(K({},"__esModule",{value:!0}),e);var p=Be(()=>{});var ue={};Gt(ue,{createReadStream:()=>Ye,createWriteStream:()=>Qe,default:()=>Jt,existsSync:()=>Ue,lstatSync:()=>ze,mkdirSync:()=>Ge,readFileSync:()=>qe,readdirSync:()=>je,rmdirSync:()=>Ke,statSync:()=>pe,unlinkSync:()=>Je,writeFileSync:()=>We});function ce(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Fe(e){var t=ce(e);if(Y[t]!==void 0)return Y[t];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return Y[n[i]]}function he(e){var t=ce(e);if(Q[t]!==void 0)return Q[t];for(var n=Object.keys(Q),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return Q[n[i]]}var Y,Q,qe,je,Ue,We,Ge,pe,ze,Je,Ke,Ye,Qe,Jt,fe=Be(()=>{"use strict";p();Y={"package.json":`{
  "author": {
    "name": "Joey Liu"
  },
  ...
  "license": "MIT",
  "main": "index.js",
  "name": "jsonresume-theme-joeytall",
  "version": "1.0.1"
}
      ...
      {{#each resume.work}}
	      ...
	      <div class='blockHeader'>
                <div class="company">
                  ...
                  <a class='title' href='{{website}}'> {{company}} </a>
                  </div>
	        {{#if startDate}}
	        <span class='date'>
