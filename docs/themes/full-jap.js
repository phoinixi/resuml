var en=Object.create;var Y=Object.defineProperty;var tn=Object.getOwnPropertyDescriptor;var nn=Object.getOwnPropertyNames;var sn=Object.getPrototypeOf,rn=Object.prototype.hasOwnProperty;var V=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,n)=>(typeof require<"u"?require:t)[n]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var fe=(e,t)=>()=>(e&&(t=e(e=0)),t);var m=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Ue=(e,t)=>{for(var n in t)Y(e,n,{get:t[n],enumerable:!0})},We=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of nn(t))!rn.call(e,s)&&s!==n&&Y(e,s,{get:()=>t[s],enumerable:!(i=tn(t,s))||i.enumerable});return e};var an=(e,t,n)=>(n=e!=null?en(sn(e)):{},We(t||!e||!e.__esModule?Y(n,"default",{value:e,enumerable:!0}):n,e)),de=e=>We(Y({},"__esModule",{value:!0}),e);var p=fe(()=>{});var ye={};Ue(ye,{createReadStream:()=>tt,createWriteStream:()=>nt,default:()=>on,existsSync:()=>Ye,lstatSync:()=>Qe,mkdirSync:()=>Ze,readFileSync:()=>Ke,readdirSync:()=>Je,rmdirSync:()=>et,statSync:()=>ve,unlinkSync:()=>$e,writeFileSync:()=>Xe});function ge(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ge(e){var t=ge(e);if(X[t]!==void 0)return X[t];for(var n=Object.keys(X),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return X[n[i]]}function me(e){var t=ge(e);if(Z[t]!==void 0)return Z[t];for(var n=Object.keys(Z),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return Z[n[i]]}var X,Z,Ke,Je,Ye,Xe,Ze,ve,Qe,$e,et,tt,nt,on,be=fe(()=>{"use strict";p();X={"package.json":`{
  "name": "jsonresume-theme-full-jap",
  "version": "0.0.4",
  "description": "Simple to the point theme for JSON Resume, based on the short theme",
  "author": "Dang Hung",
  "repository": {
    "type": "git",
    "url": "git+https://github.com/danghung-dev/jsonresume-theme-full-jap.git"
  },
  "bugs": {
    "url": "https://github.com/danghung-dev/jsonresume-theme-full-jap/issues"
  },
  "homepage": "https://github.com/danghung-dev/jsonresume-theme-full-jap#readme",
  "keywords": [
    "jsonresume",
    "resume",
    "full theme support",
...
section.experience .item header .subhead, section.volunteering .item header .subhead, section.projects .item header, section.education .item header, section.certificates .item header, section.awards .item header, section.publications .item .subhead {
  align-items: baseline;
  display: flex;
  justify-content: space-between;
}
