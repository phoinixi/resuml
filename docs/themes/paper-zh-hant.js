var Be=Object.create;var J=Object.defineProperty;var Fe=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Vt=(t,e)=>()=>(t&&(e=t(t=0)),e);var g=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)J(t,n,{get:e[n],enumerable:!0})},Bt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of je(e))!Ue.call(t,r)&&r!==n&&J(t,r,{get:()=>e[r],enumerable:!(i=Fe(e,r))||i.enumerable});return t};var Ge=(t,e,n)=>(n=t!=null?Be(ze(t)):{},Bt(e||!t||!t.__esModule?J(n,"default",{value:t,enumerable:!0}):n,t)),Ft=t=>Bt(J({},"__esModule",{value:!0}),t);var p=Vt(()=>{});var ft={};We(ft,{createReadStream:()=>Zt,createWriteStream:()=>Qt,default:()=>Ke,existsSync:()=>Wt,lstatSync:()=>Jt,mkdirSync:()=>Kt,readFileSync:()=>zt,readdirSync:()=>Ut,rmdirSync:()=>Xt,statSync:()=>ut,unlinkSync:()=>Yt,writeFileSync:()=>Gt});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function jt(t){var e=pt(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}function ct(t){var e=pt(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}var Y,X,zt,Ut,Wt,Gt,Kt,ut,Jt,Yt,Xt,Zt,Qt,Ke,dt=Vt(()=>{"use strict";p();Y={"css/print.css":`
body, html {
