var Bn=Object.create;var z=Object.defineProperty;var Vn=Object.getOwnPropertyDescriptor;var qn=Object.getOwnPropertyNames;var Jn=Object.getPrototypeOf,Un=Object.prototype.hasOwnProperty;var V=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(n,e)=>(typeof require<"u"?require:n)[e]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Mt=(t,n)=>()=>(t&&(n=t(t=0)),n);var m=(t,n)=>()=>(n||t((n={exports:{}}).exports,n),n.exports),Gn=(t,n)=>{for(var e in n)z(t,e,{get:n[e],enumerable:!0})},jt=(t,n,e,i)=>{if(n&&typeof n=="object"||typeof n=="function")for(let s of qn(n))!Un.call(t,s)&&s!==e&&z(t,s,{get:()=>n[s],enumerable:!(i=Vn(n,s))||i.enumerable});return t};var Wn=(t,n,e)=>(e=t!=null?Bn(Jn(t)):{},jt(n||!t||!t.__esModule?z(e,"default",{value:t,enumerable:!0}):e,t)),Ft=t=>jt(z({},"__esModule",{value:!0}),t);var c=Mt(()=>{});var ut={};Gn(ut,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>Kn,existsSync:()=>Jt,lstatSync:()=>Wt,mkdirSync:()=>Gt,readFileSync:()=>Vt,readdirSync:()=>qt,rmdirSync:()=>zt,statSync:()=>ct,unlinkSync:()=>Kt,writeFileSync:()=>Ut});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Bt(t){var n=pt(t);if(Y[n]!==void 0)return Y[n];for(var e=Object.keys(Y),i=0;i<e.length;i++)if(n.endsWith("/"+e[i])||n===e[i])return Y[e[i]]}function ht(t){var n=pt(t);if(X[n]!==void 0)return X[n];for(var e=Object.keys(X),i=0;i<e.length;i++)if(n.endsWith("/"+e[i])||n===e[i])return X[e[i]]}var Y,X,Vt,qt,Jt,Ut,Gt,ct,Wt,Kt,zt,Yt,Xt,Kn,ft=Mt(()=>{"use strict";c();Y={"index.html":`<!doctype html>
<html>
	<head>
