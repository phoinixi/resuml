...
var Mi=Object.create;var Le=Object.defineProperty;var Oi=Object.getOwnPropertyDescriptor;var Ai=Object.getOwnPropertyNames;var Ii=Object.getPrototypeOf,Ni=Object.prototype.hasOwnProperty;var dt=(t,e)=>()=>(t&&(e=t(t=0)),e);var v=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),pr=(t,e)=>{for(var r in e)Le(t,r,{get:e[r],enumerable:!0})},fr=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Ai(e))!Ni.call(t,i)&&i!==r&&Le(t,i,{get:()=>e[i],enumerable:!(n=Oi(e,i))||n.enumerable});return t};var Di=(t,e,r)=>(r=t!=null?Mi(Ii(t)):{},fr(e||!t||!t.__esModule?Le(r,"default",{value:t,enumerable:!0}):r,t)),dr=t=>fr(Le({},"__esModule",{value:!0}),t);var p=dt(()=>{});var xr={};pr(xr,{createReadStream:()=>Cr,createWriteStream:()=>wr,default:()=>Ri,existsSync:()=>_r,lstatSync:()=>Sr,mkdirSync:()=>br,readFileSync:()=>gr,readdirSync:()=>vr,rmdirSync:()=>Pr,statSync:()=>vt,unlinkSync:()=>kr,writeFileSync:()=>yr});function gt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function mr(t){var e=gt(t);if(Ee[e]!==void 0)return Ee[e];for(var r=Object.keys(Ee),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return Ee[r[n]]}function mt(t){var e=gt(t);if((e===""||e===".")&&te["."]!==void 0)return te["."];if(te[e]!==void 0)return te[e];for(var r=Object.keys(te),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return te[r[n]]}var Ee,te,gr,vr,_r,yr,br,vt,Sr,kr,Pr,Cr,wr,Ri,Lr=dt(()=>{"use strict";p();Ee={"package.json":`{
