...
var Gi=Object.create;var Rn=Object.defineProperty;var Ji=Object.getOwnPropertyDescriptor;var Qi=Object.getOwnPropertyNames;var Xi=Object.getPrototypeOf,Zi=Object.prototype.hasOwnProperty;var Oe=(p,m)=>()=>(p&&(m=p(p=0)),m);var xt=(p,m)=>()=>(m||p((m={exports:{}}).exports,m),m.exports),ki=(p,m)=>{for(var D in m)Rn(p,D,{get:m[D],enumerable:!0})},Se=(p,m,D,T)=>{if(m&&typeof m=="object"||typeof m=="function")for(let _ of Qi(m))!Zi.call(p,_)&&_!==D&&Rn(p,_,{get:()=>m[_],enumerable:!(T=Ji(m,_))||T.enumerable});return p};var tu=(p,m,D)=>(D=p!=null?Gi(Xi(p)):{},Se(m||!p||!p.__esModule?Rn(D,"default",{value:p,enumerable:!0}):D,p)),nu=p=>Se(Rn({},"__esModule",{value:!0}),p);var q=Oe(()=>{});var Le={};ki(Le,{createReadStream:()=>Ne,createWriteStream:()=>ze,default:()=>eu,existsSync:()=>Ie,lstatSync:()=>Ue,mkdirSync:()=>Fe,readFileSync:()=>xe,readdirSync:()=>Te,rmdirSync:()=>Pe,statSync:()=>Jn,unlinkSync:()=>Me,writeFileSync:()=>je});function Gn(p){return String(p).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function De(p){var m=Gn(p);if(En[m]!==void 0)return En[m];for(var D=Object.keys(En),T=0;T<D.length;T++)if(m.endsWith("/"+D[T])||m===D[T])return En[D[T]]}function Vn(p){var m=Gn(p);if((m===""||m===".")&&Ht["."]!==void 0)return Ht["."];if(Ht[m]!==void 0)return Ht[m];for(var D=Object.keys(Ht),T=0;T<D.length;T++)if(m.endsWith("/"+D[T])||m===D[T])return Ht[D[T]]}var En,Ht,xe,Te,Ie,je,Fe,Jn,Ue,Me,Pe,Ne,ze,eu,qe=Oe(()=>{"use strict";q();En={"package.json":`{
