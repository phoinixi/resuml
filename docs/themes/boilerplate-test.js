var Ve=Object.create;var J=Object.defineProperty;var Be=Object.getOwnPropertyDescriptor;var Fe=Object.getOwnPropertyNames;var je=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,i)=>(typeof require<"u"?require:e)[i]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Tt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var i in e)J(t,i,{get:e[i],enumerable:!0})},qt=(t,e,i,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Fe(e))!Ue.call(t,s)&&s!==i&&J(t,s,{get:()=>e[s],enumerable:!(n=Be(e,s))||n.enumerable});return t};var Ge=(t,e,i)=>(i=t!=null?Ve(je(t)):{},qt(e||!t||!t.__esModule?J(i,"default",{value:t,enumerable:!0}):i,t)),Vt=t=>qt(J({},"__esModule",{value:!0}),t);var c=Tt(()=>{});var pt={};We(pt,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>Ke,existsSync:()=>Ut,lstatSync:()=>Kt,mkdirSync:()=>Gt,readFileSync:()=>Ft,readdirSync:()=>jt,rmdirSync:()=>Jt,statSync:()=>ct,unlinkSync:()=>zt,writeFileSync:()=>Wt});function ut(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Bt(t){var e=ut(t);if(Y[e]!==void 0)return Y[e];for(var i=Object.keys(Y),n=0;n<i.length;n++)if(e.endsWith("/"+i[n])||e===i[n])return Y[i[n]]}function lt(t){var e=ut(t);if(X[e]!==void 0)return X[e];for(var i=Object.keys(X),n=0;n<i.length;n++)if(e.endsWith("/"+i[n])||e===i[n])return X[i[n]]}var Y,X,Ft,jt,Ut,Wt,Gt,ct,Kt,zt,Jt,Yt,Xt,Ke,ft=Tt(()=>{"use strict";c();Y={"package.json":`{
  "name": "jsonresume-theme-boilerplate-test",
  "version": "0.1.5",
  "description": "Boilerplate theme for JSON Resume, fork for feature testing",
  "author": "Mike Chelen",
  "repository": {
    "type": "git",
    "url": "https://github.com/mchelen/jsonresume-theme-boilerplate"
  },
  "license": "MIT",
  "dependencies": {
