...
var Di=Object.create;var Et=Object.defineProperty;var Oi=Object.getOwnPropertyDescriptor;var Ai=Object.getOwnPropertyNames;var Mi=Object.getPrototypeOf,Ii=Object.prototype.hasOwnProperty;var fe=(e,t)=>()=>(e&&(t=e(e=0)),t);var v=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),dn=(e,t)=>{for(var n in t)Et(e,n,{get:t[n],enumerable:!0})},fn=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of Ai(t))!Ii.call(e,i)&&i!==n&&Et(e,i,{get:()=>t[i],enumerable:!(r=Oi(t,i))||r.enumerable});return e};var Ni=(e,t,n)=>(n=e!=null?Di(Mi(e)):{},fn(t||!e||!e.__esModule?Et(n,"default",{value:e,enumerable:!0}):n,e)),mn=e=>fn(Et({},"__esModule",{value:!0}),e);var p=fe(()=>{});var En={};dn(En,{createReadStream:()=>Pn,createWriteStream:()=>xn,default:()=>Ri,existsSync:()=>_n,lstatSync:()=>kn,mkdirSync:()=>Sn,readFileSync:()=>vn,readdirSync:()=>yn,rmdirSync:()=>Cn,statSync:()=>ve,unlinkSync:()=>wn,writeFileSync:()=>bn});function ge(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function gn(e){var t=ge(e);if(Lt[t]!==void 0)return Lt[t];for(var n=Object.keys(Lt),r=0;r<n.length;r++)if(t.endsWith("/"+n[r])||t===n[r])return Lt[n[r]]}function me(e){var t=ge(e);if((t===""||t===".")&&et["."]!==void 0)return et["."];if(et[t]!==void 0)return et[t];for(var n=Object.keys(et),r=0;r<n.length;r++)if(t.endsWith("/"+n[r])||t===n[r])return et[n[r]]}var Lt,et,vn,yn,_n,bn,Sn,ve,kn,wn,Cn,Pn,xn,Ri,Ln=fe(()=>{"use strict";p();Lt={"package.json":`{
