...
{{/if}}
`},St={dist:["cv.pdf"],"theme/hbs-helpers":["birth-date.js","date-helpers.js","paragraph-split.js","space-to-dash.js","to-lower-case.js"],"theme/partials":["awards.hbs","basics.hbs","education.hbs","interests.hbs","languages.hbs","projects.hbs","publications.hbs","references.hbs","skills.hbs","volunteer.hbs","work.hbs"],theme:["hbs-helpers","partials"],".":["CHANGELOG.md","README.md","dist","index.js","package.json","resume.hbs","section-projects.md","style.css","theme"]};ro=function(n,t){var s=no(n);return s!==void 0?s:""},so=function(n,t){var s=ms(n);return s===void 0&&(s=[]),t&&t.withFileTypes?s.map(function(a){var l=gs(n)+"/"+a,u=ms(l)!==void 0;return{name:a,isFile:function(){return!u},isDirectory:function(){return u}}}):s},io=function(n){return no(n)!==void 0||ms(n)!==void 0},ao=function(){},oo=function(){},_s=function(){return{isFile:function(){return!0},isDirectory:function(){return!1},size:0,mtime:new Date}},lo=_s,uo=function(){},co=function(){},ho=function(){return{pipe:function(n){return n},on:function(){return this}}},fo=function(){return{write:function(){},end:function(){},on:function(){return this}}},Op={readFileSync:ro,readdirSync:so,existsSync:io,writeFileSync:ao,mkdirSync:oo,statSync:_s,lstatSync:lo,unlinkSync:uo,rmdirSync:co,createReadStream:ho,createWriteStream:fo}});var bo={};pi(bo,{basename:()=>Zn,default:()=>Cp,dirname:()=>vs,extname:()=>Jn,isAbsolute:()=>yo,join:()=>go,normalize:()=>ko,parse:()=>wo,relative:()=>So,resolve:()=>_o,sep:()=>vo});var go,_o,vs,Zn,Jn,vo,yo,ko,So,wo,Cp,Mo=Sr(()=>{"use strict";y();go=function(){return[].slice.call(arguments).join("/")},_o=function(){return[].slice.call(arguments).join("/")},vs=function(n){return n.split("/").slice(0,-1).join("/")},Zn=function(n,t){var s=n.split("/").pop()||"";return t&&s.endsWith(t)?s.slice(0,-t.length):s},Jn=function(n){var t=n.match(/\.[^.]+$/);return t?t[0]:""},vo="/",yo=function(n){return n.charAt(0)==="/"},ko=function(n){return n},So=function(n,t){return t},wo=function(n){return{root:"",dir:vs(n),base:Zn(n),ext:Jn(n),name:Zn(n,Jn(n))}},Cp={join:go,resolve:_o,dirname:vs,basename:Zn,extname:Jn,sep:vo,isAbsolute:yo,normalize:ko,relative:So,parse:wo}});var Do=O((c2,xo)=>{y();var Lp=zn(),{SafeString:Ep}=Vn(),Np=(n,t)=>{t||(t="M");let s=[];if(n&&Object.keys(n).length){n.place&&s.push(t==="F"?`<div> N\xE9e \xE0 ${n.place}`:`<div> N\xE9 \xE0 ${n.place}`),n.place&&n.state&&s.push(`, ${n.state}`);let a=n.date?Lp(n.date.toString(),["YYYY-MM-DD"]).format("YYYY"):"";a&&n.place&&n.state?s.push(` en ${a}</div>`):a&&(!n.place||n.state)&&s.push(t==="F"?`<div> N\xE9e en ${a}</div>`:`<div> N\xE9 en ${a}</div>`)}return new Ep(s.join(""))};xo.exports={birthDate:Np}});var Oo=O((f2,Po)=>{y();var ys=zn(),Yp={MY:n=>ys(n.toString(),["YYYY-MM-DD"]).format("MMMM YYYY"),Y:n=>ys(n.toString(),["YYYY-MM-DD"]).format("YYYY"),DMY:n=>ys(n.toString(),["YYYY-MM-DD"]).format("D MMMM YYYY")};Po.exports={dateHelpers:Yp}});var Lo=O((p2,Co)=>{y();var{SafeString:Ap}=Vn(),Rp=n=>{let t=/\r\n|\r|\n/g,a=(Array.isArray(n)?n.join("").split(t):n.split(t)).filter(l=>l).reduce((l,u)=>`${l}<p>${u}</p>`,"");return new Ap(a)};Co.exports={paragraphSplit:Rp}});var No=O((g2,Eo)=>{y();Eo.exports={toLowerCase:n=>n.toLowerCase()}});var Ao=O((v2,Yo)=>{y();Yo.exports={spaceToDash:n=>n.replace(/\s/g,"-").toLowerCase()}});var To=O((S2,Ro)=>{y();var Re=Vn(),Tp=zn(),{readFileSync:ks,readdirSync:Ip}=(mo(),gi(po)),{join:Ss}=(Mo(),gi(bo)),k2=Ss("/","theme/hbs-helpers"),{birthDate:Fp}=Do(),{dateHelpers:Hp}=Oo(),{paragraphSplit:Wp}=Lo(),{toLowerCase:qp}=No(),{spaceToDash:Up}=Ao();Tp.locale("fr");var{MY:Bp,Y:Gp,DMY:Vp}=Hp;Re.registerHelper("birthDate",Fp);Re.registerHelper("paragraphSplit",Wp);Re.registerHelper("spaceToDash",Up);Re.registerHelper("toLowerCase",qp);Re.registerHelper("MY",Bp);Re.registerHelper("Y",Gp);Re.registerHelper("DMY",Vp);function zp(n){let t=ks("//style.css","utf-8"),s=ks("//resume.hbs","utf-8"),a=Ss("/","theme/partials");return Ip(a).forEach(u=>{let h=/^([^.]+).hbs$/.exec(u);if(!h)return;let d=h[1],p=Ss(a,u),f=ks(p,"utf8");Re.registerPartial(d,f)}),Re.compile(s)({css:t,resume:n})}Ro.exports={render:zp}});y();var $e=Hh(To(),1),Io=$e.default??$e,b2=Io.render??$e.render,M2=Io.pdfRenderOptions??$e.pdfRenderOptions;export{M2 as pdfRenderOptions,b2 as render};
