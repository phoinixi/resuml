...
var zn=Object.create;var A=Object.defineProperty;var Rn=Object.getOwnPropertyDescriptor;var In=Object.getOwnPropertyNames;var Mn=Object.getPrototypeOf,Wn=Object.prototype.hasOwnProperty;var O=(n,s)=>()=>(n&&(s=n(n=0)),s);var y=(n,s)=>()=>(s||n((s={exports:{}}).exports,s),s.exports),V=(n,s)=>{for(var e in s)A(n,e,{get:s[e],enumerable:!0})},U=(n,s,e,t)=>{if(s&&typeof s=="object"||typeof s=="function")for(let i of In(s))!Wn.call(n,i)&&i!==e&&A(n,i,{get:()=>s[i],enumerable:!(t=Rn(s,i))||t.enumerable});return n};var Jn=(n,s,e)=>(e=n!=null?zn(Mn(n)):{},U(s||!n||!n.__esModule?A(e,"default",{value:n,enumerable:!0}):e,n)),D=n=>U(A({},"__esModule",{value:!0}),n);var c=O(()=>{});var F={};V(F,{basename:()=>S,default:()=>Bn,dirname:()=>P,extname:()=>j,isAbsolute:()=>Z,join:()=>G,normalize:()=>Y,parse:()=>K,relative:()=>Q,resolve:()=>X,sep:()=>$});var G,X,P,S,j,$,Z,Y,Q,K,Bn,T=O(()=>{"use strict";c();G=function(){return[].slice.call(arguments).join("/")},X=function(){return[].slice.call(arguments).join("/")},P=function(n){return n.split("/").slice(0,-1).join("/")},S=function(n,s){var e=n.split("/").pop()||"";return s&&e.endsWith(s)?e.slice(0,-s.length):e},j=function(n){var s=n.match(/\.[^.]+$/);return s?s[0]:""},$="/",Z=function(n){return n.charAt(0)==="/"},Y=function(n){return n},Q=function(n,s){return s},K=function(n){return{root:"",dir:P(n),base:S(n),ext:j(n),name:S(n,j(n))}},Bn={join:G,resolve:X,dirname:P,basename:S,extname:j,sep:$,isAbsolute:Z,normalize:Y,relative:Q,parse:K}});var I={};V(I,{createReadStream:()=>dn,createWriteStream:()=>pn,default:()=>qn,existsSync:()=>sn,lstatSync:()=>on,mkdirSync:()=>an,readFileSync:()=>en,readdirSync:()=>tn,rmdirSync:()=>cn,statSync:()=>R,unlinkSync:()=>ln,writeFileSync:()=>rn});function z(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function nn(n){var s=z(n);if(C[s]!==void 0)return C[s];for(var e=Object.keys(C),t=0;t<e.length;t++)if(s.endsWith("/"+e[t])||s===e[t])return C[e[t]]}function N(n){var s=z(n);if((s===""||s===".")&&w["."]!==void 0)return w["."];if(w[s]!==void 0)return w[s];for(var e=Object.keys(w),t=0;t<e.length;t++)if(s.endsWith("/"+e[t])||s===e[t])return w[e[t]]}var C,w,en,tn,sn,rn,an,R,on,ln,cn,dn,pn,qn,M=O(()=>{"use strict";c();C={"assets/stylesheets/style.css":`@import url('https://fonts.googleapis.com/css?family=Lato:300,400,700');
...
`,p.message+="Or, if you meant to create an async function, pass `async: true` as an option.")),p}var _=e.client?s:function(q){var Tn=function(Nn,H){var L=o.shallowCopy(o.createNullProtoObjWherePossible(),q);return H&&(L=o.shallowCopy(L,H)),ae(Nn,e)(L)};return s.apply(e.context,[q||o.createNullProtoObjWherePossible(),a,Tn,wn])};if(e.filename&&typeof Object.defineProperty=="function"){var x=e.filename,Fn=k.basename(x,k.extname(x));try{Object.defineProperty(_,"name",{value:Fn,writable:!1,enumerable:!1,configurable:!0})}catch{}}return _},generateSource:function(){var n=this.opts;n.rmWhitespace&&(this.templateText=this.templateText.replace(/[\r\n]+/g,`
