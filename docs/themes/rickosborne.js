var Oe=Object.create;var I=Object.defineProperty;var Ye=Object.getOwnPropertyDescriptor;var Pe=Object.getOwnPropertyNames;var Ue=Object.getPrototypeOf,Re=Object.prototype.hasOwnProperty;var q=(r,e)=>()=>(r&&(e=r(r=0)),e);var c=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),Z=(r,e)=>{for(var t in e)I(r,t,{get:e[t],enumerable:!0})},B=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let a of Pe(e))!Re.call(r,a)&&a!==t&&I(r,a,{get:()=>e[a],enumerable:!(n=Ye(e,a))||n.enumerable});return r};var We=(r,e,t)=>(t=r!=null?Oe(Ue(r)):{},B(e||!r||!r.__esModule?I(t,"default",{value:r,enumerable:!0}):t,r)),G=r=>B(I({},"__esModule",{value:!0}),r);var i=q(()=>{});var sn={};Z(sn,{createReadStream:()=>an,createWriteStream:()=>on,default:()=>Fe,existsSync:()=>X,lstatSync:()=>en,mkdirSync:()=>nn,readFileSync:()=>K,readdirSync:()=>V,rmdirSync:()=>rn,statSync:()=>Q,unlinkSync:()=>tn,writeFileSync:()=>_});function $(r){return String(r).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function H(r){var e=$(r);if(k[e]!==void 0)return k[e];for(var t=Object.keys(k),n=0;n<t.length;n++)if(e.endsWith("/"+t[n])||e===t[n])return k[t[n]]}function E(r){var e=$(r);if(L[e]!==void 0)return L[e];for(var t=Object.keys(L),n=0;n<t.length;n++)if(e.endsWith("/"+t[n])||e===t[n])return L[t[n]]}var k,L,K,V,X,_,nn,Q,en,tn,rn,an,on,Fe,cn=q(()=>{"use strict";i();k={"example.json":`{
  "awards": [
    {
      "awarder": "Company",
      "date": "2014-11-01",
...
`},L={fn:["date.js","dateFormat.js","findAll.js","firstWord.js","htmlEscape.js","humanUrl.js","imgTag.js","joinWithBetween.js","linkify.js","listTags.js","stringify.js","tag.js"],section:["avatar.js","awards.js","basics.js","certificates.js","contact.js","education.js","error.js","interests.js","languages.js","projects.js","publications.js","references.js","skills.js","volunteer.js","work.js"],".":["README.md","example.json","fn","index.js","package.json","resume.css","rickosborne.json","section","test.js"]};K=function(r,e){var t=H(r);return t!==void 0?t:""},V=function(r,e){var t=E(r);return t===void 0&&(t=[]),e&&e.withFileTypes?t.map(function(n){var a=$(r)+"/"+n,o=E(a)!==void 0;return{name:n,isFile:function(){return!o},isDirectory:function(){return o}}}):t},X=function(r){return H(r)!==void 0||E(r)!==void 0},_=function(){},nn=function(){},Q=function(){return{isFile:function(){return!0},isDirectory:function(){return!1},size:0,mtime:new Date}},en=Q,tn=function(){},rn=function(){},an=function(){return{pipe:function(r){return r},on:function(){return this}}},on=function(){return{write:function(){},end:function(){},on:function(){return this}}},Fe={readFileSync:K,readdirSync:V,existsSync:X,writeFileSync:_,mkdirSync:nn,statSync:Q,lstatSync:en,unlinkSync:tn,rmdirSync:rn,createReadStream:an,createWriteStream:on}});var yn={};Z(yn,{basename:()=>x,default:()=>Je,dirname:()=>O,extname:()=>z,isAbsolute:()=>gn,join:()=>ln,normalize:()=>pn,parse:()=>hn,relative:()=>mn,resolve:()=>un,sep:()=>dn});var ln,un,O,x,z,dn,gn,pn,mn,hn,Je,fn=q(()=>{"use strict";i();ln=function(){return[].slice.call(arguments).join("/")},un=function(){return[].slice.call(arguments).join("/")},O=function(r){return r.split("/").slice(0,-1).join("/")},x=function(r,e){var t=r.split("/").pop()||"";return e&&t.endsWith(e)?t.slice(0,-e.length):t},z=function(r){var e=r.match(/\.[^.]+$/);return e?e[0]:""},dn="/",gn=function(r){return r.charAt(0)==="/"},pn=function(r){return r},mn=function(r,e){return e},hn=function(r){return{root:"",dir:O(r),base:x(r),ext:z(r),name:x(r,z(r))}},Je={join:ln,resolve:un,dirname:O,basename:x,extname:z,sep:dn,isAbsolute:gn,normalize:pn,relative:mn,parse:hn}});var l=c((er,Mn)=>{i();Mn.exports=function(e){return typeof e=="string"?e.replace(/[\u00A0-\u9999<>&]/g,t=>`&#${t.charCodeAt(0)};`):""}});var Dn=c((rr,wn)=>{i();wn.exports=function(e,t,n){let a=null,o=[],h=typeof n=="string"?(m=>m.groups[n]):typeof n=="function"?n:typeof n=="number"?(m=>m[n]):(m=>m[0]);for(;(a=t.exec(e))!=null&&(o.push(h(a)),!!t.flags.includes("g")););return o}});var u=c((ar,vn)=>{i();var jn=l(),bn=Dn();vn.exports=function(e,t,n){if(typeof t!="string"||t==="")return"";let a=bn(e,/#([^.@#]+)/,1)[0],o=bn(e,/\.([^.@#]+)/g,1),h=e.replace(/[.@#].*$/,"");return`<${h}${a?` id="${jn(a)}"`:""} class="${o.join(" ")} ${jn(n||"")}">${t}${h==="img"?"":`</${h}>`}`}});var In=c((sr,Nn)=>{i();var Ze=u();Nn.exports=function(e,t,n){return Ze("div.error",`ERROR: No such section named "${n}".`)}});var Ln=c((lr,kn)=>{i();kn.exports=function(e,t,n){if(typeof e=="string")return e;if(typeof e=="function")return e.apply(t,n||[])}});var p=c((dr,zn)=>{i();var xn=Ln();zn.exports=function(e,t){let n=t,a;return Array.isArray(e)?(n=e,a='<span class="between"></span>'):a=xn(e),!Array.isArray(n)||n.length===0?"":n.map(o=>xn(o)).filter(o=>o!=null&&o!=="").join(a)}});var An=c((pr,Cn)=>{i();var Y=u(),P=l(),Be=p();Cn.exports=function(e){let t=e.basics||{};return`
    ...
    `.trim())}});var b=c((vr,Pn)=>{i();var _e=l();Pn.exports=function(e){return typeof e=="string"?_e(e.replace(/^https?:\/\/|\/$/ig,"")).replace(/^web\.archive\.org\/web\/\d+\/https?:\/\//,"[archived]&nbsp;"):""}});var y=c((Ir,Rn)=>{i();var nt=u(),Un=l();Rn.exports=function(e,t,n){return typeof e!="string"||e===""?"":typeof t=="string"?`<a href="${Un(t)}" class="${Un(n)}" target="_blank" rel="external">${e}</a>`:nt("span",e,"no-url")}});var Jn=c((Lr,Fn)=>{i();var et=u(),Wn=l(),tt={url:"data:image/svg+xml;base64,",email:"data:image/svg+xml;base64,",location:"data:image/svg+xml;base64,",github:"data:image/svg+xml;base64,"};Fn.exports=function(e,t,n,a){let o=(((a.meta||{}).rickosborne||{}).images||{})[e]||tt[e];return o?`<img id="img-${e}" src="${o}" alt="${Wn(t)}" class="${n}">`:et(`span#img-${e}`,Wn(t))}});var Gn=c((zr,Bn)=>{i();var d=u(),Zn=p(),rt=g(),it=b(),R=y(),v=Jn();Bn.exports=function(e,t){let n=e.basics||{},a=n.location||{};return`
        <section id="contact" class="list">
            ...
            ${rt(n.profiles,"section","div","profile",d("h2#basics-profiles",t.basicsProfiles),o=>R(`
                    ...
                    ${v(o.network,o.network,"icon",e)}
                    ${d("span.profile-username",o.username)}
                `,o.url,"profile-url"))}
        </section>
    `.trim()}});var Vn=c((Ar,Kn)=>{i();var Hn=u(),at=l(),ot=g(),st=p();Kn.exports=function(e,t){return Array.isArray(e.languages)&&e.languages.length>1?ot(e.languages,"section","div","language",`<h1>${at(t.languages)}</h1>`,n=>st([Hn("span.language-language",n.language),Hn("span.language-fluency",n.fluency)])):""}});var N=c((Sr,ne)=>{i();var W=l(),Xn=u(),_n=j();ne.exports=function(e,t){let n=(e||{}).startDate,a=(e||{}).endDate;return e==null||n==null&&a==null?"":`
    ...
    `.trim()}});var re=c((Er,te)=>{i();var F=u(),ct=l(),lt=p(),ee=g(),ut=y(),dt=N();te.exports=function(e,t){return ee(e.education,"section","div","education",`<h1>${ct(t.education)}</h1>`,n=>`
    ...
    `.trim())}});var oe=c((Qr,ae)=>{i();var ie=u(),gt=l(),pt=p(),mt=g(),ht=j(),yt=y();ae.exports=function(e,t){return mt(e.certificates,"section","div","certificate",`<h1>${gt(t.certificates)}</h1>`,n=>`
    ...
    `.trim())}});var ce=c((Yr,se)=>{i();se.exports=function(e){return typeof e!="string"||e===""?"":e.replace(/^\s*(\w+:?)/,'<span class="first-word">$1</span>')}});var de=c((Ur,ue)=>{i();var A=u(),ft=l(),Mt=p(),le=g(),wt=N(),Dt=ce(),jt=y();ue.exports=function(e,t){return le(e.work,"section","div","work",`<h1>${ft(t.work)}</h1>`,n=>`
    ...
    `.trim())}});var pe=c((Wr,ge)=>{i();var T=u(),bt=l(),vt=p(),Nt=g(),It=j(),kt=b(),Lt=y();ge.exports=function(e,t){return Nt(e.publications,"section","div","publication",`<h1>${bt(t.publications)}</h1>`,n=>`
    ...
    `.trim())}});var he=c((Jr,me)=>{i();var J=u(),xt=l(),zt=p(),S=g(),Ct=N(),At=b(),Tt=y();me.exports=function(e,t){return S(e.projects,"section",n=>`div.project-${n.type?n.type:"no-type"}`,"project",`<h1>${xt(t.projects)}</h1>`,n=>`
    ...
    `.trim())}});var we=c((Br,Me)=>{i();var ye=u(),St=l(),qt=p(),fe=g(),Et=N(),$t=b(),Qt=y();Me.exports=function(e,t){return fe(e.volunteer,"section","div","volunteer",`<h1>${St(t.volunteer)}</h1>`,n=>`
    ...
    `.trim())}});var Ee=c((ei,qe)=>{i();var Te=(cn(),G(sn)),Se=(fn(),G(yn)),Ft=u(),w=l(),Jt=Te.readFileSync(Se.join("/","resume.css"),{encoding:"utf8"}),Ce=JSON.parse(Te.readFileSync(Se.join("/","package.json"),{encoding:"utf8"})),Zt=[{id:"top",sections:[]},{id:"left",sections:["basics","education","work","volunteer","references"]},{id:"right",sections:["avatar","contact","languages","certificates","publications","awards","projects","skills","interests"]}],Bt={contact:"Contact",basicsEmail:"E-mail",basicsLocation:"Location",basicsPhone:"Phone",basicsProfiles:"Profiles",basicsUrl:"URL",languages:"Languages",education:"Education",certificates:"Certificates",work:"Employment",projects:"Projects",volunteer:"Volunteering",publications:"Publications",awards:"Awards",skills:"Skills",interests:"Interests",references:"References"},Ae={error:In(),basics:An(),avatar:qn(),awards:Yn(),contact:Gn(),languages:Vn(),education:re(),certificates:oe(),work:de(),publications:pe(),projects:he(),volunteer:we(),skills:ve(),interests:ke(),references:ze()};function Gt(r,e,t){console.log(`Rendering section: ${t}`);let a=(Ae[t]||Ae.error)(r,e,t);return console.log(`Rendered: ${typeof a} ${typeof a=="string"?a.length:""}`),a}function Ht(r){let e=r.basics||{},t=r.meta||{},n=t.rickosborne||{},a=Array.isArray(n.layout)?n.layout:Zt,o=Object.assign({},Bt,n.titles||{}),h=Array.isArray(n.customCSS)?n.customCSS.join(`
...
<head>
<meta charset="UTF-8">
<title>Resume for ${w(e.name)}</title>
${t.canonical?`<link rel="canonical" href="${w(t.canonical)}">`:""}
${t.lastModified?`<meta http-equiv="Last-Modified" content="${w(t.lastModified)}">`:""}
${t.version?`<meta http-equiv="Version" content="${w(t.version)}">`:""}
...
body {
    font-family: '${w(m)}', 'Gentium Book Basic', 'Gentium Plus', 'Gentium Basic', 'Times New Roman', 'Times', ui-serif, serif;
}
</style>
<style>${Jt}</style>
${h?`<style>${w(h)}</style>`:""}
...
<article id="resume">
${a.map(D=>Ft(`section#${D.id}`,D.sections.map(Qe=>Gt(r,o,Qe)).join(`
`))).join(`
`)}
</article>
