...
var Vg=Object.create;var Cr=Object.defineProperty;var jg=Object.getOwnPropertyDescriptor;var n0=Object.getOwnPropertyNames;var t0=Object.getPrototypeOf,e0=Object.prototype.hasOwnProperty;var Fo=(u,y)=>()=>(u&&(y=u(u=0)),y);var Et=(u,y)=>()=>(y||u((y={exports:{}}).exports,y),y.exports),r0=(u,y)=>{for(var T in y)Cr(u,T,{get:y[T],enumerable:!0})},Do=(u,y,T,D)=>{if(y&&typeof y=="object"||typeof y=="function")for(let S of n0(y))!e0.call(u,S)&&S!==T&&Cr(u,S,{get:()=>y[S],enumerable:!(D=jg(y,S))||D.enumerable});return u};var i0=(u,y,T)=>(T=u!=null?Vg(t0(u)):{},Do(y||!u||!u.__esModule?Cr(T,"default",{value:u,enumerable:!0}):T,u)),u0=u=>Do(Cr({},"__esModule",{value:!0}),u);var an=Fo(()=>{});var Ko={};r0(Ko,{createReadStream:()=>qo,createWriteStream:()=>$o,default:()=>f0,existsSync:()=>Wo,lstatSync:()=>Ho,mkdirSync:()=>ko,readFileSync:()=>Uo,readdirSync:()=>Mo,rmdirSync:()=>Go,statSync:()=>ji,unlinkSync:()=>zo,writeFileSync:()=>No});function Vi(u){return String(u).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Po(u){var y=Vi(u);if(Ir[y]!==void 0)return Ir[y];for(var T=Object.keys(Ir),D=0;D<T.length;D++)if(y.endsWith("/"+T[D])||y===T[D])return Ir[T[D]]}function Qi(u){var y=Vi(u);if((y===""||y===".")&&he["."]!==void 0)return he["."];if(he[y]!==void 0)return he[y];for(var T=Object.keys(he),D=0;D<T.length;D++)if(y.endsWith("/"+T[D])||y===T[D])return he[T[D]]}var Ir,he,Uo,Mo,Wo,No,ko,ji,Ho,zo,Go,qo,$o,f0,Yo=Fo(()=>{"use strict";an();Ir={"package.json":`{
