...
var Ve=Object.create;var Q=Object.defineProperty;var Be=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var Ue=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty;var U=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var qt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)Q(t,n,{get:e[n],enumerable:!0})},Ft=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of je(e))!ze.call(t,s)&&s!==n&&Q(t,s,{get:()=>e[s],enumerable:!(i=Be(e,s))||i.enumerable});return t};var Ge=(t,e,n)=>(n=t!=null?Ve(Ue(t)):{},Ft(e||!t||!t.__esModule?Q(n,"default",{value:t,enumerable:!0}):n,t)),Vt=t=>Ft(Q({},"__esModule",{value:!0}),t);var p=qt(()=>{});var dt={};We(dt,{createReadStream:()=>Qt,createWriteStream:()=>Yt,default:()=>Je,existsSync:()=>zt,lstatSync:()=>Jt,mkdirSync:()=>Gt,readFileSync:()=>jt,readdirSync:()=>Ut,rmdirSync:()=>Xt,statSync:()=>ut,unlinkSync:()=>Kt,writeFileSync:()=>Wt});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Bt(t){var e=pt(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}function ct(t){var e=pt(t);if((e===""||e===".")&&q["."]!==void 0)return q["."];if(q[e]!==void 0)return q[e];for(var n=Object.keys(q),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return q[n[i]]}var Y,q,jt,Ut,zt,Wt,Gt,ut,Jt,Kt,Xt,Qt,Yt,Je,ft=qt(()=>{"use strict";p();Y={"package.json":`{
  "name": "jsonresume-theme-minimal",
  "version": "0.1.1",
  "description": "Minimal theme for JSON Resume",
  "author": "Pascal Mercier",
  "repository": {
    "type": "git",
    "url": "https://github.com/pmercier/jsonresume-theme-minimal"
  },
  "license": "MIT",
  "dependencies": {
  ...
  "bugs": {
    "url": "https://github.com/pmercier/jsonresume-theme-minimal/issues"
  },
  "homepage": "https://github.com/pmercier/jsonresume-theme-minimal",
  "main": "index.js",
  "devDependencies": {},
  "scripts": {
    "test": "resume export --format html --theme minimal  index"
  }
}
`,"resume.json":`{
  "basics": {
    "name": "Pascal Mercier",
    "label": "Senior UX Engineer",
    "picture": "https://dl.dropboxusercontent.com/u/69246326/pmercier.jpg",
    "email": "mercier.pas@gmail.com",
    "phone": "+33 6 15 19 51 62",
    "website": "",
    "summary": "I'm a full stack developer who loves writing graceful code and designing compelling user experiences. I spent time exploring paths to help the most influencing actors of the industry solving their pains. I am technology agnostic to always be on the edge of our changing world.",
    "location": {
      "address": "17 rue Laganne",
      "postalCode": "31300",
      "city": "Toulouse",
      "countryCode": "FR",
    ...
    "profiles": [
      {
        "network": "LinkedIn",
        "username": "mercierpascal",
        "url": "https://www.linkedin.com/in/mercierpascal"
      },
      {
        "network": "Twitter",
        "username": "pascal_mercier",
        "url": "https://twitter.com/pascal_mercier"
      },
      {
        "network": "Github",
        "username": "pascalmercier",
        "url": "https://github.com/pascalmercier"
      }
    ]
  },
  "work": [
    {
      "company": "Salesforce.com \u2013 Remote",
      "position": "Senior UX Engineer \u2013 Q Branch",
      "website": "http://salesforce.com",
      "startDate": "2015-03-01",
      "endDate": "1970-01-01",
      "summary": "Provide tools and methods to support the rapid scale of the strategic innovation team \u2013 Ignite.",
      "highlights": [
        "Design and prototype customer visions.",
        "Create communication materials to promote the use of the Ignite methodology.",
        "Design and build of an internal content curation platform on Force.com."
      ]
    },
    {
      "company": "Salesforce.com \u2013 Paris, France",
      "position": "Ignite Senior Technical Lead",
      "website": "http://salesforce.com/ignite",
      "startDate": "2012-10-01",
      "endDate": "2015-03-01",
      "summary": "Bring UX and technical expertise in the strategic innovation team \u2013 Ignite. Our mission is to help our most important customers put their customer company vision into shape through ideation workshops.",
      "highlights": [
        "Facilitation of strategic innovation workshops.",
        "Design and prototype the customers' strategic visions crafted during workshops.",
        "Design and build a native iOS app connected to a Force.com back-end to improve collaboration of the Salesforce executives attending the WEF annual meeting at Davos.",
        "Development of responsive websites on Force.com and Heroku to enable the sales organisation with consistent business data and UX/UI guidelines."
      ]
    },
    {
      "company": "Salesforce.com \u2013 Dublin, Ireland",
      "position": "Sales Support Engineer",
      "website": "http://salesforce.com",
      "startDate": "2011-01-31",
      "endDate": "2012-10-01",
      "summary": "Support key deals by creating demo assets and providing technical expertise in the pre-sales organisation.",
      "highlights": [
        "Development of a secure iOS apps distribution platform in Ruby on Heroku and Amazon Web Services for internal use.",
        "Build and delivery of Salesforce events stage demos to showcase the art of the possible.",
        "Direction and creation of demo visuals for promotional videos."
      ]
    },
    {
      "company": "Thales Alenia Space",
      "position": "UX/UI Developer",
      "website": "https://www.thalesgroup.com/en/thales-alenia-space",
      "startDate": "2008-09-01",
      "endDate": "2010-08-31",
      "summary": "R&D in user experience for ground stations of satellites command centers. The key challenges were to move from mainframe infrastructures to distributed applications that communicate via web-services and step-up the usability of UIs.",
      "highlights": [
        "Research in user needs and technical specificities.",
        "Build prototypes to integrate a Java/JEE back-end with Adobe Flex and Google GWT front-ends.",
        "Construction of a cross-department icons library to minimise the use of fraudulent resources and standardize overall look & feel."
      ]
    }
  ],
  "volunteer": [
    {
      "organization": "Comme Un Seul Homme",
      "position": "Project Lead",
      "website": "http://www.c1sh.fr/",
      "startDate": "2015-03-10",
      "endDate": "2015-10-30",
      "summary": "Co-built the website & blog of the foundation Comme Un Seul Homme as part of the Salesforce.org initiative.",
      "highlights": [
        "Collect the requirements from the project stakeholders.",
        "Design the website & blog architecture on top the Force.com platform.",
        "Lead the development phase of the website & blog.",
        "Training and handover of the solution to the next group of volonteers."
      ]
    },
    {
      "organization": "ESIDG \u2013 Tbilisi, Georgia",
      "position": "Project Manager",
      "website": "http://www.inovdev.ge",
      "startDate": "2011-06-26",
      "endDate": "2011-07-11",
      "summary": "Initiated the project with Salesforce.com Foundation to deploy the first Salesforce.com solution in Georgia.",
      "highlights": [
        "Deployment of a end-to-end Salesforce solution.",
        "Provide extensive training for 10 users.",
        "Improve collaboration and assets management."
      ]
    }
  ],
  "education": [
    {
      "institution": "Universit\xE9 Toulouse 2",
      "area": "ICE (Informatique Collaborative en Entreprise)",
      "studyType": "Master",
  ...
  "awards": [
    {
      ...
      "date": "2013-11-11",
      "awarder": "Salesforce.com",
      "summary": "System and method for updating infographics based on multiple social networks.\\nThe initial project was launched as a public Facebook app developed in Ruby and hosted on Heroku to pull social networks data via the Radian6 API in order to predict results of the french presidential elections in 2012. The concept has been leveraged in very diverse contexts since then."
    }
  ],
  "publications": [],
  "skills": [
...
<html>
		...
		<div class="col-sm-9">
			...
			<div class="col-sm-12 work-item">
				<h4 class="strike-through">
					<span>{{company}}</span>
					<span class="date">
						{{startDate}} \u2014 {{#if endDate.length}}{{#equal endDate "1970-01-01" }}Now{{else}}{{endDate}}{{/equal}}{{/if}}
					</span>
				</h4>
				{{#website}}
	...
	<section id="education" class="row">
		...
		<div class="col-sm-9">
			...
			<div class="col-sm-12">
				<h4 class="strike-through">
					<span>{{breaklines institution}}</span>
					<span class="date">
						{{startDate}} \u2014 {{endDate}}
					</span>
				</h4>
...
`,"style.css":`@import url(http://fonts.googleapis.com/css?family=Lato:300,400,700);
...
#skills .keywords li:before, #education .courses li:before {
	content: "";
}
#skills .keywords li, #education .courses li {
...
@media print {
	...
	#work .position, #volunteer .position, #work .summary, #volunteer .summary {
		margin-bottom: 0px;
		padding-bottom: 8px;
	}
	.work-item {
