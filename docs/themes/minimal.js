var Ve=Object.create;var X=Object.defineProperty;var Be=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var Ue=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var qt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)X(t,n,{get:e[n],enumerable:!0})},Ft=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of je(e))!ze.call(t,s)&&s!==n&&X(t,s,{get:()=>e[s],enumerable:!(i=Be(e,s))||i.enumerable});return t};var Ge=(t,e,n)=>(n=t!=null?Ve(Ue(t)):{},Ft(e||!t||!t.__esModule?X(n,"default",{value:t,enumerable:!0}):n,t)),Vt=t=>Ft(X({},"__esModule",{value:!0}),t);var p=qt(()=>{});var dt={};We(dt,{createReadStream:()=>Qt,createWriteStream:()=>Yt,default:()=>Je,existsSync:()=>zt,lstatSync:()=>Jt,mkdirSync:()=>Gt,readFileSync:()=>jt,readdirSync:()=>Ut,rmdirSync:()=>Xt,statSync:()=>ut,unlinkSync:()=>Kt,writeFileSync:()=>Wt});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Bt(t){var e=pt(t);if(Q[e]!==void 0)return Q[e];for(var n=Object.keys(Q),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Q[n[i]]}function ct(t){var e=pt(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}var Q,Y,jt,Ut,zt,Wt,Gt,ut,Jt,Kt,Xt,Qt,Yt,Je,ft=qt(()=>{"use strict";p();Q={"package.json":`{
