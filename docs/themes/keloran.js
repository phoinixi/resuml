var Ji=Object.create;var Te=Object.defineProperty;var Qi=Object.getOwnPropertyDescriptor;var Zi=Object.getOwnPropertyNames;var ji=Object.getPrototypeOf,ki=Object.prototype.hasOwnProperty;var Mt=(d,m)=>()=>(d&&(m=d(d=0)),m);var Bn=(d,m)=>()=>(m||d((m={exports:{}}).exports,m),m.exports),ns=(d,m)=>{for(var S in m)Te(d,S,{get:m[S],enumerable:!0})},Ut=(d,m,S,u)=>{if(m&&typeof m=="object"||typeof m=="function")for(let E of Zi(m))!ki.call(d,E)&&E!==S&&Te(d,E,{get:()=>m[E],enumerable:!(u=Qi(m,E))||u.enumerable});return d};var es=(d,m,S)=>(S=d!=null?Ji(ji(d)):{},Ut(m||!d||!d.__esModule?Te(S,"default",{value:d,enumerable:!0}):S,d)),ts=d=>Ut(Te({},"__esModule",{value:!0}),d);var A=Mt(()=>{});var Ot={};ns(Ot,{createReadStream:()=>Ht,createWriteStream:()=>Kt,default:()=>rs,existsSync:()=>Lt,lstatSync:()=>qt,mkdirSync:()=>Nt,readFileSync:()=>Bt,readdirSync:()=>Pt,rmdirSync:()=>Yt,statSync:()=>et,unlinkSync:()=>At,writeFileSync:()=>zt});function nt(d){return String(d).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ft(d){var m=nt(d);if(Ie[m]!==void 0)return Ie[m];for(var S=Object.keys(Ie),u=0;u<S.length;u++)if(m.endsWith("/"+S[u])||m===S[u])return Ie[S[u]]}function ke(d){var m=nt(d);if(Me[m]!==void 0)return Me[m];for(var S=Object.keys(Me),u=0;u<S.length;u++)if(m.endsWith("/"+S[u])||m===S[u])return Me[S[u]]}var Ie,Me,Bt,Pt,Lt,zt,Nt,et,qt,At,Yt,Ht,Kt,rs,Vt=Mt(()=>{"use strict";A();Ie={"package.json":`{
