var qt=Object.create;var K=Object.defineProperty;var jt=Object.getOwnPropertyDescriptor;var Ut=Object.getOwnPropertyNames;var Wt=Object.getPrototypeOf,Yt=Object.prototype.hasOwnProperty;var M=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,n)=>(typeof require<"u"?require:t)[n]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var Me=(e,t)=>()=>(e&&(t=e(e=0)),t);var m=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Gt=(e,t)=>{for(var n in t)K(e,n,{get:t[n],enumerable:!0})},Fe=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of Ut(t))!Yt.call(e,s)&&s!==n&&K(e,s,{get:()=>t[s],enumerable:!(i=jt(t,s))||i.enumerable});return e};var zt=(e,t,n)=>(n=e!=null?qt(Wt(e)):{},Fe(t||!e||!e.__esModule?K(n,"default",{value:e,enumerable:!0}):n,e)),Ve=e=>Fe(K({},"__esModule",{value:!0}),e);var p=Me(()=>{});var fe={};Gt(fe,{createReadStream:()=>Xe,createWriteStream:()=>Qe,default:()=>Kt,existsSync:()=>We,lstatSync:()=>ze,mkdirSync:()=>Ge,readFileSync:()=>je,readdirSync:()=>Ue,rmdirSync:()=>Je,statSync:()=>ue,unlinkSync:()=>Ke,writeFileSync:()=>Ye});function pe(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function qe(e){var t=pe(e);if(J[t]!==void 0)return J[t];for(var n=Object.keys(J),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return J[n[i]]}function ce(e){var t=pe(e);if(X[t]!==void 0)return X[t];for(var n=Object.keys(X),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return X[n[i]]}var J,X,je,Ue,We,Ye,Ge,ue,ze,Ke,Je,Xe,Qe,Kt,de=Me(()=>{"use strict";p();J={"package.json":`{
