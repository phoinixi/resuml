var je=Object.create;var Y=Object.defineProperty;var Fe=Object.getOwnPropertyDescriptor;var Ve=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,Je=Object.prototype.hasOwnProperty;var V=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var qt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Ue=(t,e)=>{for(var n in e)Y(t,n,{get:e[n],enumerable:!0})},jt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Ve(e))!Je.call(t,s)&&s!==n&&Y(t,s,{get:()=>e[s],enumerable:!(i=Fe(e,s))||i.enumerable});return t};var Ge=(t,e,n)=>(n=t!=null?je(ze(t)):{},jt(e||!t||!t.__esModule?Y(n,"default",{value:t,enumerable:!0}):n,t)),Ft=t=>jt(Y({},"__esModule",{value:!0}),t);var p=qt(()=>{});var ft={};Ue(ft,{createReadStream:()=>Xt,createWriteStream:()=>Zt,default:()=>We,existsSync:()=>Ut,lstatSync:()=>Kt,mkdirSync:()=>Wt,readFileSync:()=>zt,readdirSync:()=>Jt,rmdirSync:()=>Qt,statSync:()=>ut,unlinkSync:()=>Yt,writeFileSync:()=>Gt});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Vt(t){var e=pt(t);if(Q[e]!==void 0)return Q[e];for(var n=Object.keys(Q),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Q[n[i]]}function ct(t){var e=pt(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}var Q,X,zt,Jt,Ut,Gt,Wt,ut,Kt,Yt,Qt,Xt,Zt,We,dt=qt(()=>{"use strict";p();Q={"assets/link.svg":`<?xml version="1.0" encoding="UTF-8"?>\r
