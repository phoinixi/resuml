var cf=Object.create;var Xr=Object.defineProperty;var df=Object.getOwnPropertyDescriptor;var ff=Object.getOwnPropertyNames;var hf=Object.getPrototypeOf,mf=Object.prototype.hasOwnProperty;var ls=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(n,a)=>(typeof require<"u"?require:n)[a]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Ni=(t,n)=>()=>(t&&(n=t(t=0)),n);var H=(t,n)=>()=>(n||t((n={exports:{}}).exports,n),n.exports),us=(t,n)=>{for(var a in n)Xr(t,a,{get:n[a],enumerable:!0})},cs=(t,n,a,i)=>{if(n&&typeof n=="object"||typeof n=="function")for(let l of ff(n))!mf.call(t,l)&&l!==a&&Xr(t,l,{get:()=>n[l],enumerable:!(i=df(n,l))||i.enumerable});return t};var pf=(t,n,a)=>(a=t!=null?cf(hf(t)):{},cs(n||!t||!t.__esModule?Xr(a,"default",{value:t,enumerable:!0}):a,t)),ds=t=>cs(Xr({},"__esModule",{value:!0}),t);var C=Ni(()=>{});var ks={};us(ks,{createReadStream:()=>bs,createWriteStream:()=>ws,default:()=>gf,existsSync:()=>ps,lstatSync:()=>ys,mkdirSync:()=>Fs,readFileSync:()=>hs,readdirSync:()=>ms,rmdirSync:()=>_s,statSync:()=>Bi,unlinkSync:()=>vs,writeFileSync:()=>gs});function Ri(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function fs(t){var n=Ri(t);if($r[n]!==void 0)return $r[n];for(var a=Object.keys($r),i=0;i<a.length;i++)if(n.endsWith("/"+a[i])||n===a[i])return $r[a[i]]}function Ti(t){var n=Ri(t);if(ea[n]!==void 0)return ea[n];for(var a=Object.keys(ea),i=0;i<a.length;i++)if(n.endsWith("/"+a[i])||n===a[i])return ea[a[i]]}var $r,ea,hs,ms,ps,gs,Fs,Bi,ys,vs,_s,bs,ws,gf,Us=Ni(()=>{"use strict";C();$r={"countries.json":`[
  {
    "code": "AD",
