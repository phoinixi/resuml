var Vt=Object.create;var J=Object.defineProperty;var qt=Object.getOwnPropertyDescriptor;var jt=Object.getOwnPropertyNames;var Ut=Object.getPrototypeOf,Gt=Object.prototype.hasOwnProperty;var q=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,n)=>(typeof require<"u"?require:t)[n]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var Me=(e,t)=>()=>(e&&(t=e(e=0)),t);var m=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Wt=(e,t)=>{for(var n in t)J(e,n,{get:t[n],enumerable:!0})},Be=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of jt(t))!Gt.call(e,s)&&s!==n&&J(e,s,{get:()=>t[s],enumerable:!(i=qt(t,s))||i.enumerable});return e};var zt=(e,t,n)=>(n=e!=null?Vt(Ut(e)):{},Be(t||!e||!e.__esModule?J(n,"default",{value:e,enumerable:!0}):n,e)),Fe=e=>Be(J({},"__esModule",{value:!0}),e);var c=Me(()=>{});var ue={};Wt(ue,{createReadStream:()=>Ye,createWriteStream:()=>Xe,default:()=>Kt,existsSync:()=>Ue,lstatSync:()=>ze,mkdirSync:()=>We,readFileSync:()=>qe,readdirSync:()=>je,rmdirSync:()=>Je,statSync:()=>ce,unlinkSync:()=>Ke,writeFileSync:()=>Ge});function pe(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ve(e){var t=pe(e);if(Y[t]!==void 0)return Y[t];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return Y[n[i]]}function le(e){var t=pe(e);if(X[t]!==void 0)return X[t];for(var n=Object.keys(X),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return X[n[i]]}var Y,X,qe,je,Ue,Ge,We,ce,ze,Ke,Je,Ye,Xe,Kt,fe=Me(()=>{"use strict";c();Y={"package.json":`{
