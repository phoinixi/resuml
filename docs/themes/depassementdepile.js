var Ll=Object.create;var Re=Object.defineProperty;var Il=Object.getOwnPropertyDescriptor;var Hl=Object.getOwnPropertyNames;var Al=Object.getPrototypeOf,Fl=Object.prototype.hasOwnProperty;var Tt=(s=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(s,{get:(i,o)=>(typeof require<"u"?require:i)[o]}):s)(function(s){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+s+'" is not supported')});var Is=(s,i)=>()=>(s&&(i=s(s=0)),i);var W=(s,i)=>()=>(i||s((i={exports:{}}).exports,i),i.exports),Wl=(s,i)=>{for(var o in i)Re(s,o,{get:i[o],enumerable:!0})},Hs=(s,i,o,l)=>{if(i&&typeof i=="object"||typeof i=="function")for(let c of Hl(i))!Fl.call(s,c)&&c!==o&&Re(s,c,{get:()=>i[c],enumerable:!(l=Il(i,c))||l.enumerable});return s};var Ul=(s,i,o)=>(o=s!=null?Ll(Al(s)):{},Hs(i||!s||!s.__esModule?Re(o,"default",{value:s,enumerable:!0}):o,s)),As=s=>Hs(Re({},"__esModule",{value:!0}),s);var M=Is(()=>{});var kn={};Wl(kn,{createReadStream:()=>Zs,createWriteStream:()=>Js,default:()=>Vl,existsSync:()=>Vs,lstatSync:()=>Gs,mkdirSync:()=>qs,readFileSync:()=>Ws,readdirSync:()=>Us,rmdirSync:()=>Bs,statSync:()=>_n,unlinkSync:()=>zs,writeFileSync:()=>js});function vn(s){return String(s).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Fs(s){var i=vn(s);if(Le[i]!==void 0)return Le[i];for(var o=Object.keys(Le),l=0;l<o.length;l++)if(i.endsWith("/"+o[l])||i===o[l])return Le[o[l]]}function yn(s){var i=vn(s);if(Ie[i]!==void 0)return Ie[i];for(var o=Object.keys(Ie),l=0;l<o.length;l++)if(i.endsWith("/"+o[l])||i===o[l])return Ie[o[l]]}var Le,Ie,Ws,Us,Vs,js,qs,_n,Gs,zs,Bs,Zs,Js,Vl,wn=Is(()=>{"use strict";M();Le={"package.json":`{
