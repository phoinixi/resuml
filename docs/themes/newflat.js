...
var Bt=Object.create;var X=Object.defineProperty;var Ft=Object.getOwnPropertyDescriptor;var jt=Object.getOwnPropertyNames;var Ut=Object.getPrototypeOf,zt=Object.prototype.hasOwnProperty;var j=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,n)=>(typeof require<"u"?require:t)[n]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var Ve=(e,t)=>()=>(e&&(t=e(e=0)),t);var m=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Wt=(e,t)=>{for(var n in t)X(e,n,{get:t[n],enumerable:!0})},qe=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of jt(t))!zt.call(e,s)&&s!==n&&X(e,s,{get:()=>t[s],enumerable:!(i=Ft(t,s))||i.enumerable});return e};var Gt=(e,t,n)=>(n=e!=null?Bt(Ut(e)):{},qe(t||!e||!e.__esModule?X(n,"default",{value:e,enumerable:!0}):n,e)),Be=e=>qe(X({},"__esModule",{value:!0}),e);var p=Ve(()=>{});var fe={};Wt(fe,{createReadStream:()=>Xe,createWriteStream:()=>Ze,default:()=>Kt,existsSync:()=>ze,lstatSync:()=>Ke,mkdirSync:()=>Ge,readFileSync:()=>je,readdirSync:()=>Ue,rmdirSync:()=>Ye,statSync:()=>ue,unlinkSync:()=>Je,writeFileSync:()=>We});function pe(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Fe(e){var t=pe(e);if(Z[t]!==void 0)return Z[t];for(var n=Object.keys(Z),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return Z[n[i]]}function ce(e){var t=pe(e);if((t===""||t===".")&&V["."]!==void 0)return V["."];if(V[t]!==void 0)return V[t];for(var n=Object.keys(V),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return V[n[i]]}var Z,V,je,Ue,ze,We,Ge,ue,Ke,Je,Ye,Xe,Ze,Kt,de=Ve(()=>{"use strict";p();Z={"package.json":`{
