...
var si=Object.create;var te=Object.defineProperty;var ci=Object.getOwnPropertyDescriptor;var fi=Object.getOwnPropertyNames;var ui=Object.getPrototypeOf,Fi=Object.prototype.hasOwnProperty;var ye=(e,n)=>()=>(e&&(n=e(e=0)),n);var M=(e,n)=>()=>(n||e((n={exports:{}}).exports,n),n.exports),mi=(e,n)=>{for(var t in n)te(e,t,{get:n[t],enumerable:!0})},je=(e,n,t,s)=>{if(n&&typeof n=="object"||typeof n=="function")for(let d of fi(n))!Fi.call(e,d)&&d!==t&&te(e,d,{get:()=>n[d],enumerable:!(s=ci(n,d))||s.enumerable});return e};var gi=(e,n,t)=>(t=e!=null?si(ui(e)):{},je(n||!e||!e.__esModule?te(t,"default",{value:e,enumerable:!0}):t,e)),pi=e=>je(te({},"__esModule",{value:!0}),e);var h=ye(()=>{});var Re={};mi(Re,{createReadStream:()=>Pe,createWriteStream:()=>De,default:()=>hi,existsSync:()=>Te,lstatSync:()=>Be,mkdirSync:()=>ke,readFileSync:()=>Se,readdirSync:()=>Ae,rmdirSync:()=>Ie,statSync:()=>ue,unlinkSync:()=>Me,writeFileSync:()=>xe});function fe(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function we(e){var n=fe(e);if(re[n]!==void 0)return re[n];for(var t=Object.keys(re),s=0;s<t.length;s++)if(n.endsWith("/"+t[s])||n===t[s])return re[t[s]]}function ce(e){var n=fe(e);if((n===""||n===".")&&Z["."]!==void 0)return Z["."];if(Z[n]!==void 0)return Z[n];for(var t=Object.keys(Z),s=0;s<t.length;s++)if(n.endsWith("/"+t[s])||n===t[s])return Z[t[s]]}var re,Z,Se,Ae,Te,xe,ke,ue,Be,Me,Ie,Pe,De,hi,Ne=ye(()=>{"use strict";h();re={"package.json":`{
