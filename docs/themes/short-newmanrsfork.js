...
var Ve=Object.create;var Y=Object.defineProperty;var Fe=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Bt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)Y(t,n,{get:e[n],enumerable:!0})},qt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of je(e))!Ue.call(t,s)&&s!==n&&Y(t,s,{get:()=>e[s],enumerable:!(i=Fe(e,s))||i.enumerable});return t};var Ge=(t,e,n)=>(n=t!=null?Ve(ze(t)):{},qt(e||!t||!t.__esModule?Y(n,"default",{value:t,enumerable:!0}):n,t)),Vt=t=>qt(Y({},"__esModule",{value:!0}),t);var p=Bt(()=>{});var dt={};We(dt,{createReadStream:()=>Xt,createWriteStream:()=>Qt,default:()=>Je,existsSync:()=>Ut,lstatSync:()=>Jt,mkdirSync:()=>Gt,readFileSync:()=>jt,readdirSync:()=>zt,rmdirSync:()=>Yt,statSync:()=>ut,unlinkSync:()=>Kt,writeFileSync:()=>Wt});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ft(t){var e=pt(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}function ct(t){var e=pt(t);if((e===""||e===".")&&B["."]!==void 0)return B["."];if(B[e]!==void 0)return B[e];for(var n=Object.keys(B),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return B[n[i]]}var X,B,jt,zt,Ut,Wt,Gt,ut,Jt,Kt,Yt,Xt,Qt,Je,ft=Bt(()=>{"use strict";p();X={"package.json":`{
