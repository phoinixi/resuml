...
var qt=Object.create;var J=Object.defineProperty;var Ft=Object.getOwnPropertyDescriptor;var jt=Object.getOwnPropertyNames;var Ut=Object.getPrototypeOf,Wt=Object.prototype.hasOwnProperty;var j=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,i)=>(typeof require<"u"?require:t)[i]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var Be=(e,t)=>()=>(e&&(t=e(e=0)),t);var g=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Kt=(e,t)=>{for(var i in t)J(e,i,{get:t[i],enumerable:!0})},Ve=(e,t,i,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of jt(t))!Wt.call(e,s)&&s!==i&&J(e,s,{get:()=>t[s],enumerable:!(n=Ft(t,s))||n.enumerable});return e};var Gt=(e,t,i)=>(i=e!=null?qt(Ut(e)):{},Ve(t||!e||!e.__esModule?J(i,"default",{value:e,enumerable:!0}):i,e)),qe=e=>Ve(J({},"__esModule",{value:!0}),e);var p=Be(()=>{});var ue={};Kt(ue,{createReadStream:()=>Xe,createWriteStream:()=>Ze,default:()=>zt,existsSync:()=>We,lstatSync:()=>ze,mkdirSync:()=>Ge,readFileSync:()=>je,readdirSync:()=>Ue,rmdirSync:()=>Je,statSync:()=>pe,unlinkSync:()=>Ye,writeFileSync:()=>Ke});function ce(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Fe(e){var t=ce(e);if(X[t]!==void 0)return X[t];for(var i=Object.keys(X),n=0;n<i.length;n++)if(t.endsWith("/"+i[n])||t===i[n])return X[i[n]]}function he(e){var t=ce(e);if((t===""||t===".")&&B["."]!==void 0)return B["."];if(B[t]!==void 0)return B[t];for(var i=Object.keys(B),n=0;n<i.length;n++)if(t.endsWith("/"+i[n])||t===i[n])return B[i[n]]}var X,B,je,Ue,We,Ke,Ge,pe,ze,Ye,Je,Xe,Ze,zt,fe=Be(()=>{"use strict";p();X={"package.json":`{
