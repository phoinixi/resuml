var je=Object.create;var J=Object.defineProperty;var Ve=Object.getOwnPropertyDescriptor;var Fe=Object.getOwnPropertyNames;var We=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty;var V=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Tt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Ge=(t,e)=>{for(var n in e)J(t,n,{get:e[n],enumerable:!0})},Bt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Fe(e))!ze.call(t,s)&&s!==n&&J(t,s,{get:()=>e[s],enumerable:!(i=Ve(e,s))||i.enumerable});return t};var Ue=(t,e,n)=>(n=t!=null?je(We(t)):{},Bt(e||!t||!t.__esModule?J(n,"default",{value:t,enumerable:!0}):n,t)),qt=t=>Bt(J({},"__esModule",{value:!0}),t);var p=Tt(()=>{});var ut={};Ge(ut,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>Ke,existsSync:()=>Wt,lstatSync:()=>Ut,mkdirSync:()=>Gt,readFileSync:()=>Vt,readdirSync:()=>Ft,rmdirSync:()=>Jt,statSync:()=>pt,unlinkSync:()=>Kt,writeFileSync:()=>zt});function ct(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function jt(t){var e=ct(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}function ht(t){var e=ct(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}var Y,X,Vt,Ft,Wt,zt,Gt,pt,Ut,Kt,Jt,Yt,Xt,Ke,dt=Tt(()=>{"use strict";p();Y={"package.json":`{
  "name": "jsonresume-theme-flat-optimized",
  "version": "0.0.2",
  "description": "The JSON Resume default theme optimized with break rules and optional address",
  "author": "Mattias Erming, Marco Kaul",
  "repository": {
    "type": "git",
    "url": "http://github.com/maggo/jsonresume-theme-flat-optimized"
  },
  "scripts": {
    "start": "resume serve"
  },
...
@media (max-width: 480px) {
	...
	<section id="contact" class="row">
		...
		<div class="col-sm-9">
			...
			<div class="col-sm-6">
				<strong>Email</strong>
				<div class="email">marcokaul@gmail.com</div>
			</div>
			<div class="col-sm-6">
				<strong>Phone</strong>
				<div class="phone">0176 63713215</div>
			</div>
			<div class="col-sm-6">
				<strong>Website</strong>
				<div class="website">
					<a href="https://mar.co.de">https://mar.co.de</a>
				</div>
			</div>
			<div class="col-sm-6">
				<strong>Location</strong>
				<div class="location">
					Berliner Stra\xDFe 14<br>
					68161 Mannheim DE 
				</div>
			</div>
			</div>
	...
	<section id="about" class="row">
		...
		<div class="col-sm-9">
			<p>Hi! I&#x27;m an aspiring full-stack developer experimenting with all kinds of technologies. Currently I&#x27;m venturing into the awesome world of React development and ES2015 app structuring and DevOps with Webpack, trying to learn new stuff every day to build the best web apps possible. Currently I do general CMS Frontend development, mostly on top of Drupal with an eye on maintainability and code style. I love to try out and learn about new things! How can one think about javascript fatique when there&#x27;s so much awesome stuff in the world to learn?</p>
		</div>
	</section>
		...
		<div class="col-sm-9">
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="username">
						<div class="url">
							<a href="https://twitter.com/mediaquery">@mediaquery</a>
						</div>
					</div>
				</div>
				<div class="col-sm-6">
					...
					<div class="username">
						<div class="url">
							<a href="https://github.com/maggo">maggo</a>
						</div>
					</div>
				</div>
				<div class="col-sm-6">
					<strong class="network">
						...
						<div class="url">
							<a href="https://www.linkedin.com/in/marcokaul">https://www.linkedin.com/in/marcokaul</a>
						</div>
				</div>
			</div>
		</div>
		...
		<div class="col-sm-9">
			...
			<div class="col-sm-12">
				<h4 class="strike-through">
					<span>UEBERBIT GmbH</span>
					<span class="date">
						May 2013 \u2014 now
					</span>
				</h4>
				<div class="website pull-right">
					<a href="https://www.ueberbit.de/">https://www.ueberbit.de/</a>
				</div>
				<div class="position">
					Web- &amp; Application-Developer
				</div>
				<div class="summary">
					<p>Developed business websites and intranets with Drupal and a B2B application suit for a major german marketing agency using angular.</p>
				</div>
			</div>
			<div class="col-sm-12">
				<h4 class="strike-through">
					<span>Dots United GmbH</span>
					<span class="date">
						November 2011 \u2014 May 2013
					</span>
				</h4>
				<div class="website pull-right">
					<a href="https://dotsunited.de/">https://dotsunited.de/</a>
				</div>
				<div class="position">
					Webdeveloper
				</div>
				<div class="summary">
					<p>Built and maintained websites with symfony and wordpress, rebuilt a flash application in pure javascript</p>
				</div>
			</div>
			</div>
		</div>
	...
	<section id="education" class="row">
		...
		<div class="col-sm-9">
			...
			<div class="col-sm-12">
				<h4 class="strike-through">
					<span>SRH Fachschule Heidelberg</span>
					<span class="date">
						2009 \u2014 2011
					</span>
				</h4>
...
`,"resume.json":`{
  "basics": {
    ...
    "picture": "",
    "email": "marcokaul@gmail.com",
    "phone": "0176 63713215",
    "website": "https://mar.co.de",
    "summary": "Hi! I'm an aspiring full-stack developer experimenting with all kinds of technologies. Currently I'm venturing into the awesome world of React development and ES2015 app structuring and DevOps with Webpack, trying to learn new stuff every day to build the best web apps possible. Currently I do general CMS Frontend development, mostly on top of Drupal with an eye on maintainability and code style. I love to try out and learn about new things! How can one think about javascript fatique when there's so much awesome stuff in the world to learn?",
    "location": {
      "address": "Berliner Stra\xDFe 14",
      "postalCode": "68161",
      "city": "Mannheim",
      "countryCode": "DE",
      "region": ""
    ...
    "profiles": [
      {
        "network": "Twitter",
        "username": "@mediaquery",
        "url": "https://twitter.com/mediaquery"
      },
      {
        "network": "GitHub",
        "username": "maggo",
        "url": "https://github.com/maggo"
      },
      {
        "network": "LinkedIn",
        "username": "",
        "url": "https://www.linkedin.com/in/marcokaul"
      }
    ]
  },
  "work": [
    {
      ...
      "website": "https://www.ueberbit.de/",
      "startDate": "May 2013",
      "endDate": "now",
      "summary": "Developed business websites and intranets with Drupal and a B2B application suit for a major german marketing agency using angular.",
      "highlights": []
    },
    {
      "company": "Dots United GmbH",
      "position": "Webdeveloper",
      "website": "https://dotsunited.de/",
      "startDate": "November 2011",
      "endDate": "May 2013",
      "summary": "Built and maintained websites with symfony and wordpress, rebuilt a flash application in pure javascript",
      "highlights": []
    }
  ],
  "volunteer": [],
  "education": [
    {
      "institution": "SRH Fachschule Heidelberg",
      "area": "Game- and Multimedia-development",
      "studyType": "",
      "startDate": "2009",
      "endDate": "2011",
      "gpa": "",
	...
	<section id="contact" class="row">
		...
		<div class="col-sm-9">
			...
			<div class="col-sm-6">
				...
				<div class="location">
					{{address}}<br>
					{{postalCode}} {{city}} {{countryCode}} {{region}}
				</div>
			</div>
			{{/location}}
			</div>
...
<div class="col-sm-6">
<strong>Email</strong>
<div class="email"><a class="__cf_email__" href="/cdn-cgi/l/email-protection" data-cfemail="620f0310010d0903170e22050f030b0e4c010d0f">[email&#160;protected]</a><script data-cfhash='f9e31' type="text/javascript">/* <![CDATA[ */!function(t,e,r,n,c,a,p){try{t=document.currentScript||function(){for(t=document.getElementsByTagName('script'),e=t.length;e--;)if(t[e].getAttribute('data-cfhash'))return t[e]}();if(t&&(c=t.previousSibling)){p=t.parentNode;if(a=c.getAttribute('data-cfemail')){for(e='',r='0x'+a.substr(0,2)|0,n=2;a.length-n;n+=2)e+='%'+('0'+('0x'+a.substr(n,2)^r).toString(16)).slice(-2);p.replaceChild(document.createTextNode(decodeURIComponent(e)),c)}p.removeChild(t)}}catch(u){}}()/* ]]> */<\/script></div>
</div>
<div class="col-sm-6">
<strong>Phone</strong>
<div class="phone">0176 63713215</div>
