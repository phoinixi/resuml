...
var je=Object.create;var Y=Object.defineProperty;var Ve=Object.getOwnPropertyDescriptor;var Fe=Object.getOwnPropertyNames;var We=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Tt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Ge=(t,e)=>{for(var n in e)Y(t,n,{get:e[n],enumerable:!0})},Bt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Fe(e))!ze.call(t,s)&&s!==n&&Y(t,s,{get:()=>e[s],enumerable:!(i=Ve(e,s))||i.enumerable});return t};var Ue=(t,e,n)=>(n=t!=null?je(We(t)):{},Bt(e||!t||!t.__esModule?Y(n,"default",{value:t,enumerable:!0}):n,t)),qt=t=>Bt(Y({},"__esModule",{value:!0}),t);var p=Tt(()=>{});var ut={};Ge(ut,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>Ke,existsSync:()=>Wt,lstatSync:()=>Ut,mkdirSync:()=>Gt,readFileSync:()=>Vt,readdirSync:()=>Ft,rmdirSync:()=>Jt,statSync:()=>pt,unlinkSync:()=>Kt,writeFileSync:()=>zt});function ct(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function jt(t){var e=ct(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}function ht(t){var e=ct(t);if((e===""||e===".")&&B["."]!==void 0)return B["."];if(B[e]!==void 0)return B[e];for(var n=Object.keys(B),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return B[n[i]]}var X,B,Vt,Ft,Wt,zt,Gt,pt,Ut,Kt,Jt,Yt,Xt,Ke,dt=Tt(()=>{"use strict";p();X={"package.json":`{
