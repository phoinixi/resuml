...
var Fe=Object.create;var Y=Object.defineProperty;var Ve=Object.getOwnPropertyDescriptor;var Be=Object.getOwnPropertyNames;var je=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Mt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Ue=(t,e)=>{for(var n in e)Y(t,n,{get:e[n],enumerable:!0})},Tt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Be(e))!ze.call(t,s)&&s!==n&&Y(t,s,{get:()=>e[s],enumerable:!(i=Ve(e,s))||i.enumerable});return t};var We=(t,e,n)=>(n=t!=null?Fe(je(t)):{},Tt(e||!t||!t.__esModule?Y(n,"default",{value:t,enumerable:!0}):n,t)),Ft=t=>Tt(Y({},"__esModule",{value:!0}),t);var p=Mt(()=>{});var ct={};Ue(ct,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>Ge,existsSync:()=>zt,lstatSync:()=>Gt,mkdirSync:()=>Wt,readFileSync:()=>Bt,readdirSync:()=>jt,rmdirSync:()=>Jt,statSync:()=>pt,unlinkSync:()=>Kt,writeFileSync:()=>Ut});function ut(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Vt(t){var e=ut(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}function lt(t){var e=ut(t);if((e===""||e===".")&&T["."]!==void 0)return T["."];if(T[e]!==void 0)return T[e];for(var n=Object.keys(T),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return T[n[i]]}var X,T,Bt,jt,zt,Ut,Wt,pt,Gt,Kt,Jt,Yt,Xt,Ge,ft=Mt(()=>{"use strict";p();X={"package.json":`{
  "name": "jsonresume-theme-ankurclass",
  "version": "0.1.1",
  "description": "Class theme for JSONResume.org",
  "author": "Ankur Jain",
  "repository": {
    "type": "git",
    "url": "https://github.com/Ankur/jsonresume-theme-class"
  },
  "license": "MIT",
  "dependencies": {
