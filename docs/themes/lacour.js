...
var n0=Object.create;var Lt=Object.defineProperty;var r0=Object.getOwnPropertyDescriptor;var e0=Object.getOwnPropertyNames;var t0=Object.getPrototypeOf,i0=Object.prototype.hasOwnProperty;var Wa=(u,A)=>()=>(u&&(A=u(u=0)),A);var Cr=(u,A)=>()=>(A||u((A={exports:{}}).exports,A),A.exports),u0=(u,A)=>{for(var D in A)Lt(u,D,{get:A[D],enumerable:!0})},Fa=(u,A,D,g)=>{if(A&&typeof A=="object"||typeof A=="function")for(let I of e0(A))!i0.call(u,I)&&I!==D&&Lt(u,I,{get:()=>A[I],enumerable:!(g=r0(A,I))||g.enumerable});return u};var f0=(u,A,D)=>(D=u!=null?n0(t0(u)):{},Fa(A||!u||!u.__esModule?Lt(D,"default",{value:u,enumerable:!0}):D,u)),a0=u=>Fa(Lt({},"__esModule",{value:!0}),u);var sn=Wa(()=>{});var Xa={};u0(Xa,{createReadStream:()=>$a,createWriteStream:()=>Za,default:()=>s0,existsSync:()=>Ha,lstatSync:()=>qa,mkdirSync:()=>za,readFileSync:()=>ka,readdirSync:()=>Na,rmdirSync:()=>Ka,statSync:()=>eu,unlinkSync:()=>Ya,writeFileSync:()=>Ga});function ru(u){return String(u).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Oa(u){var A=ru(u);if(Dt[A]!==void 0)return Dt[A];for(var D=Object.keys(Dt),g=0;g<D.length;g++)if(A.endsWith("/"+D[g])||A===D[g])return Dt[D[g]]}function nu(u){var A=ru(u);if((A===""||A===".")&&pe["."]!==void 0)return pe["."];if(pe[A]!==void 0)return pe[A];for(var D=Object.keys(pe),g=0;g<D.length;g++)if(A.endsWith("/"+D[g])||A===D[g])return pe[D[g]]}var Dt,pe,ka,Na,Ha,Ga,za,eu,qa,Ya,Ka,$a,Za,s0,Ja=Wa(()=>{"use strict";sn();Dt={"package.json":`{
