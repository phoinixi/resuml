var Bt=Object.create;var J=Object.defineProperty;var jt=Object.getOwnPropertyDescriptor;var Ft=Object.getOwnPropertyNames;var Ut=Object.getPrototypeOf,Wt=Object.prototype.hasOwnProperty;var j=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,n)=>(typeof require<"u"?require:t)[n]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var Me=(e,t)=>()=>(e&&(t=e(e=0)),t);var m=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),zt=(e,t)=>{for(var n in t)J(e,n,{get:t[n],enumerable:!0})},qe=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of Ft(t))!Wt.call(e,s)&&s!==n&&J(e,s,{get:()=>t[s],enumerable:!(i=jt(t,s))||i.enumerable});return e};var Gt=(e,t,n)=>(n=e!=null?Bt(Ut(e)):{},qe(t||!e||!e.__esModule?J(n,"default",{value:e,enumerable:!0}):n,e)),Ve=e=>qe(J({},"__esModule",{value:!0}),e);var p=Me(()=>{});var ue={};zt(ue,{createReadStream:()=>Ye,createWriteStream:()=>Xe,default:()=>Kt,existsSync:()=>Ue,lstatSync:()=>Ge,mkdirSync:()=>ze,readFileSync:()=>je,readdirSync:()=>Fe,rmdirSync:()=>Je,statSync:()=>pe,unlinkSync:()=>Ke,writeFileSync:()=>We});function ce(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Be(e){var t=ce(e);if(Y[t]!==void 0)return Y[t];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return Y[n[i]]}function le(e){var t=ce(e);if(X[t]!==void 0)return X[t];for(var n=Object.keys(X),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return X[n[i]]}var Y,X,je,Fe,Ue,We,ze,pe,Ge,Ke,Je,Ye,Xe,Kt,fe=Me(()=>{"use strict";p();Y={"package.json":`{
  "name": "jsonresume-theme-next",
  "version": "0.0.3",
  ...
  "repository": {
    "type": "git",
    "url": "http://github.com/unshift/jsonresume-theme-next"
  },
  "scripts": {
    "start": "resume serve"
  },
...
#projects .repo:before {
	content: "\\f00a";
	font: 16px Octicons;
	margin-right: 6px;
}
#projects .website:before {
	content: "\\f05c";
	font: 16px Octicons;
	margin-right: 6px;
}
