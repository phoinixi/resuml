var Ue=Object.create;var j=Object.defineProperty;var Be=Object.getOwnPropertyDescriptor;var We=Object.getOwnPropertyNames;var He=Object.getPrototypeOf,qe=Object.prototype.hasOwnProperty;var E=(e,r)=>()=>(e&&(r=e(e=0)),r);var S=(e,r)=>()=>(r||e((r={exports:{}}).exports,r),r.exports),C=(e,r)=>{for(var n in r)j(e,n,{get:r[n],enumerable:!0})},$=(e,r,n,t)=>{if(r&&typeof r=="object"||typeof r=="function")for(let i of We(r))!qe.call(e,i)&&i!==n&&j(e,i,{get:()=>r[i],enumerable:!(t=Be(r,i))||t.enumerable});return e};var Je=(e,r,n)=>(n=e!=null?Ue(He(e)):{},$(r||!e||!e.__esModule?j(n,"default",{value:e,enumerable:!0}):n,e)),w=e=>$(j({},"__esModule",{value:!0}),e);var l=E(()=>{});var A={};C(A,{createReadStream:()=>te,createWriteStream:()=>ie,default:()=>Xe,existsSync:()=>Z,lstatSync:()=>ee,mkdirSync:()=>Q,readFileSync:()=>V,readdirSync:()=>Y,rmdirSync:()=>re,statSync:()=>M,unlinkSync:()=>ne,writeFileSync:()=>K});function R(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function G(e){var r=R(e);if(L[r]!==void 0)return L[r];for(var n=Object.keys(L),t=0;t<n.length;t++)if(r.endsWith("/"+n[t])||r===n[t])return L[n[t]]}function F(e){var r=R(e);if(D[r]!==void 0)return D[r];for(var n=Object.keys(D),t=0;t<n.length;t++)if(r.endsWith("/"+n[t])||r===n[t])return D[n[t]]}var L,D,V,Y,Z,K,Q,M,ee,ne,re,te,ie,Xe,N=E(()=>{"use strict";l();L={"package.json":`{
...
`,h=0;h<n.destructuredLocals.length;h++){var b=n.destructuredLocals[h];if(!W.test(b))throw new Error("destructuredLocals["+h+"] is not a valid JS identifier.");h>0&&(p+=`,
  `),p+=b+" = __locals."+b}t+=p+`;
...
`,d.message+="Or, if you meant to create an async function, pass `async: true` as an option.")),d}var _=n.client?r:function(J){var ze=function(Ie,X){var O=s.shallowCopy(s.createNullProtoObjWherePossible(),J);return X&&(O=s.shallowCopy(O,X)),dn(Ie,n)(O)};return r.apply(n.context,[J||s.createNullProtoObjWherePossible(),o,ze,ye])};if(n.filename&&typeof Object.defineProperty=="function"){var y=n.filename,Ne=x.basename(y,x.extname(y));try{Object.defineProperty(_,"name",{value:Ne,writable:!1,enumerable:!1,configurable:!0})}catch{}}return _},generateSource:function(){var e=this.opts;e.rmWhitespace&&(this.templateText=this.templateText.replace(/[\r\n]+/g,`
