...
var tn=Object.create;var X=Object.defineProperty;var en=Object.getOwnPropertyDescriptor;var nn=Object.getOwnPropertyNames;var sn=Object.getPrototypeOf,rn=Object.prototype.hasOwnProperty;var U=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var ft=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),zt=(t,e)=>{for(var n in e)X(t,n,{get:e[n],enumerable:!0})},Wt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of nn(e))!rn.call(t,s)&&s!==n&&X(t,s,{get:()=>e[s],enumerable:!(i=en(e,s))||i.enumerable});return t};var an=(t,e,n)=>(n=t!=null?tn(sn(t)):{},Wt(e||!t||!t.__esModule?X(n,"default",{value:t,enumerable:!0}):n,t)),dt=t=>Wt(X({},"__esModule",{value:!0}),t);var u=ft(()=>{});var bt={};zt(bt,{createReadStream:()=>ee,createWriteStream:()=>ne,default:()=>on,existsSync:()=>Yt,lstatSync:()=>Qt,mkdirSync:()=>Xt,readFileSync:()=>Kt,readdirSync:()=>Jt,rmdirSync:()=>te,statSync:()=>vt,unlinkSync:()=>$t,writeFileSync:()=>Zt});function gt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Gt(t){var e=gt(t);if(Q[e]!==void 0)return Q[e];for(var n=Object.keys(Q),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Q[n[i]]}function mt(t){var e=gt(t);if((e===""||e===".")&&V["."]!==void 0)return V["."];if(V[e]!==void 0)return V[e];for(var n=Object.keys(V),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return V[n[i]]}var Q,V,Kt,Jt,Yt,Zt,Xt,vt,Qt,$t,te,ee,ne,on,yt=ft(()=>{"use strict";u();Q={"TODOS.txt":"","package.json":`{
