...
var Il=Object.create;var Ct=Object.defineProperty;var Ll=Object.getOwnPropertyDescriptor;var Hl=Object.getOwnPropertyNames;var Al=Object.getPrototypeOf,Fl=Object.prototype.hasOwnProperty;var Ye=(n=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(i,o)=>(typeof require<"u"?require:i)[o]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var In=(n,i)=>()=>(n&&(i=n(n=0)),i);var W=(n,i)=>()=>(i||n((i={exports:{}}).exports,i),i.exports),Wl=(n,i)=>{for(var o in i)Ct(n,o,{get:i[o],enumerable:!0})},Ln=(n,i,o,l)=>{if(i&&typeof i=="object"||typeof i=="function")for(let c of Hl(i))!Fl.call(n,c)&&c!==o&&Ct(n,c,{get:()=>i[c],enumerable:!(l=Ll(i,c))||l.enumerable});return n};var Ul=(n,i,o)=>(o=n!=null?Il(Al(n)):{},Ln(i||!n||!n.__esModule?Ct(o,"default",{value:n,enumerable:!0}):o,n)),Hn=n=>Ln(Ct({},"__esModule",{value:!0}),n);var D=In(()=>{});var _s={};Wl(_s,{createReadStream:()=>zn,createWriteStream:()=>Zn,default:()=>Vl,existsSync:()=>Un,lstatSync:()=>Gn,mkdirSync:()=>jn,readFileSync:()=>Fn,readdirSync:()=>Wn,rmdirSync:()=>Bn,statSync:()=>ys,unlinkSync:()=>qn,writeFileSync:()=>Vn});function gs(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function An(n){var i=gs(n);if(It[i]!==void 0)return It[i];for(var o=Object.keys(It),l=0;l<o.length;l++)if(i.endsWith("/"+o[l])||i===o[l])return It[o[l]]}function ms(n){var i=gs(n);if((i===""||i===".")&&Je["."]!==void 0)return Je["."];if(Je[i]!==void 0)return Je[i];for(var o=Object.keys(Je),l=0;l<o.length;l++)if(i.endsWith("/"+o[l])||i===o[l])return Je[o[l]]}var It,Je,Fn,Wn,Un,Vn,jn,ys,Gn,qn,Bn,zn,Zn,Vl,vs=In(()=>{"use strict";D();It={"package.json":`{
