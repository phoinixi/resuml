var di=Object.create;var xe=Object.defineProperty;var mi=Object.getOwnPropertyDescriptor;var gi=Object.getOwnPropertyNames;var vi=Object.getPrototypeOf,_i=Object.prototype.hasOwnProperty;var or=(t,e)=>()=>(t&&(e=t(t=0)),e);var v=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),yi=(t,e)=>{for(var r in e)xe(t,r,{get:e[r],enumerable:!0})},lr=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of gi(e))!_i.call(t,i)&&i!==r&&xe(t,i,{get:()=>e[i],enumerable:!(n=mi(e,i))||n.enumerable});return t};var Si=(t,e,r)=>(r=t!=null?di(vi(t)):{},lr(e||!t||!t.__esModule?xe(r,"default",{value:t,enumerable:!0}):r,t)),ki=t=>lr(xe({},"__esModule",{value:!0}),t);var p=or(()=>{});var Sr={};yi(Sr,{createReadStream:()=>_r,createWriteStream:()=>yr,default:()=>bi,existsSync:()=>pr,lstatSync:()=>mr,mkdirSync:()=>dr,readFileSync:()=>cr,readdirSync:()=>hr,rmdirSync:()=>vr,statSync:()=>ft,unlinkSync:()=>gr,writeFileSync:()=>fr});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function ur(t){var e=pt(t);if(Le[e]!==void 0)return Le[e];for(var r=Object.keys(Le),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return Le[r[n]]}function ht(t){var e=pt(t);if(Ee[e]!==void 0)return Ee[e];for(var r=Object.keys(Ee),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return Ee[r[n]]}var Le,Ee,cr,hr,pr,fr,dr,ft,mr,gr,vr,_r,yr,bi,kr=or(()=>{"use strict";p();Le={"package.json":`{
  "name": "jsonresume-theme-mint",
  "version": "0.0.1",
  "description": "Compact, printable theme for JSON Resume",
  "author": "David Aizenberg",
  "repository": {
    "type": "git",
    "url": "https://github.com/neoromantique/jsonresume-theme-mint.git"
  },
  "license": "MIT",
  "dependencies": {
  "handlebars": ">=4.3.0",
  ...
  "bugs": {
    "url": "https://github.com/neoromantique/jsonresume-theme-mint/issues"
  },
  "homepage": "https://github.com/neoromantique/jsonresume-theme-mint",
  "main": "index.js",
  "devDependencies": {}
}
