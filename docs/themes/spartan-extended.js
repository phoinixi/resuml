var dh=Object.create;var dn=Object.defineProperty;var ph=Object.getOwnPropertyDescriptor;var mh=Object.getOwnPropertyNames;var gh=Object.getPrototypeOf,yh=Object.prototype.hasOwnProperty;var ls=(n=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(t,r)=>(typeof require<"u"?require:t)[r]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var us=(n,t)=>()=>(n&&(t=n(n=0)),t);var O=(n,t)=>()=>(t||n((t={exports:{}}).exports,t),t.exports),_h=(n,t)=>{for(var r in t)dn(n,r,{get:t[r],enumerable:!0})},cs=(n,t,r,a)=>{if(t&&typeof t=="object"||typeof t=="function")for(let l of mh(t))!yh.call(n,l)&&l!==r&&dn(n,l,{get:()=>t[l],enumerable:!(a=ph(t,l))||a.enumerable});return n};var vh=(n,t,r)=>(r=n!=null?dh(gh(n)):{},cs(t||!n||!n.__esModule?dn(r,"default",{value:n,enumerable:!0}):r,n)),Sh=n=>cs(dn({},"__esModule",{value:!0}),n);var S=us(()=>{});var bs={};_h(bs,{createReadStream:()=>Ss,createWriteStream:()=>ks,default:()=>kh,existsSync:()=>ps,lstatSync:()=>ys,mkdirSync:()=>gs,readFileSync:()=>fs,readdirSync:()=>ds,rmdirSync:()=>vs,statSync:()=>wi,unlinkSync:()=>_s,writeFileSync:()=>ms});function bi(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function hs(n){var t=bi(n);if(pn[t]!==void 0)return pn[t];for(var r=Object.keys(pn),a=0;a<r.length;a++)if(t.endsWith("/"+r[a])||t===r[a])return pn[r[a]]}function ki(n){var t=bi(n);if(mn[t]!==void 0)return mn[t];for(var r=Object.keys(mn),a=0;a<r.length;a++)if(t.endsWith("/"+r[a])||t===r[a])return mn[r[a]]}var pn,mn,fs,ds,ps,ms,gs,wi,ys,_s,vs,Ss,ks,kh,ws=us(()=>{"use strict";S();pn={"main.css":`/********************************************
* 	reset from
