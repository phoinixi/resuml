...
var Vg=Object.create;var It=Object.defineProperty;var jg=Object.getOwnPropertyDescriptor;var n0=Object.getOwnPropertyNames;var r0=Object.getPrototypeOf,e0=Object.prototype.hasOwnProperty;var Uf=(u,A)=>()=>(u&&(A=u(u=0)),A);var Cr=(u,A)=>()=>(A||u((A={exports:{}}).exports,A),A.exports),t0=(u,A)=>{for(var D in A)It(u,D,{get:A[D],enumerable:!0})},Pf=(u,A,D,g)=>{if(A&&typeof A=="object"||typeof A=="function")for(let C of n0(A))!e0.call(u,C)&&C!==D&&It(u,C,{get:()=>A[C],enumerable:!(g=jg(A,C))||g.enumerable});return u};var i0=(u,A,D)=>(D=u!=null?Vg(r0(u)):{},Pf(A||!u||!u.__esModule?It(D,"default",{value:u,enumerable:!0}):D,u)),u0=u=>Pf(It({},"__esModule",{value:!0}),u);var sn=Uf(()=>{});var $f={};t0($f,{createReadStream:()=>Yf,createWriteStream:()=>Kf,default:()=>a0,existsSync:()=>kf,lstatSync:()=>Gf,mkdirSync:()=>Hf,readFileSync:()=>Ff,readdirSync:()=>Of,rmdirSync:()=>zf,statSync:()=>ru,unlinkSync:()=>qf,writeFileSync:()=>Nf});function nu(u){return String(u).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Wf(u){var A=nu(u);if(Lt[A]!==void 0)return Lt[A];for(var D=Object.keys(Lt),g=0;g<D.length;g++)if(A.endsWith("/"+D[g])||A===D[g])return Lt[D[g]]}function ji(u){var A=nu(u);if((A===""||A===".")&&pe["."]!==void 0)return pe["."];if(pe[A]!==void 0)return pe[A];for(var D=Object.keys(pe),g=0;g<D.length;g++)if(A.endsWith("/"+D[g])||A===D[g])return pe[D[g]]}var Lt,pe,Ff,Of,kf,Nf,Hf,ru,Gf,qf,zf,Yf,Kf,a0,Zf=Uf(()=>{"use strict";sn();Lt={"package.json":`{\r
