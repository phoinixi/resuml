var j0=Object.create;var Gr=Object.defineProperty;var e1=Object.getOwnPropertyDescriptor;var n1=Object.getOwnPropertyNames;var t1=Object.getPrototypeOf,r1=Object.prototype.hasOwnProperty;var ks=(r,s)=>()=>(r&&(s=r(r=0)),s);var Mn=(r,s)=>()=>(s||r((s={exports:{}}).exports,s),s.exports),po=(r,s)=>{for(var f in s)Gr(r,f,{get:s[f],enumerable:!0})},go=(r,s,f,l)=>{if(s&&typeof s=="object"||typeof s=="function")for(let o of n1(s))!r1.call(r,o)&&o!==f&&Gr(r,o,{get:()=>s[o],enumerable:!(l=e1(s,o))||l.enumerable});return r};var i1=(r,s,f)=>(f=r!=null?j0(t1(r)):{},go(s||!r||!r.__esModule?Gr(f,"default",{value:r,enumerable:!0}):f,r)),vo=r=>go(Gr({},"__esModule",{value:!0}),r);var he=ks(()=>{});var Co={};po(Co,{createReadStream:()=>Ro,createWriteStream:()=>To,default:()=>s1,existsSync:()=>wo,lstatSync:()=>yo,mkdirSync:()=>ko,readFileSync:()=>_o,readdirSync:()=>bo,rmdirSync:()=>Ao,statSync:()=>As,unlinkSync:()=>So,writeFileSync:()=>mo});function Ss(r){return String(r).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function xo(r){var s=Ss(r);if(Zr[s]!==void 0)return Zr[s];for(var f=Object.keys(Zr),l=0;l<f.length;l++)if(s.endsWith("/"+f[l])||s===f[l])return Zr[f[l]]}function ys(r){var s=Ss(r);if(Yr[s]!==void 0)return Yr[s];for(var f=Object.keys(Yr),l=0;l<f.length;l++)if(s.endsWith("/"+f[l])||s===f[l])return Yr[f[l]]}var Zr,Yr,_o,bo,wo,mo,ko,As,yo,So,Ao,Ro,To,s1,Io=ks(()=>{"use strict";he();Zr={"package.json":`{
