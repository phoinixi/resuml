var Be=Object.create;var J=Object.defineProperty;var Ve=Object.getOwnPropertyDescriptor;var Fe=Object.getOwnPropertyNames;var je=Object.getPrototypeOf,We=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Mt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Ue=(t,e)=>{for(var n in e)J(t,n,{get:e[n],enumerable:!0})},qt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Fe(e))!We.call(t,s)&&s!==n&&J(t,s,{get:()=>e[s],enumerable:!(i=Ve(e,s))||i.enumerable});return t};var Ge=(t,e,n)=>(n=t!=null?Be(je(t)):{},qt(e||!t||!t.__esModule?J(n,"default",{value:t,enumerable:!0}):n,t)),Bt=t=>qt(J({},"__esModule",{value:!0}),t);var u=Mt(()=>{});var pt={};Ue(pt,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>Ke,existsSync:()=>Wt,lstatSync:()=>Kt,mkdirSync:()=>Gt,readFileSync:()=>Ft,readdirSync:()=>jt,rmdirSync:()=>Jt,statSync:()=>ut,unlinkSync:()=>zt,writeFileSync:()=>Ut});function ct(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Vt(t){var e=ct(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}function ht(t){var e=ct(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}var Y,X,Ft,jt,Wt,Ut,Gt,ut,Kt,zt,Jt,Yt,Xt,Ke,ft=Mt(()=>{"use strict";u();Y={"index.html":`<!doctype html>
<html>
	<head>
	...
	<section id="basics">
		...
		<section id="profiles">
			...
			<div class="item">
				...
				<div class="url">
					<a href="https://soundcloud.com/dandymusicnl">Link</a>
				</div>
			</div>
		</section>
	</section>
...
`,"package.json":`{
  "name": "jsonresume-theme-sergio",
  "version": "0.0.1",
  "description": "Sergio theme for JSON Resume",
  "author": "Sergio Alonso",
  "repository": {
    "type": "git",
    "url": "https://github.com/sergio-alonso/jsonresume-theme-sergio"
  },
  "license": "MIT",
  "dependencies": {
