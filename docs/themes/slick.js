...
var Pt=Object.create;var W=Object.defineProperty;var Ot=Object.getOwnPropertyDescriptor;var zt=Object.getOwnPropertyNames;var vt=Object.getPrototypeOf,Lt=Object.prototype.hasOwnProperty;var v=(A=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(A,{get:(t,e)=>(typeof require<"u"?require:t)[e]}):A)(function(A){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+A+'" is not supported')});var GA=(A,t)=>()=>(A&&(t=A(A=0)),t);var w=(A,t)=>()=>(t||A((t={exports:{}}).exports,t),t.exports),bt=(A,t)=>{for(var e in t)W(A,e,{get:t[e],enumerable:!0})},TA=(A,t,e,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let B of zt(t))!Lt.call(A,B)&&B!==e&&W(A,B,{get:()=>t[B],enumerable:!(n=Ot(t,B))||n.enumerable});return A};var jt=(A,t,e)=>(e=A!=null?Pt(vt(A)):{},TA(t||!A||!A.__esModule?W(e,"default",{value:A,enumerable:!0}):e,A)),PA=A=>TA(W({},"__esModule",{value:!0}),A);var Q=GA(()=>{});var oA={};bt(oA,{createReadStream:()=>WA,createWriteStream:()=>ZA,default:()=>Kt,existsSync:()=>LA,lstatSync:()=>KA,mkdirSync:()=>jA,readFileSync:()=>zA,readdirSync:()=>vA,rmdirSync:()=>VA,statSync:()=>QA,unlinkSync:()=>XA,writeFileSync:()=>bA});function rA(A){return String(A).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function OA(A){var t=rA(A);if(Z[t]!==void 0)return Z[t];for(var e=Object.keys(Z),n=0;n<e.length;n++)if(t.endsWith("/"+e[n])||t===e[n])return Z[e[n]]}function EA(A){var t=rA(A);if((t===""||t===".")&&T["."]!==void 0)return T["."];if(T[t]!==void 0)return T[t];for(var e=Object.keys(T),n=0;n<e.length;n++)if(t.endsWith("/"+e[n])||t===e[n])return T[e[n]]}var Z,T,zA,vA,LA,bA,jA,QA,KA,XA,VA,WA,ZA,Kt,aA=GA(()=>{"use strict";Q();Z={"package.json":`{
  "name": "jsonresume-theme-slick",
  "version": "0.1.16",
  "description": "Slick theme for JSON Resume",
  "author": "Dominic McPhee",
  "repository": {
    "type": "git",
    "url": "https://github.com/dfmcphee/jsonresume-theme-slick"
  },
  "license": "MIT",
  "dependencies": {
