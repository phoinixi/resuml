var nn=Object.create;var J=Object.defineProperty;var sn=Object.getOwnPropertyDescriptor;var rn=Object.getOwnPropertyNames;var an=Object.getPrototypeOf,on=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var pt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),zt=(t,e)=>{for(var n in e)J(t,n,{get:e[n],enumerable:!0})},Ut=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of rn(e))!on.call(t,s)&&s!==n&&J(t,s,{get:()=>e[s],enumerable:!(i=sn(e,s))||i.enumerable});return t};var ln=(t,e,n)=>(n=t!=null?nn(an(t)):{},Ut(e||!t||!t.__esModule?J(n,"default",{value:t,enumerable:!0}):n,t)),ut=t=>Ut(J({},"__esModule",{value:!0}),t);var p=pt(()=>{});var gt={};zt(gt,{createReadStream:()=>te,createWriteStream:()=>ee,default:()=>hn,existsSync:()=>Jt,lstatSync:()=>Qt,mkdirSync:()=>Zt,readFileSync:()=>Gt,readdirSync:()=>Kt,rmdirSync:()=>$t,statSync:()=>mt,unlinkSync:()=>Xt,writeFileSync:()=>Yt});function dt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Wt(t){var e=dt(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}function ft(t){var e=dt(t);if(Z[e]!==void 0)return Z[e];for(var n=Object.keys(Z),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Z[n[i]]}var Y,Z,Gt,Kt,Jt,Yt,Zt,mt,Qt,Xt,$t,te,ee,hn,vt=pt(()=>{"use strict";p();Y={"package.json":`{
