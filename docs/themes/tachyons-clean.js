var ts=Object.create;var K=Object.defineProperty;var es=Object.getOwnPropertyDescriptor;var ss=Object.getOwnPropertyNames;var ns=Object.getPrototypeOf,is=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,s)=>(typeof require<"u"?require:e)[s]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var ut=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Gt=(t,e)=>{for(var s in e)K(t,s,{get:e[s],enumerable:!0})},Ut=(t,e,s,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of ss(e))!is.call(t,i)&&i!==s&&K(t,i,{get:()=>e[i],enumerable:!(n=es(e,i))||n.enumerable});return t};var as=(t,e,s)=>(s=t!=null?ts(ns(t)):{},Ut(e||!t||!t.__esModule?K(s,"default",{value:t,enumerable:!0}):s,t)),ft=t=>Ut(K({},"__esModule",{value:!0}),t);var p=ut(()=>{});var vt={};Gt(vt,{createReadStream:()=>te,createWriteStream:()=>ee,default:()=>rs,existsSync:()=>Kt,lstatSync:()=>Xt,mkdirSync:()=>Yt,readFileSync:()=>Jt,readdirSync:()=>zt,rmdirSync:()=>$t,statSync:()=>gt,unlinkSync:()=>Zt,writeFileSync:()=>Qt});function mt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Wt(t){var e=mt(t);if(Q[e]!==void 0)return Q[e];for(var s=Object.keys(Q),n=0;n<s.length;n++)if(e.endsWith("/"+s[n])||e===s[n])return Q[s[n]]}function dt(t){var e=mt(t);if(Y[e]!==void 0)return Y[e];for(var s=Object.keys(Y),n=0;n<s.length;n++)if(e.endsWith("/"+s[n])||e===s[n])return Y[s[n]]}var Q,Y,Jt,zt,Kt,Qt,Yt,gt,Xt,Zt,$t,te,ee,rs,bt=ut(()=>{"use strict";p();Q={"package.json":`{
