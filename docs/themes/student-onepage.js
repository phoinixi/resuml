var qe=Object.create;var K=Object.defineProperty;var Ve=Object.getOwnPropertyDescriptor;var Fe=Object.getOwnPropertyNames;var je=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Tt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)K(t,n,{get:e[n],enumerable:!0})},Bt=(t,e,n,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Fe(e))!Ue.call(t,i)&&i!==n&&K(t,i,{get:()=>e[i],enumerable:!(s=Ve(e,i))||s.enumerable});return t};var Je=(t,e,n)=>(n=t!=null?qe(je(t)):{},Bt(e||!t||!t.__esModule?K(n,"default",{value:t,enumerable:!0}):n,t)),qt=t=>Bt(K({},"__esModule",{value:!0}),t);var c=Tt(()=>{});var ut={};We(ut,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>ze,existsSync:()=>Ut,lstatSync:()=>zt,mkdirSync:()=>Jt,readFileSync:()=>Ft,readdirSync:()=>jt,rmdirSync:()=>Kt,statSync:()=>ct,unlinkSync:()=>Gt,writeFileSync:()=>Wt});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Vt(t){var e=pt(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),s=0;s<n.length;s++)if(e.endsWith("/"+n[s])||e===n[s])return Y[n[s]]}function ht(t){var e=pt(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),s=0;s<n.length;s++)if(e.endsWith("/"+n[s])||e===n[s])return X[n[s]]}var Y,X,Ft,jt,Ut,Wt,Jt,ct,zt,Gt,Kt,Yt,Xt,ze,dt=Tt(()=>{"use strict";c();Y={"index.html":`<!doctype html>
<html>
	<head>
