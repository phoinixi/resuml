var Q0=Object.create;var Mr=Object.defineProperty;var V0=Object.getOwnPropertyDescriptor;var $0=Object.getOwnPropertyNames;var ef=Object.getPrototypeOf,nf=Object.prototype.hasOwnProperty;var La=(o,z)=>()=>(o&&(z=o(o=0)),z);var In=(o,z)=>()=>(z||o((z={exports:{}}).exports,z),z.exports),tf=(o,z)=>{for(var S in z)Mr(o,S,{get:z[S],enumerable:!0})},Ea=(o,z,S,L)=>{if(z&&typeof z=="object"||typeof z=="function")for(let m of $0(z))!nf.call(o,m)&&m!==S&&Mr(o,m,{get:()=>z[m],enumerable:!(L=V0(z,m))||L.enumerable});return o};var rf=(o,z,S)=>(S=o!=null?Q0(ef(o)):{},Ea(z||!o||!o.__esModule?Mr(S,"default",{value:o,enumerable:!0}):S,o)),of=o=>Ea(Mr({},"__esModule",{value:!0}),o);var ae=La(()=>{});var Ga={};tf(Ga,{createReadStream:()=>Fa,createWriteStream:()=>Ha,default:()=>lf,existsSync:()=>Ua,lstatSync:()=>Pa,mkdirSync:()=>Za,readFileSync:()=>qa,readdirSync:()=>Oa,rmdirSync:()=>Ya,statSync:()=>to,unlinkSync:()=>Ba,writeFileSync:()=>Wa});function no(o){return String(o).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Na(o){var z=no(o);if(Cr[z]!==void 0)return Cr[z];for(var S=Object.keys(Cr),L=0;L<S.length;L++)if(z.endsWith("/"+S[L])||z===S[L])return Cr[S[L]]}function eo(o){var z=no(o);if(Sr[z]!==void 0)return Sr[z];for(var S=Object.keys(Sr),L=0;L<S.length;L++)if(z.endsWith("/"+S[L])||z===S[L])return Sr[S[L]]}var Cr,Sr,qa,Oa,Ua,Wa,Za,to,Pa,Ba,Ya,Fa,Ha,lf,Ja=La(()=>{"use strict";ae();Cr={"package-lock.json":`{
