var Kg=Object.create;var dn=Object.defineProperty;var Qg=Object.getOwnPropertyDescriptor;var Xg=Object.getOwnPropertyNames;var $g=Object.getPrototypeOf,e2=Object.prototype.hasOwnProperty;var re=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,r)=>(typeof require<"u"?require:t)[r]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var bt=(e,t)=>()=>(e&&(t=e(e=0)),t);var E=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Qt=(e,t)=>{for(var r in t)dn(e,r,{get:t[r],enumerable:!0})},Ro=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let a of Xg(t))!e2.call(e,a)&&a!==r&&dn(e,a,{get:()=>t[a],enumerable:!(n=Qg(t,a))||n.enumerable});return e};var t2=(e,t,r)=>(r=e!=null?Kg($g(e)):{},Ro(t||!e||!e.__esModule?dn(r,"default",{value:e,enumerable:!0}):r,e)),ee=e=>Ro(dn({},"__esModule",{value:!0}),e);var _=bt(()=>{});var St={};Qt(St,{createReadStream:()=>Vo,createWriteStream:()=>zo,default:()=>r2,existsSync:()=>qo,lstatSync:()=>Uo,mkdirSync:()=>Bo,readFileSync:()=>Fo,readdirSync:()=>Yo,rmdirSync:()=>Go,statSync:()=>Xi,unlinkSync:()=>jo,writeFileSync:()=>Wo});function Qi(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ho(e){var t=Qi(e);if(mn[t]!==void 0)return mn[t];for(var r=Object.keys(mn),n=0;n<r.length;n++)if(t.endsWith("/"+r[n])||t===r[n])return mn[r[n]]}function Ki(e){var t=Qi(e);if(gn[t]!==void 0)return gn[t];for(var r=Object.keys(gn),n=0;n<r.length;n++)if(t.endsWith("/"+r[n])||t===r[n])return gn[r[n]]}var mn,gn,Fo,Yo,qo,Wo,Bo,Xi,Uo,jo,Go,Vo,zo,r2,wt=bt(()=>{"use strict";_();mn={"docs/index.html":`<!DOCTYPE html>
<html><head>
