...
#skills .item, #languages .display {
    display:inline-block;
    width: 30%;
    vertical-align: top;
}
`,"theme/partials/achievements.hbs":`{{#if resume.achievements.length}}
...
{{/if}}
`,"theme/partials/openSourceContributions.hbs":`{{#if resume.openSourceContributions.length}}
<section class="section">
  <header>
    <h2 class='section-title'>Open source contributions<span class="item-count">({{resume.openSourceContributions.length}})</span></h2>
  </header>

  <section id="work">
    {{#each resume.openSourceContributions}}
