...
{{/if}}
`},ht={sample:["sample.png"],"theme/hbs-helpers":["birth-date.js","date-helpers.js","paragraph-split.js","space-to-dash.js","to-lower-case.js"],"theme/partials":["achievements.hbs","awards.hbs","basics.hbs","education.hbs","interests.hbs","languages.hbs","openSourceContributions.hbs","projects.hbs","publications.hbs","references.hbs","skills.hbs","volunteer.hbs","work.hbs"],theme:["hbs-helpers","partials"],".":["README.md","index.js","package.json","resume.hbs","sample","style.css","theme"]};oi=function(t,e){var n=ai(t);return n!==void 0?n:""},li=function(t,e){var n=hn(t);return n===void 0&&(n=[]),e&&e.withFileTypes?n.map(function(r){var i=pn(t)+"/"+r,s=hn(i)!==void 0;return{name:r,isFile:function(){return!s},isDirectory:function(){return s}}}):n},ui=function(t){return ai(t)!==void 0||hn(t)!==void 0},ci=function(){},hi=function(){},fn=function(){return{isFile:function(){return!0},isDirectory:function(){return!1},size:0,mtime:new Date}},pi=fn,fi=function(){},di=function(){},mi=function(){return{pipe:function(t){return t},on:function(){return this}}},gi=function(){return{write:function(){},end:function(){},on:function(){return this}}},Po={readFileSync:oi,readdirSync:li,existsSync:ui,writeFileSync:ci,mkdirSync:hi,statSync:fn,lstatSync:pi,unlinkSync:fi,rmdirSync:di,createReadStream:mi,createWriteStream:gi}});var xi={};vn(xi,{basename:()=>pt,default:()=>xo,dirname:()=>dn,extname:()=>ft,isAbsolute:()=>Si,join:()=>yi,normalize:()=>wi,parse:()=>Pi,relative:()=>Ci,resolve:()=>bi,sep:()=>ki});var yi,bi,dn,pt,ft,ki,Si,wi,Ci,Pi,xo,Li=vt(()=>{"use strict";p();yi=function(){return[].slice.call(arguments).join("/")},bi=function(){return[].slice.call(arguments).join("/")},dn=function(t){return t.split("/").slice(0,-1).join("/")},pt=function(t,e){var n=t.split("/").pop()||"";return e&&n.endsWith(e)?n.slice(0,-e.length):n},ft=function(t){var e=t.match(/\.[^.]+$/);return e?e[0]:""},ki="/",Si=function(t){return t.charAt(0)==="/"},wi=function(t){return t},Ci=function(t,e){return e},Pi=function(t){return{root:"",dir:dn(t),base:pt(t),ext:ft(t),name:pt(t,ft(t))}},xo={join:yi,resolve:bi,dirname:dn,basename:pt,extname:ft,sep:ki,isAbsolute:Si,normalize:wi,relative:Ci,parse:Pi}});var Mi=v(($l,Ei)=>{p();var z=si(),{readFileSync:mn,readdirSync:Lo}=(_i(),yn(vi)),{join:K}=(Li(),yn(xi)),xe=K("/","theme/hbs-helpers"),{birthDate:Eo}=re(K(xe,"birth-date.js")),{dateHelpers:Mo}=re(K(xe,"date-helpers.js")),{paragraphSplit:Oo}=re(K(xe,"paragraph-split.js")),{toLowerCase:Ao}=re(K(xe,"to-lower-case.js")),{spaceToDash:Io}=re(K(xe,"space-to-dash.js")),{MY:No,Y:Do,DMY:Ro}=Mo;z.registerHelper("birthDate",Eo);z.registerHelper("paragraphSplit",Oo);z.registerHelper("spaceToDash",Io);z.registerHelper("toLowerCase",Ao);z.registerHelper("MY",No);z.registerHelper("Y",Do);z.registerHelper("DMY",Ro);function qo(t){let e=mn("//style.css","utf-8"),n=mn("//resume.hbs","utf-8"),r=K("/","theme/partials");return Lo(r).forEach(s=>{let a=/^([^.]+).hbs$/.exec(s);if(!a)return;let l=a[1],u=K(r,s),o=mn(u,"utf8");z.registerPartial(l,o)}),z.compile(n)({css:e,resume:t})}Ei.exports={render:qo}});p();var te=qi(Mi(),1),Oi=te.default??te,nu=Oi.render??te.render,ru=Oi.pdfRenderOptions??te.pdfRenderOptions;export{ru as pdfRenderOptions,nu as render};
