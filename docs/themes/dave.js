var je=Object.create;var J=Object.defineProperty;var Be=Object.getOwnPropertyDescriptor;var Fe=Object.getOwnPropertyNames;var Ve=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var B=(n=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(e,t)=>(typeof require<"u"?require:e)[t]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var qn=(n,e)=>()=>(n&&(e=n(n=0)),e);var m=(n,e)=>()=>(e||n((e={exports:{}}).exports,e),e.exports),Ge=(n,e)=>{for(var t in e)J(n,t,{get:e[t],enumerable:!0})},zn=(n,e,t,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Fe(e))!Ue.call(n,r)&&r!==t&&J(n,r,{get:()=>e[r],enumerable:!(i=Be(e,r))||i.enumerable});return n};var We=(n,e,t)=>(t=n!=null?je(Ve(n)):{},zn(e||!n||!n.__esModule?J(t,"default",{value:n,enumerable:!0}):t,n)),jn=n=>zn(J({},"__esModule",{value:!0}),n);var p=qn(()=>{});var fn={};Ge(fn,{createReadStream:()=>Xn,createWriteStream:()=>Qn,default:()=>Ke,existsSync:()=>Un,lstatSync:()=>Kn,mkdirSync:()=>Wn,readFileSync:()=>Fn,readdirSync:()=>Vn,rmdirSync:()=>Yn,statSync:()=>un,unlinkSync:()=>Jn,writeFileSync:()=>Gn});function pn(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Bn(n){var e=pn(n);if(Y[e]!==void 0)return Y[e];for(var t=Object.keys(Y),i=0;i<t.length;i++)if(e.endsWith("/"+t[i])||e===t[i])return Y[t[i]]}function cn(n){var e=pn(n);if(X[e]!==void 0)return X[e];for(var t=Object.keys(X),i=0;i<t.length;i++)if(e.endsWith("/"+t[i])||e===t[i])return X[t[i]]}var Y,X,Fn,Vn,Un,Gn,Wn,un,Kn,Jn,Yn,Xn,Qn,Ke,dn=qn(()=>{"use strict";p();Y={"package.json":`{
