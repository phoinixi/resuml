...
var wd=Object.create;var Hn=Object.defineProperty;var xd=Object.getOwnPropertyDescriptor;var Pd=Object.getOwnPropertyNames;var Md=Object.getPrototypeOf,Od=Object.prototype.hasOwnProperty;var re=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,r)=>(typeof require<"u"?require:e)[r]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var jt=(t,e)=>()=>(t&&(e=t(t=0)),e);var M=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),ai=(t,e)=>{for(var r in e)Hn(t,r,{get:e[r],enumerable:!0})},pa=(t,e,r,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let l of Pd(e))!Od.call(t,l)&&l!==r&&Hn(t,l,{get:()=>e[l],enumerable:!(i=xd(e,l))||i.enumerable});return t};var Cd=(t,e,r)=>(r=t!=null?wd(Md(t)):{},pa(e||!t||!t.__esModule?Hn(r,"default",{value:t,enumerable:!0}):r,t)),zt=t=>pa(Hn({},"__esModule",{value:!0}),t);var _=jt(()=>{});var Yn={};ai(Yn,{createReadStream:()=>ba,createWriteStream:()=>wa,default:()=>Ed,existsSync:()=>ga,lstatSync:()=>_a,mkdirSync:()=>ya,readFileSync:()=>Tn,readdirSync:()=>Rn,rmdirSync:()=>ka,statSync:()=>ui,unlinkSync:()=>Sa,writeFileSync:()=>va});function li(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function ma(t){var e=li(t);if(In[e]!==void 0)return In[e];for(var r=Object.keys(In),i=0;i<r.length;i++)if(e.endsWith("/"+r[i])||e===r[i])return In[r[i]]}function oi(t){var e=li(t);if((e===""||e===".")&&xt["."]!==void 0)return xt["."];if(xt[e]!==void 0)return xt[e];for(var r=Object.keys(xt),i=0;i<r.length;i++)if(e.endsWith("/"+r[i])||e===r[i])return xt[r[i]]}var In,xt,Tn,Rn,ga,va,ya,ui,_a,Sa,ka,ba,wa,Ed,Pt=jt(()=>{"use strict";_();In={"docs/index.html":`<!DOCTYPE html>
<html><head>
