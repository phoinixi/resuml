...
var Vg=Object.create;var Tr=Object.defineProperty;var jg=Object.getOwnPropertyDescriptor;var n0=Object.getOwnPropertyNames;var e0=Object.getPrototypeOf,t0=Object.prototype.hasOwnProperty;var Uf=(u,A)=>()=>(u&&(A=u(u=0)),A);var Ce=(u,A)=>()=>(A||u((A={exports:{}}).exports,A),A.exports),r0=(u,A)=>{for(var D in A)Tr(u,D,{get:A[D],enumerable:!0})},Pf=(u,A,D,g)=>{if(A&&typeof A=="object"||typeof A=="function")for(let T of n0(A))!t0.call(u,T)&&T!==D&&Tr(u,T,{get:()=>A[T],enumerable:!(g=jg(A,T))||g.enumerable});return u};var i0=(u,A,D)=>(D=u!=null?Vg(e0(u)):{},Pf(A||!u||!u.__esModule?Tr(D,"default",{value:u,enumerable:!0}):D,u)),u0=u=>Pf(Tr({},"__esModule",{value:!0}),u);var sn=Uf(()=>{});var $f={};r0($f,{createReadStream:()=>Yf,createWriteStream:()=>Kf,default:()=>a0,existsSync:()=>kf,lstatSync:()=>Gf,mkdirSync:()=>Hf,readFileSync:()=>Ff,readdirSync:()=>Of,rmdirSync:()=>zf,statSync:()=>eu,unlinkSync:()=>qf,writeFileSync:()=>Nf});function nu(u){return String(u).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Wf(u){var A=nu(u);if(Lr[A]!==void 0)return Lr[A];for(var D=Object.keys(Lr),g=0;g<D.length;g++)if(A.endsWith("/"+D[g])||A===D[g])return Lr[D[g]]}function ji(u){var A=nu(u);if((A===""||A===".")&&pt["."]!==void 0)return pt["."];if(pt[A]!==void 0)return pt[A];for(var D=Object.keys(pt),g=0;g<D.length;g++)if(A.endsWith("/"+D[g])||A===D[g])return pt[D[g]]}var Lr,pt,Ff,Of,kf,Nf,Hf,eu,Gf,qf,zf,Yf,Kf,a0,Zf=Uf(()=>{"use strict";sn();Lr={"package.json":`{
