...
var Ve=Object.create;var Y=Object.defineProperty;var Be=Object.getOwnPropertyDescriptor;var Fe=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,je=Object.prototype.hasOwnProperty;var z=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,i)=>(typeof require<"u"?require:e)[i]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Mt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Ue=(t,e)=>{for(var i in e)Y(t,i,{get:e[i],enumerable:!0})},Tt=(t,e,i,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Fe(e))!je.call(t,r)&&r!==i&&Y(t,r,{get:()=>e[r],enumerable:!(n=Be(e,r))||n.enumerable});return t};var We=(t,e,i)=>(i=t!=null?Ve(ze(t)):{},Tt(e||!t||!t.__esModule?Y(i,"default",{value:t,enumerable:!0}):i,t)),Vt=t=>Tt(Y({},"__esModule",{value:!0}),t);var c=Mt(()=>{});var pt={};Ue(pt,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>Ke,existsSync:()=>jt,lstatSync:()=>Kt,mkdirSync:()=>Wt,readFileSync:()=>Ft,readdirSync:()=>zt,rmdirSync:()=>Jt,statSync:()=>ct,unlinkSync:()=>Gt,writeFileSync:()=>Ut});function ut(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Bt(t){var e=ut(t);if(X[e]!==void 0)return X[e];for(var i=Object.keys(X),n=0;n<i.length;n++)if(e.endsWith("/"+i[n])||e===i[n])return X[i[n]]}function lt(t){var e=ut(t);if((e===""||e===".")&&T["."]!==void 0)return T["."];if(T[e]!==void 0)return T[e];for(var i=Object.keys(T),n=0;n<i.length;n++)if(e.endsWith("/"+i[n])||e===i[n])return T[i[n]]}var X,T,Ft,zt,jt,Ut,Wt,ct,Kt,Gt,Jt,Yt,Xt,Ke,ft=Mt(()=>{"use strict";c();X={"package.json":`{
