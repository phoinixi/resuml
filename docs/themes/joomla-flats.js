...
var Bt=Object.create;var X=Object.defineProperty;var Vt=Object.getOwnPropertyDescriptor;var Ft=Object.getOwnPropertyNames;var Ut=Object.getPrototypeOf,Wt=Object.prototype.hasOwnProperty;var V=(n=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(t,e)=>(typeof require<"u"?require:t)[e]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var Tn=(n,t)=>()=>(n&&(t=n(n=0)),t);var w=(n,t)=>()=>(t||n((t={exports:{}}).exports,t),t.exports),Gt=(n,t)=>{for(var e in t)X(n,e,{get:t[e],enumerable:!0})},Mn=(n,t,e,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of Ft(t))!Wt.call(n,r)&&r!==e&&X(n,r,{get:()=>t[r],enumerable:!(o=Vt(t,r))||o.enumerable});return n};var Kt=(n,t,e)=>(e=n!=null?Bt(Ut(n)):{},Mn(t||!n||!n.__esModule?X(e,"default",{value:n,enumerable:!0}):e,n)),Bn=n=>Mn(X({},"__esModule",{value:!0}),n);var c=Tn(()=>{});var hn={};Gt(hn,{createReadStream:()=>Qn,createWriteStream:()=>Zn,default:()=>Jt,existsSync:()=>Wn,lstatSync:()=>Jn,mkdirSync:()=>Kn,readFileSync:()=>Fn,readdirSync:()=>Un,rmdirSync:()=>Yn,statSync:()=>pn,unlinkSync:()=>Xn,writeFileSync:()=>Gn});function cn(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Vn(n){var t=cn(n);if(Y[t]!==void 0)return Y[t];for(var e=Object.keys(Y),o=0;o<e.length;o++)if(t.endsWith("/"+e[o])||t===e[o])return Y[e[o]]}function dn(n){var t=cn(n);if((t===""||t===".")&&L["."]!==void 0)return L["."];if(L[t]!==void 0)return L[t];for(var e=Object.keys(L),o=0;o<e.length;o++)if(t.endsWith("/"+e[o])||t===e[o])return L[e[o]]}var Y,L,Fn,Un,Wn,Gn,Kn,pn,Jn,Xn,Yn,Qn,Zn,Jt,fn=Tn(()=>{"use strict";c();Y={"package.json":`{
