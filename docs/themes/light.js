var Ji=Object.create;var xe=Object.defineProperty;var Yi=Object.getOwnPropertyDescriptor;var Zi=Object.getOwnPropertyNames;var ki=Object.getPrototypeOf,na=Object.prototype.hasOwnProperty;var Dt=(l,v)=>()=>(l&&(v=l(l=0)),v);var Dn=(l,v)=>()=>(v||l((v={exports:{}}).exports,v),v.exports),ea=(l,v)=>{for(var R in v)xe(l,R,{get:v[R],enumerable:!0})},St=(l,v,R,O)=>{if(v&&typeof v=="object"||typeof v=="function")for(let S of Zi(v))!na.call(l,S)&&S!==R&&xe(l,S,{get:()=>v[S],enumerable:!(O=Yi(v,S))||O.enumerable});return l};var ta=(l,v,R)=>(R=l!=null?Ji(ki(l)):{},St(v||!l||!l.__esModule?xe(R,"default",{value:l,enumerable:!0}):R,l)),ra=l=>St(xe({},"__esModule",{value:!0}),l);var A=Dt(()=>{});var At={};ea(At,{createReadStream:()=>zt,createWriteStream:()=>Nt,default:()=>ia,existsSync:()=>Ft,lstatSync:()=>Pt,mkdirSync:()=>Mt,readFileSync:()=>Rt,readdirSync:()=>Tt,rmdirSync:()=>Ut,statSync:()=>Ve,unlinkSync:()=>It,writeFileSync:()=>jt});function Qe(l){return String(l).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ot(l){var v=Qe(l);if(Ce[v]!==void 0)return Ce[v];for(var R=Object.keys(Ce),O=0;O<R.length;O++)if(v.endsWith("/"+R[O])||v===R[O])return Ce[R[O]]}function Ge(l){var v=Qe(l);if(Ee[v]!==void 0)return Ee[v];for(var R=Object.keys(Ee),O=0;O<R.length;O++)if(v.endsWith("/"+R[O])||v===R[O])return Ee[R[O]]}var Ce,Ee,Rt,Tt,Ft,jt,Mt,Ve,Pt,It,Ut,zt,Nt,ia,Lt=Dt(()=>{"use strict";A();Ce={"package.json":`{
