var Kh=Object.create;var gr=Object.defineProperty;var Qh=Object.getOwnPropertyDescriptor;var Xh=Object.getOwnPropertyNames;var $h=Object.getPrototypeOf,ef=Object.prototype.hasOwnProperty;var pt=(r=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(r,{get:(e,i)=>(typeof require<"u"?require:e)[i]}):r)(function(r){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+r+'" is not supported')});var At=(r,e)=>()=>(r&&(e=r(r=0)),e);var L=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),An=(r,e)=>{for(var i in e)gr(r,i,{get:e[i],enumerable:!0})},Os=(r,e,i,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let l of Xh(e))!ef.call(r,l)&&l!==i&&gr(r,l,{get:()=>e[l],enumerable:!(s=Qh(e,l))||s.enumerable});return r};var tf=(r,e,i)=>(i=r!=null?Kh($h(r)):{},Os(e||!r||!r.__esModule?gr(i,"default",{value:r,enumerable:!0}):i,r)),vr=r=>Os(gr({},"__esModule",{value:!0}),r);var y=At(()=>{});var Fn={};An(Fn,{createReadStream:()=>Ys,createWriteStream:()=>Is,default:()=>rf,existsSync:()=>Ls,lstatSync:()=>Rs,mkdirSync:()=>Ns,readFileSync:()=>Sr,readdirSync:()=>kr,rmdirSync:()=>Ts,statSync:()=>In,unlinkSync:()=>As,writeFileSync:()=>Es});function Yn(r){return String(r).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Cs(r){var e=Yn(r);if(_r[e]!==void 0)return _r[e];for(var i=Object.keys(_r),s=0;s<i.length;s++)if(e.endsWith("/"+i[s])||e===i[s])return _r[i[s]]}function Tn(r){var e=Yn(r);if(yr[e]!==void 0)return yr[e];for(var i=Object.keys(yr),s=0;s<i.length;s++)if(e.endsWith("/"+i[s])||e===i[s])return yr[i[s]]}var _r,yr,Sr,kr,Ls,Es,Ns,In,Rs,As,Ts,Ys,Is,rf,Tt=At(()=>{"use strict";y();_r={"package.json":`{
