var Ve=Object.create;var J=Object.defineProperty;var Fe=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Tt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)J(t,n,{get:e[n],enumerable:!0})},Bt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of je(e))!Ue.call(t,s)&&s!==n&&J(t,s,{get:()=>e[s],enumerable:!(i=Fe(e,s))||i.enumerable});return t};var Ge=(t,e,n)=>(n=t!=null?Ve(ze(t)):{},Bt(e||!t||!t.__esModule?J(n,"default",{value:t,enumerable:!0}):n,t)),qt=t=>Bt(J({},"__esModule",{value:!0}),t);var u=Tt(()=>{});var ct={};We(ct,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>Ke,existsSync:()=>zt,lstatSync:()=>Gt,mkdirSync:()=>Wt,readFileSync:()=>Ft,readdirSync:()=>jt,rmdirSync:()=>Jt,statSync:()=>ut,unlinkSync:()=>Kt,writeFileSync:()=>Ut});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Vt(t){var e=pt(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}function lt(t){var e=pt(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}var Y,X,Ft,jt,zt,Ut,Wt,ut,Gt,Kt,Jt,Yt,Xt,Ke,ft=Tt(()=>{"use strict";u();Y={"package.json":`{
  "name": "jsonresume-theme-sshorter",
  "version": "0.3.0",
  "description": "A simple, pdf export focused, german theme for jsonresume.org (improved upon the work of Graeme Maciver and Danial)",
  "author": "sspross",
  "repository": {
    "type": "git",
    "url": "https://github.com/sspross/jsonresume-theme-shorter"
  },
  "license": "MIT",
  "dependencies": {
...
<html>
	...
	<section class="heading">
		<header>
			{{#if picture}}<img src="{{picture}}" style="float: right;">{{/if}}
			<h1>{{name}}</h1>
			<div class="contact">
				{{#if email}}
				<span class="detail">
