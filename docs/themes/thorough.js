var gi=Object.create;var Lt=Object.defineProperty;var mi=Object.getOwnPropertyDescriptor;var vi=Object.getOwnPropertyNames;var _i=Object.getPrototypeOf,yi=Object.prototype.hasOwnProperty;var ur=(e,t)=>()=>(e&&(t=e(e=0)),t);var v=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Si=(e,t)=>{for(var r in t)Lt(e,r,{get:t[r],enumerable:!0})},lr=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of vi(t))!yi.call(e,i)&&i!==r&&Lt(e,i,{get:()=>t[i],enumerable:!(n=mi(t,i))||n.enumerable});return e};var ki=(e,t,r)=>(r=e!=null?gi(_i(e)):{},lr(t||!e||!e.__esModule?Lt(r,"default",{value:e,enumerable:!0}):r,e)),bi=e=>lr(Lt({},"__esModule",{value:!0}),e);var f=ur(()=>{});var kr={};Si(kr,{createReadStream:()=>yr,createWriteStream:()=>Sr,default:()=>Ci,existsSync:()=>pr,lstatSync:()=>mr,mkdirSync:()=>gr,readFileSync:()=>hr,readdirSync:()=>fr,rmdirSync:()=>_r,statSync:()=>de,unlinkSync:()=>vr,writeFileSync:()=>dr});function pe(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function cr(e){var t=pe(e);if(Et[t]!==void 0)return Et[t];for(var r=Object.keys(Et),n=0;n<r.length;n++)if(t.endsWith("/"+r[n])||t===r[n])return Et[r[n]]}function fe(e){var t=pe(e);if(xt[t]!==void 0)return xt[t];for(var r=Object.keys(xt),n=0;n<r.length;n++)if(t.endsWith("/"+r[n])||t===r[n])return xt[r[n]]}var Et,xt,hr,fr,pr,dr,gr,de,mr,vr,_r,yr,Sr,Ci,br=ur(()=>{"use strict";f();Et={"package.json":`{
