...
var uh=Object.create;var cr=Object.defineProperty;var ch=Object.getOwnPropertyDescriptor;var hh=Object.getOwnPropertyNames;var fh=Object.getPrototypeOf,dh=Object.prototype.hasOwnProperty;var ss=(r=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(r,{get:(e,i)=>(typeof require<"u"?require:e)[i]}):r)(function(r){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+r+'" is not supported')});var as=(r,e)=>()=>(r&&(e=r(r=0)),e);var L=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),ph=(r,e)=>{for(var i in e)cr(r,i,{get:e[i],enumerable:!0})},os=(r,e,i,a)=>{if(e&&typeof e=="object"||typeof e=="function")for(let l of hh(e))!dh.call(r,l)&&l!==i&&cr(r,l,{get:()=>e[l],enumerable:!(a=ch(e,l))||a.enumerable});return r};var mh=(r,e,i)=>(i=r!=null?uh(fh(r)):{},os(e||!r||!r.__esModule?cr(i,"default",{value:r,enumerable:!0}):i,r)),gh=r=>os(cr({},"__esModule",{value:!0}),r);var S=as(()=>{});var ys={};ph(ys,{createReadStream:()=>_s,createWriteStream:()=>vs,default:()=>_h,existsSync:()=>hs,lstatSync:()=>ps,mkdirSync:()=>ds,readFileSync:()=>us,readdirSync:()=>cs,rmdirSync:()=>gs,statSync:()=>yn,unlinkSync:()=>ms,writeFileSync:()=>fs});function vn(r){return String(r).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function ls(r){var e=vn(r);if(hr[e]!==void 0)return hr[e];for(var i=Object.keys(hr),a=0;a<i.length;a++)if(e.endsWith("/"+i[a])||e===i[a])return hr[i[a]]}function _n(r){var e=vn(r);if((e===""||e===".")&&he["."]!==void 0)return he["."];if(he[e]!==void 0)return he[e];for(var i=Object.keys(he),a=0;a<i.length;a++)if(e.endsWith("/"+i[a])||e===i[a])return he[i[a]]}var hr,he,us,cs,hs,fs,ds,yn,ps,ms,gs,_s,vs,_h,Ss=as(()=>{"use strict";S();hr={"package.json":`{\r
  "name": "jsonresume-theme-spartanbentekkie",\r
  "version": "0.2.4",\r
  "description": "Minimal, clean and elegant theme for JSON Resume - Modified by bentekkie",\r
  "author": "Benjamin Segall <bentekkie@gmail.com>",\r
  "repository": {\r
    "type": "git",\r
    "url": "https://github.com/bentekkie/jsonresume-theme-spartan"\r
  },\r
  "license": "MIT",\r
  "dependencies": {\r
    "handlebars": ">=4.0.11",\r
...
<html>\r
	...
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css" />\r
	<link href='https://fonts.googleapis.com/css?family=Roboto:400,700,400italic' rel='stylesheet' type='text/css'>\r
	<style>\r
		{{{css}}}\r
	</style>\r
	\r
...
\r
				...
				<section id="basics">\r
					...
					{{#location}}\r
						<div id="location">\r
							{{#if address}}\r
							<span class="fa fa-map-marker"></span>\r
							<span class="address">\r
								{{address}},\r
							</span>\r
							{{/if}}\r
							{{#if postalCode}}\r
							<span class="postalCode">\r
								{{postalCode}},\r
							</span>\r
							{{/if}}\r
							{{#if city}}\r
...
\r
					<div id="contact">\r
						...
						{{#if email}}\r
						<div class="email">\r
							<span class="fa fa-envelope"></span>\r
							<a href="mailto:{{email}}">{{email}}</a>\r
						</div>\r
						{{/if}}\r
						{{#if phone}}\r
						<div class="phone">\r
							<span class="fa fa-phone-square"></span>\r
							{{phone}}\r
						</div>\r
						{{/if}}\r
					</div>\r
...
\r
					...
					<div id="profiles">\r
						...
						<div class="item">\r
							{{#if network}}\r
							<span class="network fa fa-{{spaceToDash network}} {{spaceToDash network}}"></span>\r
							{{/if}}\r
							{{#if username}}\r
							<span class="username">\r
								{{#if url}}\r
								<span class="url">\r
									<a href="{{url}}">{{username}}</a>\r
								</span>\r
								{{else}}\r
									{{username}}\r
								{{/if}}\r
...
\r
				{{#if summary}}\r
				<section class="section main-summary">\r
					<h2 class='section-title'>About</h2>\r
					<section>\r
						<p>{{{summary}}}</p>\r
					</section>\r
					{{/if}}\r
...
\r
			{{#if resume.work.length}}\r
				<section class="section">\r
					<h2 class='section-title'>Experience</h2>\r
					<section id="work">\r
					{{#each resume.work}}\r
						{{#if company}}\r
						<header>\r
					...
					<section id="education">\r
						{{#each resume.education}}\r
							...
							<div class="item">\r
								...
								{{#if gpa}}						\r
									<div>\r
										<span class="fa fa-graduation-cap"></span>\r
		...
		\r
			{{#if resume.publications.length}}\r
				<section class="section">\r
					<h2 class='section-title'>Projects</h2>\r
...
body {\r
	...
	line-height: 1.6;\r
	font-size: 15px;\r
	font-family: Calibri,Candara,Segoe,Segoe UI,Optima,Arial,sans-serif; \r
}\r
\r
#resume {\r
	padding: 1rem 0;\r
...
h2.section-title {\r
	...
	font-weight: 400;\r
	color: #757575;\r
	padding: 1em 1rem 0;\r
	margin-bottom: 0.1275em;\r
}\r
\r
.date {\r
	font-weight: 700;\r
...
\r
.position, .area, .institution {\r
	font-weight: 700;\r
}\r
\r
#interests .item, #languages .item {\r
	padding: 0 1em 1em 0;\r
	border-bottom: none;\r
}\r
\r
.website::before {\r
...
\r
#profiles, #skills, #interests, #languages {\r
...
#skills .level .bar {\r
	...
	width: 10em;\r
	height: 5px;\r
	margin: 0em 0 1em 0;\r
	position: relative;\r
}\r
\r
#skills .level .bar::after {\r
	position: absolute;\r
	content: " ";\r
	top: 0;\r
	left: 0;\r
...
\r
#skills .level.beginner .bar::after {\r
	background: #EB5F51;\r
	width: 2.5em;\r
} \r
\r
#skills .level.intermediate .bar::after {\r
	background: #ffdf1f;\r
	width: 5em;\r
} \r
\r
#skills .level.advanced .bar::after {\r
	background: #59C596;\r
	width: 7.5em;\r
} \r
\r
#skills .level.master .bar::after {\r
	background: #5CB85C;\r
	width: 10em;\r
}\r
\r
#references .item {\r
	padding-left: 1em;\r
	border-left: 5px solid #EB5F51;\r
}\r
\r
.fa.social {\r
	margin-right: 0.25em;\r
...
@media screen and (min-width: 1025px) { \r
	...
	#resume {\r
		...
		margin: 3em auto;\r
		background: #fff;\r
		box-shadow: 0 2px 5px rgba(0, 0, 0, 0.4);\r
	}\r
\r
	.section {\r
		display: -webkit-box;\r
