var qe=Object.create;var J=Object.defineProperty;var Be=Object.getOwnPropertyDescriptor;var Ve=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,je=Object.prototype.hasOwnProperty;var V=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Tt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Ue=(t,e)=>{for(var n in e)J(t,n,{get:e[n],enumerable:!0})},qt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Ve(e))!je.call(t,s)&&s!==n&&J(t,s,{get:()=>e[s],enumerable:!(i=Be(e,s))||i.enumerable});return t};var We=(t,e,n)=>(n=t!=null?qe(ze(t)):{},qt(e||!t||!t.__esModule?J(n,"default",{value:t,enumerable:!0}):n,t)),Bt=t=>qt(J({},"__esModule",{value:!0}),t);var u=Tt(()=>{});var pt={};Ue(pt,{createReadStream:()=>Xt,createWriteStream:()=>Zt,default:()=>Ge,existsSync:()=>Ut,lstatSync:()=>Kt,mkdirSync:()=>Gt,readFileSync:()=>zt,readdirSync:()=>jt,rmdirSync:()=>Yt,statSync:()=>ut,unlinkSync:()=>Jt,writeFileSync:()=>Wt});function ct(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Vt(t){var e=ct(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}function ht(t){var e=ct(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}var Y,X,zt,jt,Ut,Wt,Gt,ut,Kt,Jt,Yt,Xt,Zt,Ge,ft=Tt(()=>{"use strict";u();Y={"package.json":`{
  "name": "jsonresume-theme-striking",
  "version": "0.0.8",
  "description": "Striking theme for JSON Resume",
  "author": "Santosh Shaastry",
  "repository": {
    "type": "git",
    "url": "https://github.com/poleveD/jsonresume-theme-striking"
  },
  "license": "MIT",
  "dependencies": {
  ...
  "bugs": {
    "url": "https://github.com/poleveD/jsonresume-theme-striking/issues"
  }
}`,"print.css":`body {
...
#work, #volunteer, #education, #awards, #publications, #skills, #languages, #interests {
...
#work .work-item, #volunteer .volunteer-item , #education .education-item, #awards .award-item,
#publications .pub-item, #languages .lang-item, #interests .interest-item, #references .ref-item  {
  padding-left: 2%;
  padding-bottom: 2%;
  padding-top: 0.2em;
}

#work .work-item:hover , #volunteer .volunteer-item:hover, #education .education-item:hover, #awards .award-item:hover,
#publications .pub-item:hover, #languages .lang-item:hover, #interests .interest-item:hover, #references .ref-item:hover{
  background-color: #EEE;
}

#work .work-position, #volunteer .volunteer-position , #education .education-institution, #awards .award-title,
#publications .pub-name, #languages .lang-name, #interests .interest-name {
  text-transform: uppercase;
  font-size: 1.2em;
  font-weight: bold;
}

#work .work-position, #work .duration {
  color: #0099CC
}

#volunteer .volunteer-position, #volunteer .duration {
  color: #D4A017;
}

#education .education-institution, #education .duration  {
  color: #438D80;
}

#awards .award-title, #awards .award-date {
  color: #954535;
}

#publications .pub-name, #publications .pub-date {
  color: #B2C248;
}
...
#work .duration, #volunteer .duration, #education .duration, #awards .award-date , 
#publications .pub-date, #languages .lang-fluency, #interests .interest-keyword {
  font-size: 1em;
  text-align: center;
}

#skills .skills-header th {
  font-size: 1.2em;
  width: 33%;
}

#skills .skills-rows  td{
  width: 33%;
}

#skills .skills-rows td:first-child {
  color: #CC6600;
}
...
@media all and (max-width: 768px) {
  #work .section-info, #volunteer .section-info, #education .section-info,
  #awards .section-info, #publications .section-info, #skills .section-info,
  #languages .section-info, #interests .section-info, #references .section-info  {
    font-size: 1.1em;
	right: 0;
	left: 0;
  }
  ...
  #work, #volunteer, #education, #awards, #publications, #languages, #skills, #interests, #references {
    font-size: 0.7em;
  }
