...
var qe=Object.create;var Y=Object.defineProperty;var Be=Object.getOwnPropertyDescriptor;var Ve=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,je=Object.prototype.hasOwnProperty;var z=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Tt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Ue=(t,e)=>{for(var n in e)Y(t,n,{get:e[n],enumerable:!0})},qt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Ve(e))!je.call(t,s)&&s!==n&&Y(t,s,{get:()=>e[s],enumerable:!(i=Be(e,s))||i.enumerable});return t};var We=(t,e,n)=>(n=t!=null?qe(ze(t)):{},qt(e||!t||!t.__esModule?Y(n,"default",{value:t,enumerable:!0}):n,t)),Bt=t=>qt(Y({},"__esModule",{value:!0}),t);var u=Tt(()=>{});var pt={};Ue(pt,{createReadStream:()=>Xt,createWriteStream:()=>Zt,default:()=>Ge,existsSync:()=>Ut,lstatSync:()=>Kt,mkdirSync:()=>Gt,readFileSync:()=>zt,readdirSync:()=>jt,rmdirSync:()=>Yt,statSync:()=>ut,unlinkSync:()=>Jt,writeFileSync:()=>Wt});function ct(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Vt(t){var e=ct(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}function ht(t){var e=ct(t);if((e===""||e===".")&&T["."]!==void 0)return T["."];if(T[e]!==void 0)return T[e];for(var n=Object.keys(T),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return T[n[i]]}var X,T,zt,jt,Ut,Wt,Gt,ut,Kt,Jt,Yt,Xt,Zt,Ge,ft=Tt(()=>{"use strict";u();X={"package.json":`{
