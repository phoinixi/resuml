var ka=Object.create;var We=Object.defineProperty;var wa=Object.getOwnPropertyDescriptor;var ya=Object.getOwnPropertyNames;var _a=Object.getPrototypeOf,Sa=Object.prototype.hasOwnProperty;var Ue=(n,e)=>()=>(n&&(e=n(n=0)),e);var v=(n,e)=>()=>(e||n((e={exports:{}}).exports,e),e.exports),jn=(n,e)=>{for(var t in e)We(n,t,{get:e[t],enumerable:!0})},nr=(n,e,t,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of ya(e))!Sa.call(n,i)&&i!==t&&We(n,i,{get:()=>e[i],enumerable:!(r=wa(e,i))||r.enumerable});return n};var Ca=(n,e,t)=>(t=n!=null?ka(_a(n)):{},nr(e||!n||!n.__esModule?We(t,"default",{value:n,enumerable:!0}):t,n)),Fn=n=>nr(We({},"__esModule",{value:!0}),n);var f=Ue(()=>{});var fr={};jn(fr,{createReadStream:()=>cr,createWriteStream:()=>hr,default:()=>Aa,existsSync:()=>sr,lstatSync:()=>lr,mkdirSync:()=>or,readFileSync:()=>rr,readdirSync:()=>ir,rmdirSync:()=>ur,statSync:()=>Gn,unlinkSync:()=>pr,writeFileSync:()=>ar});function Vn(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function tr(n){var e=Vn(n);if(Ke[e]!==void 0)return Ke[e];for(var t=Object.keys(Ke),r=0;r<t.length;r++)if(e.endsWith("/"+t[r])||e===t[r])return Ke[t[r]]}function Hn(n){var e=Vn(n);if(Xe[e]!==void 0)return Xe[e];for(var t=Object.keys(Xe),r=0;r<t.length;r++)if(e.endsWith("/"+t[r])||e===t[r])return Xe[t[r]]}var Ke,Xe,rr,ir,sr,ar,or,Gn,lr,pr,ur,cr,hr,Aa,dr=Ue(()=>{"use strict";f();Ke={"assets/css/styles-2.css":`/*   
...
`,n=n.substring(h.length+1),p=!0),!p){let S=this.rules.other.nextBulletRegex(b),j=this.rules.other.hrRegex(b),te=this.rules.other.fencesBeginRegex(b),A=this.rules.other.headingBeginRegex(b),we=this.rules.other.htmlBeginRegex(b);for(;n;){let B=n.split(`
`,1)[0],P;if(h=B,this.options.pedantic?(h=h.replace(this.rules.other.listReplaceNesting,"  "),P=h):P=h.replace(this.rules.other.tabCharGlobal,"    "),te.test(h)||A.test(h)||we.test(h)||S.test(h)||j.test(h))break;if(P.search(this.rules.other.nonSpaceChar)>=b||!h.trim())c+=`
