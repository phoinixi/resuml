var Ne=Object.create;var _=Object.defineProperty;var Ie=Object.getOwnPropertyDescriptor;var Re=Object.getOwnPropertyNames;var Me=Object.getPrototypeOf,We=Object.prototype.hasOwnProperty;var C=(e,r)=>()=>(e&&(r=e(e=0)),r);var y=(e,r)=>()=>(r||e((r={exports:{}}).exports,r),r.exports),U=(e,r)=>{for(var n in r)_(e,n,{get:r[n],enumerable:!0})},q=(e,r,n,t)=>{if(r&&typeof r=="object"||typeof r=="function")for(let i of Re(r))!We.call(e,i)&&i!==n&&_(e,i,{get:()=>r[i],enumerable:!(t=Ie(r,i))||t.enumerable});return e};var ze=(e,r,n)=>(n=e!=null?Ne(Me(e)):{},q(r||!e||!e.__esModule?_(n,"default",{value:e,enumerable:!0}):n,e)),E=e=>q(_({},"__esModule",{value:!0}),e);var l=C(()=>{});var T={};U(T,{basename:()=>D,default:()=>Je,dirname:()=>O,extname:()=>S,isAbsolute:()=>Z,join:()=>G,normalize:()=>Y,parse:()=>K,relative:()=>Q,resolve:()=>X,sep:()=>$});var G,X,O,D,S,$,Z,Y,Q,K,Je,F=C(()=>{"use strict";l();G=function(){return[].slice.call(arguments).join("/")},X=function(){return[].slice.call(arguments).join("/")},O=function(e){return e.split("/").slice(0,-1).join("/")},D=function(e,r){var n=e.split("/").pop()||"";return r&&n.endsWith(r)?n.slice(0,-r.length):n},S=function(e){var r=e.match(/\.[^.]+$/);return r?r[0]:""},$="/",Z=function(e){return e.charAt(0)==="/"},Y=function(e){return e},Q=function(e,r){return r},K=function(e){return{root:"",dir:O(e),base:D(e),ext:S(e),name:D(e,S(e))}},Je={join:G,resolve:X,dirname:O,basename:D,extname:S,sep:$,isAbsolute:Z,normalize:Y,relative:Q,parse:K}});var M={};U(M,{createReadStream:()=>le,createWriteStream:()=>pe,default:()=>Ve,existsSync:()=>re,lstatSync:()=>ae,mkdirSync:()=>se,readFileSync:()=>ne,readdirSync:()=>te,rmdirSync:()=>ce,statSync:()=>R,unlinkSync:()=>oe,writeFileSync:()=>ie});function I(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function ee(e){var r=I(e);if(A[r]!==void 0)return A[r];for(var n=Object.keys(A),t=0;t<n.length;t++)if(r.endsWith("/"+n[t])||r===n[t])return A[n[t]]}function N(e){var r=I(e);if(L[r]!==void 0)return L[r];for(var n=Object.keys(L),t=0;t<n.length;t++)if(r.endsWith("/"+n[t])||r===n[t])return L[n[t]]}var A,L,ne,te,re,ie,se,R,ae,oe,ce,le,pe,Ve,W=C(()=>{"use strict";l();A={"assets/stylesheets/style.css":`@import url('https://fonts.googleapis.com/css?family=Lato:300,400,700');
...
`,f=0;f<n.destructuredLocals.length;f++){var w=n.destructuredLocals[f];if(!J.test(w))throw new Error("destructuredLocals["+f+"] is not a valid JS identifier.");f>0&&(h+=`,
  `),h+=w+" = __locals."+w}t+=h+`;
...
`,u.message+="Or, if you meant to create an async function, pass `async: true` as an option.")),u}var k=n.client?r:function(B){var Te=function(Fe,H){var P=o.shallowCopy(o.createNullProtoObjWherePossible(),B);return H&&(P=o.shallowCopy(P,H)),an(Fe,n)(P)};return r.apply(n.context,[B||o.createNullProtoObjWherePossible(),a,Te,ye])};if(n.filename&&typeof Object.defineProperty=="function"){var b=n.filename,Oe=x.basename(b,x.extname(b));try{Object.defineProperty(k,"name",{value:Oe,writable:!1,enumerable:!1,configurable:!0})}catch{}}return k},generateSource:function(){var e=this.opts;e.rmWhitespace&&(this.templateText=this.templateText.replace(/[\r\n]+/g,`
...
`)}};s.escapeXML=o.escapeXML;s.__express=s.renderFile;s.VERSION=Ze;s.name=en;typeof window<"u"&&(window.ejs=s)});var _e=y((jn,ke)=>{l();var on=["January","February","March","April","May","June","July","August","September","October","November","December"];ke.exports=e=>{if(!e)return e;let r=new Date(e);return`${on[r.getMonth()]} ${r.getFullYear()}`}});var De=y((_n,Ee)=>{l();var cn=_e();function ln(e){return e&&e.replace(/(https?:\/\/)?(www.)?/i,"")}Ee.exports={prettyDate:cn,domainOnly:ln}});var Pe=y(Le=>{l();var Se=(F(),E(T)),Ae=(W(),E(M)),pn=je(),un=De();Le.render=e=>{let r=Se.join("/","views/resume.ejs"),n=pn.compile(Ae.readFileSync(r,"utf8"),{filename:r,context:{...un}}),t=Ae.readFileSync(Se.join("/","assets/stylesheets/style.css"),"utf8");return n({css:t,resume:e})}});l();var v=ze(Pe(),1),Ce=v.default??v,An=Ce.render??v.render,Ln=Ce.pdfRenderOptions??v.pdfRenderOptions;export{Ln as pdfRenderOptions,An as render};
