var jh=Object.create;var mr=Object.defineProperty;var Zh=Object.getOwnPropertyDescriptor;var Jh=Object.getOwnPropertyNames;var Kh=Object.getPrototypeOf,Qh=Object.prototype.hasOwnProperty;var dt=(r=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(r,{get:(t,i)=>(typeof require<"u"?require:t)[i]}):r)(function(r){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+r+'" is not supported')});var At=(r,t)=>()=>(r&&(t=r(r=0)),t);var L=(r,t)=>()=>(t||r((t={exports:{}}).exports,t),t.exports),An=(r,t)=>{for(var i in t)mr(r,i,{get:t[i],enumerable:!0})},Os=(r,t,i,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let l of Jh(t))!Qh.call(r,l)&&l!==i&&mr(r,l,{get:()=>t[l],enumerable:!(s=Zh(t,l))||s.enumerable});return r};var Xh=(r,t,i)=>(i=r!=null?jh(Kh(r)):{},Os(t||!r||!r.__esModule?mr(i,"default",{value:r,enumerable:!0}):i,r)),gr=r=>Os(mr({},"__esModule",{value:!0}),r);var y=At(()=>{});var Yn={};An(Yn,{createReadStream:()=>Ts,createWriteStream:()=>Is,default:()=>$h,existsSync:()=>Cs,lstatSync:()=>Ns,mkdirSync:()=>Es,readFileSync:()=>yr,readdirSync:()=>Sr,rmdirSync:()=>Rs,statSync:()=>In,unlinkSync:()=>As,writeFileSync:()=>Ls});function Tn(r){return String(r).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ds(r){var t=Tn(r);if(_r[t]!==void 0)return _r[t];for(var i=Object.keys(_r),s=0;s<i.length;s++)if(t.endsWith("/"+i[s])||t===i[s])return _r[i[s]]}function Rn(r){var t=Tn(r);if(vr[t]!==void 0)return vr[t];for(var i=Object.keys(vr),s=0;s<i.length;s++)if(t.endsWith("/"+i[s])||t===i[s])return vr[i[s]]}var _r,vr,yr,Sr,Cs,Ls,Es,In,Ns,As,Rs,Ts,Is,$h,Rt=At(()=>{"use strict";y();_r={"package.json":`{
  "name": "jsonresume-theme-americano-german",
  "version": "0.1.4",
  "description": "minimalistic german theme for JSON Resume. Based on macchiato-theme.",
  "author": "Marek Baron",
  "scripts": {
  ...
  "repository": {
    "type": "git",
    "url": "https://github.com/marek-baron/jsonresume-theme-americano-german"
  },
  "license": "MIT",
  "dependencies": {
...
<div class="container about-container">
  ...
  {{/if}}
    ...
    {{> title value="Pers\xF6nliche Daten"}}

    {{#if birthday}}
        {{> info-tag text=(concat "Geb. am " this.birthday) icon="fa-calendar"}}
    {{/if}}
...
<div class="container education-container">
    {{> title value="Abschl\xFCsse"}} {{#each resume.education}}
    <section class="item">
...
{{/if}}`,"src/partials/languages.hbs":`{{#if resume.languages.length}}
    <div class="container languages-container">
        {{> title value="Sprachen"}}

        <ul class="minimal">
            {{#each resume.languages}}
                <li>
                    <h6 class="skill language-item">{{language}} {{#if fluency}}<em>({{fluency}})</em>{{/if}}</h6>
                </li>
            {{/each}}
        </ul>
    </div>
...
<div class="container publications-container">
    {{> title value="Ver\xF6ffentlichungen"}}
...
<div class="container work-container">
    {{> title value="Beruflicher Werdegang"}}
