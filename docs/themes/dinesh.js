var Ft=Object.create;var J=Object.defineProperty;var Vt=Object.getOwnPropertyDescriptor;var qt=Object.getOwnPropertyNames;var jt=Object.getPrototypeOf,Ut=Object.prototype.hasOwnProperty;var q=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,n)=>(typeof require<"u"?require:t)[n]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var Be=(e,t)=>()=>(e&&(t=e(e=0)),t);var m=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),zt=(e,t)=>{for(var n in t)J(e,n,{get:t[n],enumerable:!0})},Me=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of qt(t))!Ut.call(e,s)&&s!==n&&J(e,s,{get:()=>t[s],enumerable:!(i=Vt(t,s))||i.enumerable});return e};var Wt=(e,t,n)=>(n=e!=null?Ft(jt(e)):{},Me(t||!e||!e.__esModule?J(n,"default",{value:e,enumerable:!0}):n,e)),Fe=e=>Me(J({},"__esModule",{value:!0}),e);var p=Be(()=>{});var ue={};zt(ue,{createReadStream:()=>Ye,createWriteStream:()=>Qe,default:()=>Gt,existsSync:()=>Ue,lstatSync:()=>Ge,mkdirSync:()=>We,readFileSync:()=>qe,readdirSync:()=>je,rmdirSync:()=>Je,statSync:()=>pe,unlinkSync:()=>Ke,writeFileSync:()=>ze});function ce(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ve(e){var t=ce(e);if(Y[t]!==void 0)return Y[t];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return Y[n[i]]}function he(e){var t=ce(e);if(Q[t]!==void 0)return Q[t];for(var n=Object.keys(Q),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return Q[n[i]]}var Y,Q,qe,je,Ue,ze,We,pe,Ge,Ke,Je,Ye,Qe,Gt,fe=Be(()=>{"use strict";p();Y={"package.json":`{
