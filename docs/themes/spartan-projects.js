var uh=Object.create;var cn=Object.defineProperty;var ch=Object.getOwnPropertyDescriptor;var hh=Object.getOwnPropertyNames;var fh=Object.getPrototypeOf,dh=Object.prototype.hasOwnProperty;var ss=(n=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(e,i)=>(typeof require<"u"?require:e)[i]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var as=(n,e)=>()=>(n&&(e=n(n=0)),e);var L=(n,e)=>()=>(e||n((e={exports:{}}).exports,e),e.exports),ph=(n,e)=>{for(var i in e)cn(n,i,{get:e[i],enumerable:!0})},os=(n,e,i,a)=>{if(e&&typeof e=="object"||typeof e=="function")for(let l of hh(e))!dh.call(n,l)&&l!==i&&cn(n,l,{get:()=>e[l],enumerable:!(a=ch(e,l))||a.enumerable});return n};var mh=(n,e,i)=>(i=n!=null?uh(fh(n)):{},os(e||!n||!n.__esModule?cn(i,"default",{value:n,enumerable:!0}):i,n)),gh=n=>os(cn({},"__esModule",{value:!0}),n);var k=as(()=>{});var ys={};ph(ys,{createReadStream:()=>_s,createWriteStream:()=>vs,default:()=>_h,existsSync:()=>hs,lstatSync:()=>ps,mkdirSync:()=>ds,readFileSync:()=>us,readdirSync:()=>cs,rmdirSync:()=>gs,statSync:()=>yr,unlinkSync:()=>ms,writeFileSync:()=>fs});function vr(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function ls(n){var e=vr(n);if(hn[e]!==void 0)return hn[e];for(var i=Object.keys(hn),a=0;a<i.length;a++)if(e.endsWith("/"+i[a])||e===i[a])return hn[i[a]]}function _r(n){var e=vr(n);if(fn[e]!==void 0)return fn[e];for(var i=Object.keys(fn),a=0;a<i.length;a++)if(e.endsWith("/"+i[a])||e===i[a])return fn[i[a]]}var hn,fn,us,cs,hs,fs,ds,yr,ps,ms,gs,_s,vs,_h,ks=as(()=>{"use strict";k();hn={"package.json":`{
