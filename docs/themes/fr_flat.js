var Ve=Object.create;var J=Object.defineProperty;var je=Object.getOwnPropertyDescriptor;var Fe=Object.getOwnPropertyNames;var Ue=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Mt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)J(t,n,{get:e[n],enumerable:!0})},qt=(t,e,n,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Fe(e))!ze.call(t,i)&&i!==n&&J(t,i,{get:()=>e[i],enumerable:!(s=je(e,i))||s.enumerable});return t};var Ge=(t,e,n)=>(n=t!=null?Ve(Ue(t)):{},qt(e||!t||!t.__esModule?J(n,"default",{value:t,enumerable:!0}):n,t)),Bt=t=>qt(J({},"__esModule",{value:!0}),t);var u=Mt(()=>{});var pt={};We(pt,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>Ke,existsSync:()=>Ut,lstatSync:()=>Gt,mkdirSync:()=>Wt,readFileSync:()=>jt,readdirSync:()=>Ft,rmdirSync:()=>Jt,statSync:()=>ut,unlinkSync:()=>Kt,writeFileSync:()=>zt});function ct(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Vt(t){var e=ct(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),s=0;s<n.length;s++)if(e.endsWith("/"+n[s])||e===n[s])return Y[n[s]]}function ht(t){var e=ct(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),s=0;s<n.length;s++)if(e.endsWith("/"+n[s])||e===n[s])return X[n[s]]}var Y,X,jt,Ft,Ut,zt,Wt,ut,Gt,Kt,Jt,Yt,Xt,Ke,dt=Mt(()=>{"use strict";u();Y={"package.json":`{
