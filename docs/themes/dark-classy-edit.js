var tn=Object.create;var K=Object.defineProperty;var en=Object.getOwnPropertyDescriptor;var nn=Object.getOwnPropertyNames;var sn=Object.getPrototypeOf,rn=Object.prototype.hasOwnProperty;var V=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var pt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Bt=(t,e)=>{for(var n in e)K(t,n,{get:e[n],enumerable:!0})},Wt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of nn(e))!rn.call(t,s)&&s!==n&&K(t,s,{get:()=>e[s],enumerable:!(i=en(e,s))||i.enumerable});return t};var an=(t,e,n)=>(n=t!=null?tn(sn(t)):{},Wt(e||!t||!t.__esModule?K(n,"default",{value:t,enumerable:!0}):n,t)),ft=t=>Wt(K({},"__esModule",{value:!0}),t);var u=pt(()=>{});var vt={};Bt(vt,{createReadStream:()=>te,createWriteStream:()=>ee,default:()=>on,existsSync:()=>Kt,lstatSync:()=>Xt,mkdirSync:()=>Qt,readFileSync:()=>Jt,readdirSync:()=>Gt,rmdirSync:()=>$t,statSync:()=>gt,unlinkSync:()=>Zt,writeFileSync:()=>Yt});function mt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ut(t){var e=mt(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}function dt(t){var e=mt(t);if(Q[e]!==void 0)return Q[e];for(var n=Object.keys(Q),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Q[n[i]]}var Y,Q,Jt,Gt,Kt,Yt,Qt,gt,Xt,Zt,$t,te,ee,on,bt=pt(()=>{"use strict";u();Y={"package.json":`{
  "name": "jsonresume-theme-dark-classy-edit",
  "version": "0.1.1",
  "description": "Dark classy edit of the infamous jsonresume theme.",
  "author": "Cko bu",
  "repository": {
    "type": "git",
    "url": "https://github.com/milos-v/jsonresume-theme-dark-classy-edit"
  },
  "license": "MIT",
  "dependencies": {
...
/*-->*/
	...
	<!-- <div id="resume"> -->
		...
		<header class="header">
			<h1>Milo\u0161 Veljkovi\u0107</h1>
			<h3 class="label">Programmer</h3>
			<ul id="contact" class="contact-list list-lines">
				<li class="contact-header">(+381)69 189 19 99</li>
				<li class="contact-header"><a href="mailto:mlsvljkvc@gmail.com">mlsvljkvc@gmail.com</a></li>
			</ul>
			<ul id="profiles" class="profiles-list list-set">
				<li><a href="https://www.linkedin.com/in/mlsvljkvc/" class="profile" title="LinkedIn"><i class="fa fa-linkedin"></i><span class="profile-name">LinkedIn</span></a></li>
				<li><a href="https://github.com/milos-v" class="profile" title="Github"><i class="fa fa-github"></i><span class="profile-name">Github</span></a></li>
			</ul>
		</header>
		...
		<main role="main" class="main">
			<section id="about" class="section">
				...
				<p>I started as a designer because being a designer gives you a chance to express yourself creatively. One time a website had to be finished, the design was done but no one in the company knew how to do HTML/CSS. I decided to give it a try. Somehow it came naturally to me and the more I learned the clearer it became to me that coding is highly creative. It quickly captured the whole of my attention. For a long time design remained in my field of work, so I was able to constantly mix the two. Somewhere in the process I switched to coding completely. In the past two years I&#x27;ve been doing mostly back-end programming and designing only as a hobby.       I am eager to learn more and continue to improve my skills from project to project so I can have a bigger impact wherever I land.</p>
			</section>
			<section id="work" class="section">
				<h2><i class="fa fa-suitcase left"></i>Work Experience</h2>
				<section class="section-sub section-sub-job">
					<h3>Web developer, RBT</h3>
						<h4>April 2016 - present</h4>
					<p>Working on a large team and a variety of projects. Started with frontend, mostly AngularJS and ReactJS. Later switched to ROR and balancing it with AngularJS </p>
					<h4>Highlights</h4>
					<ul>
						<li>Mastering ROR, MongoDb, AngularJS</li>
						<li>Introduction ReactJS, Redux, Python, Flask</li>
					</ul>
				</section>
				<section class="section-sub section-sub-job">
					<h3>Frontend developer, Probe &amp; Query</h3>
						<h4>November 2015 - April 2016</h4>
						<h4><a href=http://probe-query.com/>http://probe-query.com/</a></h4>
					<p>Developing a Wordpress theme for International Water Association. </p>
					<h4>Highlights</h4>
					<ul>
				...
				<section class="section-sub section-sub-job">
					<h3>Frontend developer, Dodo</h3>
						<h4>March 2014 - April 2016</h4>
						<h4><a href=http://fakturabank.no>http://fakturabank.no</a></h4>
					<p>Designing and developing frontend part of a web based accounting app. Every day communication with the clients. Later on leading a team of 3 frontend developers, team expansion, interviews..</p>
					<h4>Highlights</h4>
					<ul>
						<li>Complete upgrade of UI/UX </li>
						<li>Mastering SASS, jQuery, JS</li>
						<li>Introduction to Ruby, Rails, Postgres</li>
					</ul>
				</section>
				<section class="section-sub section-sub-job">
					<h3>Junior frontend developer, ESD</h3>
						<h4>November 2013 - February 2014</h4>
						<h4><a href=http://esd.rs>http://esd.rs</a></h4>
					<p>Out sourcing company. Mostly doing PSD to HTML conversion(HTML5, CSS3, JS) but also some web shop creation(HTML, PHP, JS) and a bit of design.</p>
					<h4>Highlights</h4>
					<ul>
						<li>Mastering HTML, CSS</li>
						<li>Definite switch from design to coding</li>
			...
			<section id="education" class="section">
				...
				<section class="section-sub section-sub-education">
					<h3>High School - Gimnazija &quot;Sveti Sava&quot;</h3>
					<h4>September 2004 - May 2008</h4>
			...
			<section id="languages" class="section">
				...
				<section class="section-sub section-sub-language">
					<h3>Serbian</h3>
					<h4>Fluency: Native</h4>
				</section>
				<section class="section-sub section-sub-language">
					<h3>English</h3>
					<h4>Fluency: Fluent</h4>
				</section>
			</section>
		</main>
	</body>
...
<html>
	...
	<!-- <div id="resume"> -->
		...
		<header class="header">
			<h1>{{#resume.basics}}{{name}}{{/resume.basics}}</h1>
			<h3 class="label">{{#resume.basics}}{{label}}{{/resume.basics}}</h3>
			<ul id="contact" class="contact-list list-lines">
				<li class="contact-header">{{#resume.basics}}{{phone}}{{/resume.basics}}</li>
				<li class="contact-header"><a href="mailto:mlsvljkvc@gmail.com">{{#resume.basics}}{{email}}{{/resume.basics}}</a></li>
			</ul>
			<ul id="profiles" class="profiles-list list-set">
			{{#each resume.basics.profiles}}
				<li><a href="{{this.url}}" class="profile" title="{{this.network}}"><i class="fa fa-{{this.faclass}}"></i><span class="profile-name">{{this.network}}</span></a></li>
			{{/each}}
			</ul>
		</header>
		...
		<main role="main" class="main">
			<section id="about" class="section">
				<h2><i class="fa fa-user left"></i>About</h2>
				<p>{{#resume.basics}}{{summary}}{{/resume.basics}}</p>
			</section>
			<section id="work" class="section">
				<h2><i class="fa fa-suitcase left"></i>Work Experience</h2>
				{{#each resume.work}}
				<section class="section-sub section-sub-job">
					...
					{{#if this.endDate}}
						<h4>{{this.startDate}} - {{this.endDate}}</h4>
					{{else}}
						<h4>{{this.startDate}} - present</h4>
					{{/if}}
					{{#if this.website}}
						<h4><a href={{this.website}}>{{this.website}}</a></h4>
					{{/if}}
					<p>{{this.summary}}</p>
					<h4>Highlights</h4>
					<ul>
			...
			<section id="education" class="section">
				...
				{{#each resume.education}}
				<section class="section-sub section-sub-education">
					<h3>{{this.studyType}} - {{this.institution}}</h3>
					<h4>{{this.startDate}} - {{this.endDate}}</h4>
					<p>{{this.area}}</p>
				</section>
				{{/each}}
