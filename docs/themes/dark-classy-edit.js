...
var tn=Object.create;var Y=Object.defineProperty;var en=Object.getOwnPropertyDescriptor;var nn=Object.getOwnPropertyNames;var sn=Object.getPrototypeOf,rn=Object.prototype.hasOwnProperty;var z=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var pt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Bt=(t,e)=>{for(var n in e)Y(t,n,{get:e[n],enumerable:!0})},Wt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of nn(e))!rn.call(t,s)&&s!==n&&Y(t,s,{get:()=>e[s],enumerable:!(i=en(e,s))||i.enumerable});return t};var an=(t,e,n)=>(n=t!=null?tn(sn(t)):{},Wt(e||!t||!t.__esModule?Y(n,"default",{value:t,enumerable:!0}):n,t)),ft=t=>Wt(Y({},"__esModule",{value:!0}),t);var u=pt(()=>{});var vt={};Bt(vt,{createReadStream:()=>te,createWriteStream:()=>ee,default:()=>on,existsSync:()=>Kt,lstatSync:()=>Xt,mkdirSync:()=>Qt,readFileSync:()=>Jt,readdirSync:()=>Gt,rmdirSync:()=>$t,statSync:()=>gt,unlinkSync:()=>Zt,writeFileSync:()=>Yt});function mt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ut(t){var e=mt(t);if(Q[e]!==void 0)return Q[e];for(var n=Object.keys(Q),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Q[n[i]]}function dt(t){var e=mt(t);if((e===""||e===".")&&F["."]!==void 0)return F["."];if(F[e]!==void 0)return F[e];for(var n=Object.keys(F),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return F[n[i]]}var Q,F,Jt,Gt,Kt,Yt,Qt,gt,Xt,Zt,$t,te,ee,on,bt=pt(()=>{"use strict";u();Q={"package.json":`{
