var Vg=Object.create;var Ir=Object.defineProperty;var jg=Object.getOwnPropertyDescriptor;var n0=Object.getOwnPropertyNames;var e0=Object.getPrototypeOf,t0=Object.prototype.hasOwnProperty;var Uf=(u,A)=>()=>(u&&(A=u(u=0)),A);var Ee=(u,A)=>()=>(A||u((A={exports:{}}).exports,A),A.exports),r0=(u,A)=>{for(var L in A)Ir(u,L,{get:A[L],enumerable:!0})},Pf=(u,A,L,h)=>{if(A&&typeof A=="object"||typeof A=="function")for(let T of n0(A))!t0.call(u,T)&&T!==L&&Ir(u,T,{get:()=>A[T],enumerable:!(h=jg(A,T))||h.enumerable});return u};var i0=(u,A,L)=>(L=u!=null?Vg(e0(u)):{},Pf(A||!u||!u.__esModule?Ir(L,"default",{value:u,enumerable:!0}):L,u)),u0=u=>Pf(Ir({},"__esModule",{value:!0}),u);var sn=Uf(()=>{});var $f={};r0($f,{createReadStream:()=>zf,createWriteStream:()=>Kf,default:()=>a0,existsSync:()=>kf,lstatSync:()=>Gf,mkdirSync:()=>Hf,readFileSync:()=>Ff,readdirSync:()=>Of,rmdirSync:()=>Yf,statSync:()=>eu,unlinkSync:()=>qf,writeFileSync:()=>Nf});function nu(u){return String(u).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Wf(u){var A=nu(u);if(Tr[A]!==void 0)return Tr[A];for(var L=Object.keys(Tr),h=0;h<L.length;h++)if(A.endsWith("/"+L[h])||A===L[h])return Tr[L[h]]}function ji(u){var A=nu(u);if(Dr[A]!==void 0)return Dr[A];for(var L=Object.keys(Dr),h=0;h<L.length;h++)if(A.endsWith("/"+L[h])||A===L[h])return Dr[L[h]]}var Tr,Dr,Ff,Of,kf,Nf,Hf,eu,Gf,qf,Yf,zf,Kf,a0,Zf=Uf(()=>{"use strict";sn();Tr={"package.json":`{
