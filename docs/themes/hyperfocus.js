var tn=Object.create;var K=Object.defineProperty;var en=Object.getOwnPropertyDescriptor;var nn=Object.getOwnPropertyNames;var sn=Object.getPrototypeOf,rn=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var pt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),zt=(t,e)=>{for(var n in e)K(t,n,{get:e[n],enumerable:!0})},Wt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of nn(e))!rn.call(t,s)&&s!==n&&K(t,s,{get:()=>e[s],enumerable:!(i=en(e,s))||i.enumerable});return t};var an=(t,e,n)=>(n=t!=null?tn(sn(t)):{},Wt(e||!t||!t.__esModule?K(n,"default",{value:t,enumerable:!0}):n,t)),dt=t=>Wt(K({},"__esModule",{value:!0}),t);var u=pt(()=>{});var vt={};zt(vt,{createReadStream:()=>te,createWriteStream:()=>ee,default:()=>on,existsSync:()=>Kt,lstatSync:()=>Zt,mkdirSync:()=>Xt,readFileSync:()=>Gt,readdirSync:()=>Jt,rmdirSync:()=>$t,statSync:()=>gt,unlinkSync:()=>Qt,writeFileSync:()=>Yt});function mt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ut(t){var e=mt(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}function ft(t){var e=mt(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}var Y,X,Gt,Jt,Kt,Yt,Xt,gt,Zt,Qt,$t,te,ee,on,bt=pt(()=>{"use strict";u();Y={"package.json":`{
