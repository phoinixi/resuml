...
var Jr=Object.create;var It=Object.defineProperty;var Qr=Object.getOwnPropertyDescriptor;var $r=Object.getOwnPropertyNames;var Xr=Object.getPrototypeOf,Zr=Object.prototype.hasOwnProperty;var je=(g,x)=>()=>(g&&(x=g(g=0)),x);var Mn=(g,x)=>()=>(x||g((x={exports:{}}).exports,x),x.exports),no=(g,x)=>{for(var S in x)It(g,S,{get:x[S],enumerable:!0})},Pe=(g,x,S,d)=>{if(x&&typeof x=="object"||typeof x=="function")for(let D of $r(x))!Zr.call(g,D)&&D!==S&&It(g,D,{get:()=>x[D],enumerable:!(d=Qr(x,D))||d.enumerable});return g};var to=(g,x,S)=>(S=g!=null?Jr(Xr(g)):{},Pe(x||!g||!g.__esModule?It(S,"default",{value:g,enumerable:!0}):S,g)),eo=g=>Pe(It({},"__esModule",{value:!0}),g);var B=je(()=>{});var We={};no(We,{createReadStream:()=>qe,createWriteStream:()=>Ne,default:()=>io,existsSync:()=>ke,lstatSync:()=>Ae,mkdirSync:()=>Ue,readFileSync:()=>Me,readdirSync:()=>Le,rmdirSync:()=>Oe,statSync:()=>te,unlinkSync:()=>Be,writeFileSync:()=>Fe});function ne(g){return String(g).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Te(g){var x=ne(g);if(jt[x]!==void 0)return jt[x];for(var S=Object.keys(jt),d=0;d<S.length;d++)if(x.endsWith("/"+S[d])||x===S[d])return jt[S[d]]}function Zt(g){var x=ne(g);if((x===""||x===".")&&$n["."]!==void 0)return $n["."];if($n[x]!==void 0)return $n[x];for(var S=Object.keys($n),d=0;d<S.length;d++)if(x.endsWith("/"+S[d])||x===S[d])return $n[S[d]]}var jt,$n,Me,Le,ke,Fe,Ue,te,Ae,Be,Oe,qe,Ne,io,Ye=je(()=>{"use strict";B();jt={"css/style.css":`body {\r
