...
var fi=Object.create;var xe=Object.defineProperty;var di=Object.getOwnPropertyDescriptor;var mi=Object.getOwnPropertyNames;var gi=Object.getPrototypeOf,vi=Object.prototype.hasOwnProperty;var ln=(t,e)=>()=>(t&&(e=t(t=0)),e);var v=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),_i=(t,e)=>{for(var n in e)xe(t,n,{get:e[n],enumerable:!0})},un=(t,e,n,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of mi(e))!vi.call(t,i)&&i!==n&&xe(t,i,{get:()=>e[i],enumerable:!(r=di(e,i))||r.enumerable});return t};var yi=(t,e,n)=>(n=t!=null?fi(gi(t)):{},un(e||!t||!t.__esModule?xe(n,"default",{value:t,enumerable:!0}):n,t)),bi=t=>un(xe({},"__esModule",{value:!0}),t);var p=ln(()=>{});var kn={};_i(kn,{createReadStream:()=>yn,createWriteStream:()=>bn,default:()=>ki,existsSync:()=>fn,lstatSync:()=>gn,mkdirSync:()=>mn,readFileSync:()=>hn,readdirSync:()=>pn,rmdirSync:()=>_n,statSync:()=>ft,unlinkSync:()=>vn,writeFileSync:()=>dn});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function cn(t){var e=pt(t);if(Ee[e]!==void 0)return Ee[e];for(var n=Object.keys(Ee),r=0;r<n.length;r++)if(e.endsWith("/"+n[r])||e===n[r])return Ee[n[r]]}function ht(t){var e=pt(t);if((e===""||e===".")&&te["."]!==void 0)return te["."];if(te[e]!==void 0)return te[e];for(var n=Object.keys(te),r=0;r<n.length;r++)if(e.endsWith("/"+n[r])||e===n[r])return te[n[r]]}var Ee,te,hn,pn,fn,dn,mn,ft,gn,vn,_n,yn,bn,ki,Sn=ln(()=>{"use strict";p();Ee={"package.json":`{
