var ah=Object.create;var un=Object.defineProperty;var oh=Object.getOwnPropertyDescriptor;var lh=Object.getOwnPropertyNames;var uh=Object.getPrototypeOf,ch=Object.prototype.hasOwnProperty;var ri=(n=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(e,s)=>(typeof require<"u"?require:e)[s]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var si=(n,e)=>()=>(n&&(e=n(n=0)),e);var L=(n,e)=>()=>(e||n((e={exports:{}}).exports,e),e.exports),hh=(n,e)=>{for(var s in e)un(n,s,{get:e[s],enumerable:!0})},ii=(n,e,s,a)=>{if(e&&typeof e=="object"||typeof e=="function")for(let l of lh(e))!ch.call(n,l)&&l!==s&&un(n,l,{get:()=>e[l],enumerable:!(a=oh(e,l))||a.enumerable});return n};var fh=(n,e,s)=>(s=n!=null?ah(uh(n)):{},ii(e||!n||!n.__esModule?un(s,"default",{value:n,enumerable:!0}):s,n)),dh=n=>ii(un({},"__esModule",{value:!0}),n);var S=si(()=>{});var _i={};hh(_i,{createReadStream:()=>mi,createWriteStream:()=>gi,default:()=>ph,existsSync:()=>ui,lstatSync:()=>fi,mkdirSync:()=>hi,readFileSync:()=>oi,readdirSync:()=>li,rmdirSync:()=>pi,statSync:()=>vr,unlinkSync:()=>di,writeFileSync:()=>ci});function _r(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function ai(n){var e=_r(n);if(cn[e]!==void 0)return cn[e];for(var s=Object.keys(cn),a=0;a<s.length;a++)if(e.endsWith("/"+s[a])||e===s[a])return cn[s[a]]}function gr(n){var e=_r(n);if(hn[e]!==void 0)return hn[e];for(var s=Object.keys(hn),a=0;a<s.length;a++)if(e.endsWith("/"+s[a])||e===s[a])return hn[s[a]]}var cn,hn,oi,li,ui,ci,hi,vr,fi,di,pi,mi,gi,ph,vi=si(()=>{"use strict";S();cn={"package.json":`{
