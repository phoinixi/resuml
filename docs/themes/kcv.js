var Te=Object.create;var X=Object.defineProperty;var Fe=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var Ue=Object.getPrototypeOf,Ke=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Mt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)X(t,n,{get:e[n],enumerable:!0})},Bt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of je(e))!Ke.call(t,s)&&s!==n&&X(t,s,{get:()=>e[s],enumerable:!(i=Fe(e,s))||i.enumerable});return t};var ze=(t,e,n)=>(n=t!=null?Te(Ue(t)):{},Bt(e||!t||!t.__esModule?X(n,"default",{value:t,enumerable:!0}):n,t)),Tt=t=>Bt(X({},"__esModule",{value:!0}),t);var p=Mt(()=>{});var ft={};We(ft,{createReadStream:()=>Yt,createWriteStream:()=>Zt,default:()=>Je,existsSync:()=>Kt,lstatSync:()=>Jt,mkdirSync:()=>zt,readFileSync:()=>jt,readdirSync:()=>Ut,rmdirSync:()=>Qt,statSync:()=>ut,unlinkSync:()=>Xt,writeFileSync:()=>Wt});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ft(t){var e=pt(t);if(Q[e]!==void 0)return Q[e];for(var n=Object.keys(Q),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Q[n[i]]}function ct(t){var e=pt(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}var Q,Y,jt,Ut,Kt,Wt,zt,ut,Jt,Xt,Qt,Yt,Zt,Je,dt=Mt(()=>{"use strict";p();Q={"package.json":`{
