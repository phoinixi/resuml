...
var qe=Object.create;var J=Object.defineProperty;var Ve=Object.getOwnPropertyDescriptor;var Be=Object.getOwnPropertyNames;var Fe=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var jt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)J(t,n,{get:e[n],enumerable:!0})},qt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Be(e))!ze.call(t,s)&&s!==n&&J(t,s,{get:()=>e[s],enumerable:!(i=Ve(e,s))||i.enumerable});return t};var Ue=(t,e,n)=>(n=t!=null?qe(Fe(t)):{},qt(e||!t||!t.__esModule?J(n,"default",{value:t,enumerable:!0}):n,t)),Vt=t=>qt(J({},"__esModule",{value:!0}),t);var p=jt(()=>{});var ut={};We(ut,{createReadStream:()=>Zt,createWriteStream:()=>Xt,default:()=>Ge,existsSync:()=>Wt,lstatSync:()=>Kt,mkdirSync:()=>Gt,readFileSync:()=>Ft,readdirSync:()=>zt,rmdirSync:()=>Jt,statSync:()=>pt,unlinkSync:()=>Yt,writeFileSync:()=>Ut});function ct(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Bt(t){var e=ct(t);if(Z[e]!==void 0)return Z[e];for(var n=Object.keys(Z),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Z[n[i]]}function ht(t){var e=ct(t);if((e===""||e===".")&&j["."]!==void 0)return j["."];if(j[e]!==void 0)return j[e];for(var n=Object.keys(j),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return j[n[i]]}var Z,j,Ft,zt,Wt,Ut,Gt,pt,Kt,Yt,Jt,Zt,Xt,Ge,ft=jt(()=>{"use strict";p();Z={"index.html":`<!doctype html>
<html>
	<head>
