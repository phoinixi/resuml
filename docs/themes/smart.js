...
var En=Object.create;var me=Object.defineProperty;var wn=Object.getOwnPropertyDescriptor;var Tn=Object.getOwnPropertyNames;var Ln=Object.getPrototypeOf,On=Object.prototype.hasOwnProperty;var Ae=(m,k)=>()=>(m&&(k=m(m=0)),k);var ae=(m,k)=>()=>(k||m((k={exports:{}}).exports,k),k.exports),Me=(m,k)=>{for(var v in k)me(m,v,{get:k[v],enumerable:!0})},Ie=(m,k,v,a)=>{if(k&&typeof k=="object"||typeof k=="function")for(let f of Tn(k))!On.call(m,f)&&f!==v&&me(m,f,{get:()=>k[f],enumerable:!(a=wn(k,f))||a.enumerable});return m};var An=(m,k,v)=>(v=m!=null?En(Ln(m)):{},Ie(k||!m||!m.__esModule?me(v,"default",{value:m,enumerable:!0}):v,m)),Pe=m=>Ie(me({},"__esModule",{value:!0}),m);var D=Ae(()=>{});var Xe={};Me(Xe,{createReadStream:()=>Ye,createWriteStream:()=>Je,default:()=>Sn,existsSync:()=>je,lstatSync:()=>We,mkdirSync:()=>Ue,readFileSync:()=>De,readdirSync:()=>$e,rmdirSync:()=>He,statSync:()=>Ce,unlinkSync:()=>Ge,writeFileSync:()=>Ve});function Ne(m){return String(m).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function ze(m){var k=Ne(m);if(ve[k]!==void 0)return ve[k];for(var v=Object.keys(ve),a=0;a<v.length;a++)if(k.endsWith("/"+v[a])||k===v[a])return ve[v[a]]}function Se(m){var k=Ne(m);if((k===""||k===".")&&ie["."]!==void 0)return ie["."];if(ie[k]!==void 0)return ie[k];for(var v=Object.keys(ie),a=0;a<v.length;a++)if(k.endsWith("/"+v[a])||k===v[a])return ie[v[a]]}var ve,ie,De,$e,je,Ve,Ue,Ce,We,Ge,He,Ye,Je,Sn,qe=Ae(()=>{"use strict";D();ve={"css/css.css":`/* 
