var nt=Object.create;var K=Object.defineProperty;var tt=Object.getOwnPropertyDescriptor;var it=Object.getOwnPropertyNames;var st=Object.getPrototypeOf,rt=Object.prototype.hasOwnProperty;var q=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(n,t)=>(typeof require<"u"?require:n)[t]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var ue=(e,n)=>()=>(e&&(n=e(e=0)),n);var m=(e,n)=>()=>(n||e((n={exports:{}}).exports,n),n.exports),je=(e,n)=>{for(var t in n)K(e,t,{get:n[t],enumerable:!0})},We=(e,n,t,i)=>{if(n&&typeof n=="object"||typeof n=="function")for(let s of it(n))!rt.call(e,s)&&s!==t&&K(e,s,{get:()=>n[s],enumerable:!(i=tt(n,s))||i.enumerable});return e};var at=(e,n,t)=>(t=e!=null?nt(st(e)):{},We(n||!e||!e.__esModule?K(t,"default",{value:e,enumerable:!0}):t,e)),de=e=>We(K({},"__esModule",{value:!0}),e);var p=ue(()=>{});var ve={};je(ve,{createReadStream:()=>en,createWriteStream:()=>nn,default:()=>lt,existsSync:()=>Ke,lstatSync:()=>Qe,mkdirSync:()=>Xe,readFileSync:()=>Ge,readdirSync:()=>Je,rmdirSync:()=>$e,statSync:()=>ge,unlinkSync:()=>Ze,writeFileSync:()=>Ye});function me(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ue(e){var n=me(e);if(Y[n]!==void 0)return Y[n];for(var t=Object.keys(Y),i=0;i<t.length;i++)if(n.endsWith("/"+t[i])||n===t[i])return Y[t[i]]}function fe(e){var n=me(e);if(X[n]!==void 0)return X[n];for(var t=Object.keys(X),i=0;i<t.length;i++)if(n.endsWith("/"+t[i])||n===t[i])return X[t[i]]}var Y,X,Ge,Je,Ke,Ye,Xe,ge,Qe,Ze,$e,en,nn,lt,be=ue(()=>{"use strict";p();Y={"package.json":`{
