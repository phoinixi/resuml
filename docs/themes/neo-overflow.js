...
{{/if}}
`},ht={"test/TestOutput":[],"test/__snapshots__":["SimpleTests.test.js.snap"],test:["SimpleTests.test.js","TestOutput","__snapshots__"],"theme/hbs-helpers":["birth-date.js","date-helpers.js","paragraph-split.js","space-to-dash.js","to-lower-case.js"],"theme/partials":["awards.hbs","basics.hbs","certificates.hbs","date.hbs","education.hbs","interests.hbs","languages.hbs","projects.hbs","publications.hbs","references.hbs","skills.hbs","volunteer.hbs","work.hbs"],theme:["hbs-helpers","partials"],".":["README.md","index.js","jsonresume-theme-neo-overflow-1.0.0.tgz","jsonresume-theme-neo-overflow-1.0.1.tgz","package.json","resume.hbs","style.css","test","theme"]};li=function(t,e){var n=oi(t);return n!==void 0?n:""},ui=function(t,e){var n=pn(t);return n===void 0&&(n=[]),e&&e.withFileTypes?n.map(function(r){var i=fn(t)+"/"+r,s=pn(i)!==void 0;return{name:r,isFile:function(){return!s},isDirectory:function(){return s}}}):n},ci=function(t){return oi(t)!==void 0||pn(t)!==void 0},hi=function(){},pi=function(){},dn=function(){return{isFile:function(){return!0},isDirectory:function(){return!1},size:0,mtime:new Date}},fi=dn,di=function(){},mi=function(){},gi=function(){return{pipe:function(t){return t},on:function(){return this}}},vi=function(){return{write:function(){},end:function(){},on:function(){return this}}},xo={readFileSync:li,readdirSync:ui,existsSync:ci,writeFileSync:hi,mkdirSync:pi,statSync:dn,lstatSync:fi,unlinkSync:di,rmdirSync:mi,createReadStream:gi,createWriteStream:vi}});var Li={};_n(Li,{basename:()=>pt,default:()=>Lo,dirname:()=>mn,extname:()=>ft,isAbsolute:()=>wi,join:()=>bi,normalize:()=>Ci,parse:()=>xi,relative:()=>Pi,resolve:()=>Si,sep:()=>ki});var bi,Si,mn,pt,ft,ki,wi,Ci,Pi,xi,Lo,Ei=_t(()=>{"use strict";p();bi=function(){return[].slice.call(arguments).join("/")},Si=function(){return[].slice.call(arguments).join("/")},mn=function(t){return t.split("/").slice(0,-1).join("/")},pt=function(t,e){var n=t.split("/").pop()||"";return e&&n.endsWith(e)?n.slice(0,-e.length):n},ft=function(t){var e=t.match(/\.[^.]+$/);return e?e[0]:""},ki="/",wi=function(t){return t.charAt(0)==="/"},Ci=function(t){return t},Pi=function(t,e){return e},xi=function(t){return{root:"",dir:mn(t),base:pt(t),ext:ft(t),name:pt(t,ft(t))}},Lo={join:bi,resolve:Si,dirname:mn,basename:pt,extname:ft,sep:ki,isAbsolute:wi,normalize:Ci,relative:Pi,parse:xi}});var Oi=v((tu,Mi)=>{p();var z=ai(),{readFileSync:gn,readdirSync:Eo}=(yi(),bn(_i)),{join:j}=(Ei(),bn(Li)),xe=j("/","theme/hbs-helpers"),{birthDate:Mo}=re(j(xe,"birth-date.js")),{dateHelpers:Oo}=re(j(xe,"date-helpers.js")),{paragraphSplit:Ao}=re(j(xe,"paragraph-split.js")),{toLowerCase:Io}=re(j(xe,"to-lower-case.js")),{spaceToDash:No}=re(j(xe,"space-to-dash.js")),{MY:Do,Y:Ro,DMY:qo}=Oo;z.registerHelper("birthDate",Mo);z.registerHelper("MY",Do);z.registerHelper("Y",Ro);z.registerHelper("DMY",qo);z.registerHelper("paragraphSplit",Ao);z.registerHelper("toLowerCase",Io);z.registerHelper("spaceToDash",No);function Bo(t){let e=gn("//style.css","utf-8"),n=gn("//resume.hbs","utf-8"),r=j("/","theme/partials");return Eo(r).forEach(s=>{let a=/^([^.]+).hbs$/.exec(s);if(!a)return;let l=a[1],u=j(r,s),o=gn(u,"utf8");z.registerPartial(l,o)}),z.compile(n)({css:e,resume:t})}var dt="0.8 cm",Ho={margin:{top:dt,bottom:dt,left:dt,right:dt}};Mi.exports={render:Bo,pdfRenderOptions:Ho}});p();var te=Bi(Oi(),1),Ai=te.default??te,iu=Ai.render??te.render,su=Ai.pdfRenderOptions??te.pdfRenderOptions;export{su as pdfRenderOptions,iu as render};
