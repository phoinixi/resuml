...
var qh=Object.create;var $n=Object.defineProperty;var Vh=Object.getOwnPropertyDescriptor;var Gh=Object.getOwnPropertyNames;var zh=Object.getPrototypeOf,Zh=Object.prototype.hasOwnProperty;var to=(r=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(r,{get:(e,i)=>(typeof require<"u"?require:e)[i]}):r)(function(r){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+r+'" is not supported')});var eo=(r,e)=>()=>(r&&(e=r(r=0)),e);var V=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),Jh=(r,e)=>{for(var i in e)$n(r,i,{get:e[i],enumerable:!0})},ro=(r,e,i,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let l of Gh(e))!Zh.call(r,l)&&l!==i&&$n(r,l,{get:()=>e[l],enumerable:!(s=Vh(e,l))||s.enumerable});return r};var Kh=(r,e,i)=>(i=r!=null?qh(zh(r)):{},ro(e||!r||!r.__esModule?$n(i,"default",{value:r,enumerable:!0}):i,r)),Qh=r=>ro($n({},"__esModule",{value:!0}),r);var D=eo(()=>{});var mo={};Jh(mo,{createReadStream:()=>fo,createWriteStream:()=>po,default:()=>Xh,existsSync:()=>ao,lstatSync:()=>uo,mkdirSync:()=>lo,readFileSync:()=>io,readdirSync:()=>so,rmdirSync:()=>ho,statSync:()=>Ts,unlinkSync:()=>co,writeFileSync:()=>oo});function Is(r){return String(r).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function no(r){var e=Is(r);if(ti[e]!==void 0)return ti[e];for(var i=Object.keys(ti),s=0;s<i.length;s++)if(e.endsWith("/"+i[s])||e===i[s])return ti[i[s]]}function Rs(r){var e=Is(r);if((e===""||e===".")&&gr["."]!==void 0)return gr["."];if(gr[e]!==void 0)return gr[e];for(var i=Object.keys(gr),s=0;s<i.length;s++)if(e.endsWith("/"+i[s])||e===i[s])return gr[i[s]]}var ti,gr,io,so,ao,oo,lo,Ts,uo,co,ho,fo,po,Xh,go=eo(()=>{"use strict";D();ti={"package.json":`{\r
