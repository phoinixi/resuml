var nt=Object.create;var K=Object.defineProperty;var tt=Object.getOwnPropertyDescriptor;var rt=Object.getOwnPropertyNames;var it=Object.getPrototypeOf,st=Object.prototype.hasOwnProperty;var V=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(n,t)=>(typeof require<"u"?require:n)[t]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var ue=(e,n)=>()=>(e&&(n=e(e=0)),n);var m=(e,n)=>()=>(n||e((n={exports:{}}).exports,n),n.exports),ze=(e,n)=>{for(var t in n)K(e,t,{get:n[t],enumerable:!0})},We=(e,n,t,r)=>{if(n&&typeof n=="object"||typeof n=="function")for(let i of rt(n))!st.call(e,i)&&i!==t&&K(e,i,{get:()=>n[i],enumerable:!(r=tt(n,i))||r.enumerable});return e};var at=(e,n,t)=>(t=e!=null?nt(it(e)):{},We(n||!e||!e.__esModule?K(t,"default",{value:e,enumerable:!0}):t,e)),de=e=>We(K({},"__esModule",{value:!0}),e);var p=ue(()=>{});var ve={};ze(ve,{createReadStream:()=>en,createWriteStream:()=>nn,default:()=>ot,existsSync:()=>Ke,lstatSync:()=>Xe,mkdirSync:()=>Ye,readFileSync:()=>Ue,readdirSync:()=>Ge,rmdirSync:()=>$e,statSync:()=>ge,unlinkSync:()=>Ze,writeFileSync:()=>Qe});function me(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Je(e){var n=me(e);if(Q[n]!==void 0)return Q[n];for(var t=Object.keys(Q),r=0;r<t.length;r++)if(n.endsWith("/"+t[r])||n===t[r])return Q[t[r]]}function fe(e){var n=me(e);if(Y[n]!==void 0)return Y[n];for(var t=Object.keys(Y),r=0;r<t.length;r++)if(n.endsWith("/"+t[r])||n===t[r])return Y[t[r]]}var Q,Y,Ue,Ge,Ke,Qe,Ye,ge,Xe,Ze,$e,en,nn,ot,be=ue(()=>{"use strict";p();Q={"package.json":`{
