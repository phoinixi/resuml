var Ft=Object.create;var J=Object.defineProperty;var qt=Object.getOwnPropertyDescriptor;var jt=Object.getOwnPropertyNames;var Ut=Object.getPrototypeOf,zt=Object.prototype.hasOwnProperty;var q=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,n)=>(typeof require<"u"?require:t)[n]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var Be=(e,t)=>()=>(e&&(t=e(e=0)),t);var m=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Wt=(e,t)=>{for(var n in t)J(e,n,{get:t[n],enumerable:!0})},Me=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of jt(t))!zt.call(e,s)&&s!==n&&J(e,s,{get:()=>t[s],enumerable:!(i=qt(t,s))||i.enumerable});return e};var Gt=(e,t,n)=>(n=e!=null?Ft(Ut(e)):{},Me(t||!e||!e.__esModule?J(n,"default",{value:e,enumerable:!0}):n,e)),Ve=e=>Me(J({},"__esModule",{value:!0}),e);var p=Be(()=>{});var ue={};Wt(ue,{createReadStream:()=>Ye,createWriteStream:()=>Xe,default:()=>Kt,existsSync:()=>Ue,lstatSync:()=>Ge,mkdirSync:()=>We,readFileSync:()=>qe,readdirSync:()=>je,rmdirSync:()=>Je,statSync:()=>pe,unlinkSync:()=>Ke,writeFileSync:()=>ze});function ce(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Fe(e){var t=ce(e);if(Y[t]!==void 0)return Y[t];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return Y[n[i]]}function he(e){var t=ce(e);if(X[t]!==void 0)return X[t];for(var n=Object.keys(X),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return X[n[i]]}var Y,X,qe,je,Ue,ze,We,pe,Ge,Ke,Je,Ye,Xe,Kt,fe=Be(()=>{"use strict";p();Y={"package.json":`{
  "name": "jsonresume-theme-onepage_zena",
  "version": "0.0.2",
  "description": "A fork of Ainsley Chong's onepage theme.",
  "author": "Ainsley Chong",
  "contributors": [
    {
      "name": "Zena Hirsch",
      "email": "hirsch.zena@gmail.com"
    }
  ],
  "repository": {
    "type": "git",
    "url": "https://github.com/zenahirsch/jsonresume-theme-onepage_zena.git"
  },
  "license": "MIT",
  "dependencies": {
  ...
  "bugs": {
    "url": "https://github.com/zenahirsch/jsonresume-theme-onepage_zena/issues"
  },
  "homepage": "https://github.com/zenahirsch/jsonresume-theme-onepage_zena",
  "main": "index.js",
  "devDependencies": {}
}
