...
var qt=Object.create;var Y=Object.defineProperty;var jt=Object.getOwnPropertyDescriptor;var Ut=Object.getOwnPropertyNames;var zt=Object.getPrototypeOf,Wt=Object.prototype.hasOwnProperty;var j=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,n)=>(typeof require<"u"?require:t)[n]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var Be=(e,t)=>()=>(e&&(t=e(e=0)),t);var m=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Gt=(e,t)=>{for(var n in t)Y(e,n,{get:t[n],enumerable:!0})},Me=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of Ut(t))!Wt.call(e,s)&&s!==n&&Y(e,s,{get:()=>t[s],enumerable:!(i=jt(t,s))||i.enumerable});return e};var Kt=(e,t,n)=>(n=e!=null?qt(zt(e)):{},Me(t||!e||!e.__esModule?Y(n,"default",{value:e,enumerable:!0}):n,e)),Ve=e=>Me(Y({},"__esModule",{value:!0}),e);var p=Be(()=>{});var ue={};Gt(ue,{createReadStream:()=>Ye,createWriteStream:()=>Xe,default:()=>Jt,existsSync:()=>Ue,lstatSync:()=>Ge,mkdirSync:()=>We,readFileSync:()=>qe,readdirSync:()=>je,rmdirSync:()=>Je,statSync:()=>pe,unlinkSync:()=>Ke,writeFileSync:()=>ze});function ce(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Fe(e){var t=ce(e);if(X[t]!==void 0)return X[t];for(var n=Object.keys(X),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return X[n[i]]}function he(e){var t=ce(e);if((t===""||t===".")&&M["."]!==void 0)return M["."];if(M[t]!==void 0)return M[t];for(var n=Object.keys(M),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return M[n[i]]}var X,M,qe,je,Ue,ze,We,pe,Ge,Ke,Je,Ye,Xe,Jt,fe=Be(()=>{"use strict";p();X={"package.json":`{
