...
var vf=Object.create;var Ln=Object.defineProperty;var yf=Object.getOwnPropertyDescriptor;var bf=Object.getOwnPropertyNames;var kf=Object.getPrototypeOf,_f=Object.prototype.hasOwnProperty;var Xs=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,r)=>(typeof require<"u"?require:t)[r]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var En=(e,t)=>()=>(e&&(t=e(e=0)),t);var L=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Gr=(e,t)=>{for(var r in t)Ln(e,r,{get:t[r],enumerable:!0})},$s=(e,t,r,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let a of bf(t))!_f.call(e,a)&&a!==r&&Ln(e,a,{get:()=>t[a],enumerable:!(s=yf(t,a))||s.enumerable});return e};var wf=(e,t,r)=>(r=e!=null?vf(kf(e)):{},$s(t||!e||!e.__esModule?Ln(r,"default",{value:e,enumerable:!0}):r,e)),zr=e=>$s(Ln({},"__esModule",{value:!0}),e);var k=En(()=>{});var ha={};Gr(ha,{createReadStream:()=>ua,createWriteStream:()=>ca,default:()=>Sf,existsSync:()=>ra,lstatSync:()=>aa,mkdirSync:()=>sa,readFileSync:()=>ea,readdirSync:()=>na,rmdirSync:()=>la,statSync:()=>Zr,unlinkSync:()=>oa,writeFileSync:()=>ia});function Jr(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function ta(e){var t=Jr(e);if(An[t]!==void 0)return An[t];for(var r=Object.keys(An),s=0;s<r.length;s++)if(t.endsWith("/"+r[s])||t===r[s])return An[r[s]]}function Vr(e){var t=Jr(e);if((t===""||t===".")&&ke["."]!==void 0)return ke["."];if(ke[t]!==void 0)return ke[t];for(var r=Object.keys(ke),s=0;s<r.length;s++)if(t.endsWith("/"+r[s])||t===r[s])return ke[r[s]]}var An,ke,ea,na,ra,ia,sa,Zr,aa,oa,la,ua,ca,Sf,da=En(()=>{"use strict";k();An={"example-resume.json":`{
  "basics": {
