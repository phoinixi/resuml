var fi=Object.create;var xt=Object.defineProperty;var di=Object.getOwnPropertyDescriptor;var _i=Object.getOwnPropertyNames;var mi=Object.getPrototypeOf,gi=Object.prototype.hasOwnProperty;var ln=(e,t)=>()=>(e&&(t=e(e=0)),t);var g=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),vi=(e,t)=>{for(var n in t)xt(e,n,{get:t[n],enumerable:!0})},un=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of _i(t))!gi.call(e,i)&&i!==n&&xt(e,i,{get:()=>t[i],enumerable:!(r=di(t,i))||r.enumerable});return e};var yi=(e,t,n)=>(n=e!=null?fi(mi(e)):{},un(t||!e||!e.__esModule?xt(n,"default",{value:e,enumerable:!0}):n,e)),bi=e=>un(xt({},"__esModule",{value:!0}),e);var p=ln(()=>{});var Sn={};vi(Sn,{createReadStream:()=>yn,createWriteStream:()=>bn,default:()=>Si,existsSync:()=>fn,lstatSync:()=>mn,mkdirSync:()=>_n,readFileSync:()=>hn,readdirSync:()=>pn,rmdirSync:()=>vn,statSync:()=>fe,unlinkSync:()=>gn,writeFileSync:()=>dn});function pe(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function cn(e){var t=pe(e);if(Lt[t]!==void 0)return Lt[t];for(var n=Object.keys(Lt),r=0;r<n.length;r++)if(t.endsWith("/"+n[r])||t===n[r])return Lt[n[r]]}function he(e){var t=pe(e);if(Et[t]!==void 0)return Et[t];for(var n=Object.keys(Et),r=0;r<n.length;r++)if(t.endsWith("/"+n[r])||t===n[r])return Et[n[r]]}var Lt,Et,hn,pn,fn,dn,_n,fe,mn,gn,vn,yn,bn,Si,kn=ln(()=>{"use strict";p();Lt={"index.html":`<!doctype html>
<html>
	<head>
