var Bt=Object.create;var J=Object.defineProperty;var Vt=Object.getOwnPropertyDescriptor;var Ft=Object.getOwnPropertyNames;var jt=Object.getPrototypeOf,Ut=Object.prototype.hasOwnProperty;var F=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,i)=>(typeof require<"u"?require:t)[i]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var Te=(e,t)=>()=>(e&&(t=e(e=0)),t);var m=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),zt=(e,t)=>{for(var i in t)J(e,i,{get:t[i],enumerable:!0})},qe=(e,t,i,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of Ft(t))!Ut.call(e,s)&&s!==i&&J(e,s,{get:()=>t[s],enumerable:!(n=Vt(t,s))||n.enumerable});return e};var Wt=(e,t,i)=>(i=e!=null?Bt(jt(e)):{},qe(t||!e||!e.__esModule?J(i,"default",{value:e,enumerable:!0}):i,e)),Be=e=>qe(J({},"__esModule",{value:!0}),e);var c=Te(()=>{});var ue={};zt(ue,{createReadStream:()=>Ye,createWriteStream:()=>Xe,default:()=>Gt,existsSync:()=>Ue,lstatSync:()=>Ge,mkdirSync:()=>We,readFileSync:()=>Fe,readdirSync:()=>je,rmdirSync:()=>Je,statSync:()=>ce,unlinkSync:()=>Ke,writeFileSync:()=>ze});function pe(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ve(e){var t=pe(e);if(Y[t]!==void 0)return Y[t];for(var i=Object.keys(Y),n=0;n<i.length;n++)if(t.endsWith("/"+i[n])||t===i[n])return Y[i[n]]}function he(e){var t=pe(e);if(X[t]!==void 0)return X[t];for(var i=Object.keys(X),n=0;n<i.length;n++)if(t.endsWith("/"+i[n])||t===i[n])return X[i[n]]}var Y,X,Fe,je,Ue,ze,We,ce,Ge,Ke,Je,Ye,Xe,Gt,fe=Te(()=>{"use strict";c();Y={"package.json":`{
