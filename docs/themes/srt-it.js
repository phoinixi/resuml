var qe=Object.create;var J=Object.defineProperty;var Ve=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var Fe=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,r)=>(typeof require<"u"?require:e)[r]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Mt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Ue=(t,e)=>{for(var r in e)J(t,r,{get:e[r],enumerable:!0})},Bt=(t,e,r,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of je(e))!ze.call(t,n)&&n!==r&&J(t,n,{get:()=>e[n],enumerable:!(i=Ve(e,n))||i.enumerable});return t};var We=(t,e,r)=>(r=t!=null?qe(Fe(t)):{},Bt(e||!t||!t.__esModule?J(r,"default",{value:t,enumerable:!0}):r,t)),qt=t=>Bt(J({},"__esModule",{value:!0}),t);var p=Mt(()=>{});var ct={};Ue(ct,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>Ge,existsSync:()=>zt,lstatSync:()=>Gt,mkdirSync:()=>Wt,readFileSync:()=>jt,readdirSync:()=>Ft,rmdirSync:()=>Jt,statSync:()=>pt,unlinkSync:()=>Kt,writeFileSync:()=>Ut});function ut(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Vt(t){var e=ut(t);if(Y[e]!==void 0)return Y[e];for(var r=Object.keys(Y),i=0;i<r.length;i++)if(e.endsWith("/"+r[i])||e===r[i])return Y[r[i]]}function lt(t){var e=ut(t);if(X[e]!==void 0)return X[e];for(var r=Object.keys(X),i=0;i<r.length;i++)if(e.endsWith("/"+r[i])||e===r[i])return X[r[i]]}var Y,X,jt,Ft,zt,Ut,Wt,pt,Gt,Kt,Jt,Yt,Xt,Ge,ft=Mt(()=>{"use strict";p();Y={"index.html":`<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">\r
<html>\r
<head>\r
