...
var Ks=Object.create;var mt=Object.defineProperty;var Ys=Object.getOwnPropertyDescriptor;var js=Object.getOwnPropertyNames;var zs=Object.getPrototypeOf,Js=Object.prototype.hasOwnProperty;var gt=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var De=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Gn=(t,e)=>{for(var n in e)mt(t,n,{get:e[n],enumerable:!0})},ti=(t,e,n,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of js(e))!Js.call(t,i)&&i!==n&&mt(t,i,{get:()=>e[i],enumerable:!(r=Ys(e,i))||r.enumerable});return t};var Qs=(t,e,n)=>(n=t!=null?Ks(zs(t)):{},ti(e||!t||!t.__esModule?mt(n,"default",{value:t,enumerable:!0}):n,t)),vt=t=>ti(mt({},"__esModule",{value:!0}),t);var f=De(()=>{});var Vn={};Gn(Vn,{createReadStream:()=>li,createWriteStream:()=>ci,default:()=>Zs,existsSync:()=>ri,lstatSync:()=>oi,mkdirSync:()=>ai,readFileSync:()=>bt,readdirSync:()=>_t,rmdirSync:()=>ui,statSync:()=>Fn,unlinkSync:()=>si,writeFileSync:()=>ii});function Un(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function ni(t){var e=Un(t);if(yt[e]!==void 0)return yt[e];for(var n=Object.keys(yt),r=0;r<n.length;r++)if(e.endsWith("/"+n[r])||e===n[r])return yt[n[r]]}function Hn(t){var e=Un(t);if((e===""||e===".")&&_e["."]!==void 0)return _e["."];if(_e[e]!==void 0)return _e[e];for(var n=Object.keys(_e),r=0;r<n.length;r++)if(e.endsWith("/"+n[r])||e===n[r])return _e[n[r]]}var yt,_e,bt,_t,ri,ii,ai,Fn,oi,si,ui,li,ci,Zs,Ie=De(()=>{"use strict";f();yt={"package.json":`{
