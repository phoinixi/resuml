var Is=Object.create;var Te=Object.defineProperty;var Ns=Object.getOwnPropertyDescriptor;var qs=Object.getOwnPropertyNames;var Ts=Object.getPrototypeOf,Bs=Object.prototype.hasOwnProperty;var Be=(n,e)=>()=>(n&&(e=n(n=0)),e);var S=(n,e)=>()=>(e||n((e={exports:{}}).exports,e),e.exports),On=(n,e)=>{for(var t in e)Te(n,t,{get:e[t],enumerable:!0})},It=(n,e,t,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of qs(e))!Bs.call(n,i)&&i!==t&&Te(n,i,{get:()=>e[i],enumerable:!(r=Ns(e,i))||r.enumerable});return n};var js=(n,e,t)=>(t=n!=null?Is(Ts(n)):{},It(e||!n||!n.__esModule?Te(t,"default",{value:n,enumerable:!0}):t,n)),Rn=n=>It(Te({},"__esModule",{value:!0}),n);var g=Be(()=>{});var Kt={};On(Kt,{createReadStream:()=>Ut,createWriteStream:()=>Wt,default:()=>Fs,existsSync:()=>Bt,lstatSync:()=>Ht,mkdirSync:()=>Ft,readFileSync:()=>qt,readdirSync:()=>Tt,rmdirSync:()=>Gt,statSync:()=>zn,unlinkSync:()=>Vt,writeFileSync:()=>jt});function Dn(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Nt(n){var e=Dn(n);if(je[e]!==void 0)return je[e];for(var t=Object.keys(je),r=0;r<t.length;r++)if(e.endsWith("/"+t[r])||e===t[r])return je[t[r]]}function Mn(n){var e=Dn(n);if(Fe[e]!==void 0)return Fe[e];for(var t=Object.keys(Fe),r=0;r<t.length;r++)if(e.endsWith("/"+t[r])||e===t[r])return Fe[t[r]]}var je,Fe,qt,Tt,Bt,jt,Ft,zn,Ht,Vt,Gt,Ut,Wt,Fs,Jt=Be(()=>{"use strict";g();je={"assets/css/styles-2.css":`/*   
