var $1=Object.create;var Bo=Object.defineProperty;var j1=Object.getOwnPropertyDescriptor;var em=Object.getOwnPropertyNames;var nm=Object.getPrototypeOf,tm=Object.prototype.hasOwnProperty;var Qi=(i=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(i,{get:(u,d)=>(typeof require<"u"?require:u)[d]}):i)(function(i){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+i+'" is not supported')});var Mc=(i,u)=>()=>(i&&(u=i(i=0)),u);var Fe=(i,u)=>()=>(u||i((u={exports:{}}).exports,u),u.exports),rm=(i,u)=>{for(var d in u)Bo(i,d,{get:u[d],enumerable:!0})},Oc=(i,u,d,v)=>{if(u&&typeof u=="object"||typeof u=="function")for(let _ of em(u))!tm.call(i,_)&&_!==d&&Bo(i,_,{get:()=>u[_],enumerable:!(v=j1(u,_))||v.enumerable});return i};var im=(i,u,d)=>(d=i!=null?$1(nm(i)):{},Oc(u||!i||!i.__esModule?Bo(d,"default",{value:i,enumerable:!0}):d,i)),Tc=i=>Oc(Bo({},"__esModule",{value:!0}),i);var ne=Mc(()=>{});var Rl={};rm(Rl,{createReadStream:()=>Fc,createWriteStream:()=>Wc,default:()=>sm,existsSync:()=>Nc,lstatSync:()=>Cc,mkdirSync:()=>Rc,readFileSync:()=>Ac,readdirSync:()=>Pc,rmdirSync:()=>Yc,statSync:()=>Il,unlinkSync:()=>Lc,writeFileSync:()=>Ic});function Nl(i){return String(i).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ec(i){var u=Nl(i);if(Go[u]!==void 0)return Go[u];for(var d=Object.keys(Go),v=0;v<d.length;v++)if(u.endsWith("/"+d[v])||u===d[v])return Go[d[v]]}function Pl(i){var u=Nl(i);if(zo[u]!==void 0)return zo[u];for(var d=Object.keys(zo),v=0;v<d.length;v++)if(u.endsWith("/"+d[v])||u===d[v])return zo[d[v]]}var Go,zo,Ac,Pc,Nc,Ic,Rc,Il,Cc,Lc,Yc,Fc,Wc,sm,Cl=Mc(()=>{"use strict";ne();Go={"package.json":`{
