...
var qe=Object.create;var Y=Object.defineProperty;var Be=Object.getOwnPropertyDescriptor;var Ve=Object.getOwnPropertyNames;var Fe=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Tt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Ue=(t,e)=>{for(var n in e)Y(t,n,{get:e[n],enumerable:!0})},Mt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Ve(e))!ze.call(t,s)&&s!==n&&Y(t,s,{get:()=>e[s],enumerable:!(i=Be(e,s))||i.enumerable});return t};var We=(t,e,n)=>(n=t!=null?qe(Fe(t)):{},Mt(e||!t||!t.__esModule?Y(n,"default",{value:t,enumerable:!0}):n,t)),qt=t=>Mt(Y({},"__esModule",{value:!0}),t);var p=Tt(()=>{});var ut={};Ue(ut,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>Ge,existsSync:()=>zt,lstatSync:()=>Gt,mkdirSync:()=>Wt,readFileSync:()=>Vt,readdirSync:()=>Ft,rmdirSync:()=>Jt,statSync:()=>pt,unlinkSync:()=>Kt,writeFileSync:()=>Ut});function ct(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Bt(t){var e=ct(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}function ht(t){var e=ct(t);if((e===""||e===".")&&M["."]!==void 0)return M["."];if(M[e]!==void 0)return M[e];for(var n=Object.keys(M),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return M[n[i]]}var X,M,Vt,Ft,zt,Ut,Wt,pt,Gt,Kt,Jt,Yt,Xt,Ge,ft=Tt(()=>{"use strict";p();X={"index.html":`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
