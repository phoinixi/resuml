var Mh=Object.create;var cn=Object.defineProperty;var xh=Object.getOwnPropertyDescriptor;var Ph=Object.getOwnPropertyNames;var Dh=Object.getPrototypeOf,Oh=Object.prototype.hasOwnProperty;var us=(n=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(t,i)=>(typeof require<"u"?require:t)[i]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var wr=(n,t)=>()=>(n&&(t=n(n=0)),t);var L=(n,t)=>()=>(t||n((t={exports:{}}).exports,t),t.exports),cs=(n,t)=>{for(var i in t)cn(n,i,{get:t[i],enumerable:!0})},hs=(n,t,i,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let l of Ph(t))!Oh.call(n,l)&&l!==i&&cn(n,l,{get:()=>t[l],enumerable:!(s=xh(t,l))||s.enumerable});return n};var Ch=(n,t,i)=>(i=n!=null?Mh(Dh(n)):{},hs(t||!n||!n.__esModule?cn(i,"default",{value:n,enumerable:!0}):i,n)),ds=n=>hs(cn({},"__esModule",{value:!0}),n);var w=wr(()=>{});var Ms={};cs(Ms,{createReadStream:()=>Ss,createWriteStream:()=>bs,default:()=>Lh,existsSync:()=>gs,lstatSync:()=>ys,mkdirSync:()=>_s,readFileSync:()=>ps,readdirSync:()=>ms,rmdirSync:()=>ks,statSync:()=>br,unlinkSync:()=>ws,writeFileSync:()=>vs});function Sr(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function fs(n){var t=Sr(n);if(hn[t]!==void 0)return hn[t];for(var i=Object.keys(hn),s=0;s<i.length;s++)if(t.endsWith("/"+i[s])||t===i[s])return hn[i[s]]}function kr(n){var t=Sr(n);if(dn[t]!==void 0)return dn[t];for(var i=Object.keys(dn),s=0;s<i.length;s++)if(t.endsWith("/"+i[s])||t===i[s])return dn[i[s]]}var hn,dn,ps,ms,gs,vs,_s,br,ys,ws,ks,Ss,bs,Lh,xs=wr(()=>{"use strict";w();hn={"package.json":`{
