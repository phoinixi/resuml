...
var Qh=Object.create;var _r=Object.defineProperty;var Xh=Object.getOwnPropertyDescriptor;var $h=Object.getOwnPropertyNames;var ef=Object.getPrototypeOf,tf=Object.prototype.hasOwnProperty;var pt=(r=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(r,{get:(e,i)=>(typeof require<"u"?require:e)[i]}):r)(function(r){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+r+'" is not supported')});var Tt=(r,e)=>()=>(r&&(e=r(r=0)),e);var L=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),Rn=(r,e)=>{for(var i in e)_r(r,i,{get:e[i],enumerable:!0})},Os=(r,e,i,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let l of $h(e))!tf.call(r,l)&&l!==i&&_r(r,l,{get:()=>e[l],enumerable:!(s=Xh(e,l))||s.enumerable});return r};var rf=(r,e,i)=>(i=r!=null?Qh(ef(r)):{},Os(e||!r||!r.__esModule?_r(i,"default",{value:r,enumerable:!0}):i,r)),vr=r=>Os(_r({},"__esModule",{value:!0}),r);var y=Tt(()=>{});var Fn={};Rn(Fn,{createReadStream:()=>Is,createWriteStream:()=>Ys,default:()=>nf,existsSync:()=>Ls,lstatSync:()=>As,mkdirSync:()=>Ns,readFileSync:()=>Sr,readdirSync:()=>kr,rmdirSync:()=>Ts,statSync:()=>Yn,unlinkSync:()=>Rs,writeFileSync:()=>Es});function In(r){return String(r).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Cs(r){var e=In(r);if(yr[e]!==void 0)return yr[e];for(var i=Object.keys(yr),s=0;s<i.length;s++)if(e.endsWith("/"+i[s])||e===i[s])return yr[i[s]]}function Tn(r){var e=In(r);if((e===""||e===".")&&mt["."]!==void 0)return mt["."];if(mt[e]!==void 0)return mt[e];for(var i=Object.keys(mt),s=0;s<i.length;s++)if(e.endsWith("/"+i[s])||e===i[s])return mt[i[s]]}var yr,mt,Sr,kr,Ls,Es,Ns,Yn,As,Rs,Ts,Is,Ys,nf,It=Tt(()=>{"use strict";y();yr={"package.json":`{
