var Gt=Object.create;var Tr=Object.defineProperty;var $t=Object.getOwnPropertyDescriptor;var Qt=Object.getOwnPropertyNames;var Xt=Object.getPrototypeOf,Zt=Object.prototype.hasOwnProperty;var Re=(u,b)=>()=>(u&&(b=u(u=0)),b);var kn=(u,b)=>()=>(b||u((b={exports:{}}).exports,b),b.exports),ns=(u,b)=>{for(var S in b)Tr(u,S,{get:b[S],enumerable:!0})},Me=(u,b,S,p)=>{if(b&&typeof b=="object"||typeof b=="function")for(let E of Qt(b))!Zt.call(u,E)&&E!==S&&Tr(u,E,{get:()=>b[E],enumerable:!(p=$t(b,E))||p.enumerable});return u};var rs=(u,b,S)=>(S=u!=null?Gt(Xt(u)):{},Me(b||!u||!u.__esModule?Tr(S,"default",{value:u,enumerable:!0}):S,u)),es=u=>Me(Tr({},"__esModule",{value:!0}),u);var U=Re(()=>{});var Ke={};ns(Ke,{createReadStream:()=>Oe,createWriteStream:()=>je,default:()=>is,existsSync:()=>Ne,lstatSync:()=>ze,mkdirSync:()=>Pe,readFileSync:()=>ke,readdirSync:()=>Ae,rmdirSync:()=>qe,statSync:()=>re,unlinkSync:()=>Ue,writeFileSync:()=>Be});function ne(u){return String(u).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Le(u){var b=ne(u);if(Ir[b]!==void 0)return Ir[b];for(var S=Object.keys(Ir),p=0;p<S.length;p++)if(b.endsWith("/"+S[p])||b===S[p])return Ir[S[p]]}function Zr(u){var b=ne(u);if(Rr[b]!==void 0)return Rr[b];for(var S=Object.keys(Rr),p=0;p<S.length;p++)if(b.endsWith("/"+S[p])||b===S[p])return Rr[S[p]]}var Ir,Rr,ke,Ae,Ne,Be,Pe,re,ze,Ue,qe,Oe,je,is,Ve=Re(()=>{"use strict";U();Ir={"package.json":`{\r
