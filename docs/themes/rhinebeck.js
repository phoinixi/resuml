...
var Bt=Object.create;var Y=Object.defineProperty;var Vt=Object.getOwnPropertyDescriptor;var qt=Object.getOwnPropertyNames;var Jt=Object.getPrototypeOf,Ut=Object.prototype.hasOwnProperty;var q=(n=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(t,e)=>(typeof require<"u"?require:t)[e]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var Mn=(n,t)=>()=>(n&&(t=n(n=0)),t);var m=(n,t)=>()=>(t||n((t={exports:{}}).exports,t),t.exports),Gt=(n,t)=>{for(var e in t)Y(n,e,{get:t[e],enumerable:!0})},Fn=(n,t,e,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of qt(t))!Ut.call(n,s)&&s!==e&&Y(n,s,{get:()=>t[s],enumerable:!(i=Vt(t,s))||i.enumerable});return n};var Wt=(n,t,e)=>(e=n!=null?Bt(Jt(n)):{},Fn(t||!n||!n.__esModule?Y(e,"default",{value:n,enumerable:!0}):e,n)),Bn=n=>Fn(Y({},"__esModule",{value:!0}),n);var c=Mn(()=>{});var dn={};Gt(dn,{createReadStream:()=>Qn,createWriteStream:()=>Xn,default:()=>Kt,existsSync:()=>Un,lstatSync:()=>Kn,mkdirSync:()=>Wn,readFileSync:()=>qn,readdirSync:()=>Jn,rmdirSync:()=>Yn,statSync:()=>un,unlinkSync:()=>zn,writeFileSync:()=>Gn});function cn(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Vn(n){var t=cn(n);if(Q[t]!==void 0)return Q[t];for(var e=Object.keys(Q),i=0;i<e.length;i++)if(t.endsWith("/"+e[i])||t===e[i])return Q[e[i]]}function pn(n){var t=cn(n);if((t===""||t===".")&&M["."]!==void 0)return M["."];if(M[t]!==void 0)return M[t];for(var e=Object.keys(M),i=0;i<e.length;i++)if(t.endsWith("/"+e[i])||t===e[i])return M[e[i]]}var Q,M,qn,Jn,Un,Gn,Wn,un,Kn,zn,Yn,Qn,Xn,Kt,fn=Mn(()=>{"use strict";c();Q={"index.html":`<!doctype html>
<html>
	<head>
