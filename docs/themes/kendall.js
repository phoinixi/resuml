...
var Vg=Object.create;var Tr=Object.defineProperty;var jg=Object.getOwnPropertyDescriptor;var n0=Object.getOwnPropertyNames;var e0=Object.getPrototypeOf,t0=Object.prototype.hasOwnProperty;var Ua=(u,A)=>()=>(u&&(A=u(u=0)),A);var Ce=(u,A)=>()=>(A||u((A={exports:{}}).exports,A),A.exports),r0=(u,A)=>{for(var D in A)Tr(u,D,{get:A[D],enumerable:!0})},Pa=(u,A,D,g)=>{if(A&&typeof A=="object"||typeof A=="function")for(let T of n0(A))!t0.call(u,T)&&T!==D&&Tr(u,T,{get:()=>A[T],enumerable:!(g=jg(A,T))||g.enumerable});return u};var i0=(u,A,D)=>(D=u!=null?Vg(e0(u)):{},Pa(A||!u||!u.__esModule?Tr(D,"default",{value:u,enumerable:!0}):D,u)),u0=u=>Pa(Tr({},"__esModule",{value:!0}),u);var sn=Ua(()=>{});var $a={};r0($a,{createReadStream:()=>Ya,createWriteStream:()=>Ka,default:()=>f0,existsSync:()=>ka,lstatSync:()=>Ga,mkdirSync:()=>Ha,readFileSync:()=>Fa,readdirSync:()=>Oa,rmdirSync:()=>za,statSync:()=>eu,unlinkSync:()=>qa,writeFileSync:()=>Na});function nu(u){return String(u).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Wa(u){var A=nu(u);if(Lr[A]!==void 0)return Lr[A];for(var D=Object.keys(Lr),g=0;g<D.length;g++)if(A.endsWith("/"+D[g])||A===D[g])return Lr[D[g]]}function ji(u){var A=nu(u);if((A===""||A===".")&&dt["."]!==void 0)return dt["."];if(dt[A]!==void 0)return dt[A];for(var D=Object.keys(dt),g=0;g<D.length;g++)if(A.endsWith("/"+D[g])||A===D[g])return dt[D[g]]}var Lr,dt,Fa,Oa,ka,Na,Ha,eu,Ga,qa,za,Ya,Ka,f0,Za=Ua(()=>{"use strict";sn();Lr={"package.json":`{
