var Xi=Object.create;var Re=Object.defineProperty;var Gi=Object.getOwnPropertyDescriptor;var Ji=Object.getOwnPropertyNames;var Qi=Object.getPrototypeOf,Zi=Object.prototype.hasOwnProperty;var Mt=(l,y)=>()=>(l&&(y=l(l=0)),y);var kn=(l,y)=>()=>(y||l((y={exports:{}}).exports,y),y.exports),na=(l,y)=>{for(var D in y)Re(l,D,{get:y[D],enumerable:!0})},At=(l,y,D,d)=>{if(y&&typeof y=="object"||typeof y=="function")for(let E of Ji(y))!Zi.call(l,E)&&E!==D&&Re(l,E,{get:()=>y[E],enumerable:!(d=Gi(y,E))||d.enumerable});return l};var ea=(l,y,D)=>(D=l!=null?Xi(Qi(l)):{},At(y||!l||!l.__esModule?Re(D,"default",{value:l,enumerable:!0}):D,l)),ta=l=>At(Re({},"__esModule",{value:!0}),l);var q=Mt(()=>{});var Bt={};na(Bt,{createReadStream:()=>Wt,createWriteStream:()=>Ot,default:()=>ra,existsSync:()=>Lt,lstatSync:()=>Ut,mkdirSync:()=>Nt,readFileSync:()=>kt,readdirSync:()=>Pt,rmdirSync:()=>jt,statSync:()=>et,unlinkSync:()=>qt,writeFileSync:()=>Ft});function nt(l){return String(l).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function zt(l){var y=nt(l);if(Ie[y]!==void 0)return Ie[y];for(var D=Object.keys(Ie),d=0;d<D.length;d++)if(y.endsWith("/"+D[d])||y===D[d])return Ie[D[d]]}function Ze(l){var y=nt(l);if(Me[y]!==void 0)return Me[y];for(var D=Object.keys(Me),d=0;d<D.length;d++)if(y.endsWith("/"+D[d])||y===D[d])return Me[D[d]]}var Ie,Me,kt,Pt,Lt,Ft,Nt,et,Ut,qt,jt,Wt,Ot,ra,Kt=Mt(()=>{"use strict";q();Ie={"package.json":`{
