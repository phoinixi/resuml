var Fn=Object.create;var J=Object.defineProperty;var jn=Object.getOwnPropertyDescriptor;var zn=Object.getOwnPropertyNames;var Wn=Object.getPrototypeOf,Un=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(n,e)=>(typeof require<"u"?require:n)[e]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Bt=(t,n)=>()=>(t&&(n=t(t=0)),n);var g=(t,n)=>()=>(n||t((n={exports:{}}).exports,n),n.exports),Gn=(t,n)=>{for(var e in n)J(t,e,{get:n[e],enumerable:!0})},qt=(t,n,e,i)=>{if(n&&typeof n=="object"||typeof n=="function")for(let s of zn(n))!Un.call(t,s)&&s!==e&&J(t,s,{get:()=>n[s],enumerable:!(i=jn(n,s))||i.enumerable});return t};var Kn=(t,n,e)=>(e=t!=null?Fn(Wn(t)):{},qt(n||!t||!t.__esModule?J(e,"default",{value:t,enumerable:!0}):e,t)),Ft=t=>qt(J({},"__esModule",{value:!0}),t);var p=Bt(()=>{});var ft={};Gn(ft,{createReadStream:()=>Xt,createWriteStream:()=>Qt,default:()=>Jn,existsSync:()=>Ut,lstatSync:()=>Jt,mkdirSync:()=>Kt,readFileSync:()=>zt,readdirSync:()=>Wt,rmdirSync:()=>Zt,statSync:()=>ut,unlinkSync:()=>Yt,writeFileSync:()=>Gt});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function jt(t){var n=pt(t);if(Y[n]!==void 0)return Y[n];for(var e=Object.keys(Y),i=0;i<e.length;i++)if(n.endsWith("/"+e[i])||n===e[i])return Y[e[i]]}function ct(t){var n=pt(t);if(Z[n]!==void 0)return Z[n];for(var e=Object.keys(Z),i=0;i<e.length;i++)if(n.endsWith("/"+e[i])||n===e[i])return Z[e[i]]}var Y,Z,zt,Wt,Ut,Gt,Kt,ut,Jt,Yt,Zt,Xt,Qt,Jn,dt=Bt(()=>{"use strict";p();Y={"css/print.css":`
body, html {
