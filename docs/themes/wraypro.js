...
var je=Object.create;var Y=Object.defineProperty;var Fe=Object.getOwnPropertyDescriptor;var We=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var F=(n=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(e,i)=>(typeof require<"u"?require:e)[i]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var qn=(n,e)=>()=>(n&&(e=n(n=0)),e);var f=(n,e)=>()=>(e||n((e={exports:{}}).exports,e),e.exports),Ge=(n,e)=>{for(var i in e)Y(n,i,{get:e[i],enumerable:!0})},Bn=(n,e,i,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let t of We(e))!Ue.call(n,t)&&t!==i&&Y(n,t,{get:()=>e[t],enumerable:!(s=Fe(e,t))||s.enumerable});return n};var Je=(n,e,i)=>(i=n!=null?je(ze(n)):{},Bn(e||!n||!n.__esModule?Y(i,"default",{value:n,enumerable:!0}):i,n)),Vn=n=>Bn(Y({},"__esModule",{value:!0}),n);var u=qn(()=>{});var dn={};Ge(dn,{createReadStream:()=>Xn,createWriteStream:()=>Zn,default:()=>Ke,existsSync:()=>zn,lstatSync:()=>Jn,mkdirSync:()=>Gn,readFileSync:()=>Fn,readdirSync:()=>Wn,rmdirSync:()=>Yn,statSync:()=>pn,unlinkSync:()=>Kn,writeFileSync:()=>Un});function un(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function jn(n){var e=un(n);if(X[e]!==void 0)return X[e];for(var i=Object.keys(X),s=0;s<i.length;s++)if(e.endsWith("/"+i[s])||e===i[s])return X[i[s]]}function hn(n){var e=un(n);if((e===""||e===".")&&q["."]!==void 0)return q["."];if(q[e]!==void 0)return q[e];for(var i=Object.keys(q),s=0;s<i.length;s++)if(e.endsWith("/"+i[s])||e===i[s])return q[i[s]]}var X,q,Fn,Wn,zn,Un,Gn,pn,Jn,Kn,Yn,Xn,Zn,Ke,mn=qn(()=>{"use strict";u();X={"package.json":`{
