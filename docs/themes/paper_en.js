...
var Be=Object.create;var Y=Object.defineProperty;var je=Object.getOwnPropertyDescriptor;var Fe=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Vt=(t,e)=>()=>(t&&(e=t(t=0)),e);var g=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)Y(t,n,{get:e[n],enumerable:!0})},Bt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Fe(e))!Ue.call(t,r)&&r!==n&&Y(t,r,{get:()=>e[r],enumerable:!(i=je(e,r))||i.enumerable});return t};var Ge=(t,e,n)=>(n=t!=null?Be(ze(t)):{},Bt(e||!t||!t.__esModule?Y(n,"default",{value:t,enumerable:!0}):n,t)),jt=t=>Bt(Y({},"__esModule",{value:!0}),t);var p=Vt(()=>{});var ft={};We(ft,{createReadStream:()=>Zt,createWriteStream:()=>Qt,default:()=>Ke,existsSync:()=>Wt,lstatSync:()=>Jt,mkdirSync:()=>Kt,readFileSync:()=>zt,readdirSync:()=>Ut,rmdirSync:()=>Xt,statSync:()=>ut,unlinkSync:()=>Yt,writeFileSync:()=>Gt});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ft(t){var e=pt(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}function ct(t){var e=pt(t);if((e===""||e===".")&&q["."]!==void 0)return q["."];if(q[e]!==void 0)return q[e];for(var n=Object.keys(q),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return q[n[i]]}var X,q,zt,Ut,Wt,Gt,Kt,ut,Jt,Yt,Xt,Zt,Qt,Ke,dt=Vt(()=>{"use strict";p();X={"css/print.css":`
body, html {
...
{{#if $first}}
\r
196 - <p class="heading" style="margin-top:2.35em;">{{institution}}</p>
   --->1.35\r
{{else}}\r
\r
\r
...
{{#if $first}}
<p style="margin-top:2.4em;">     --->1.0\r
\r
<p>{{publisher}}</p>
\r
{{/if}}\r
...
\r
`,"package.json":`{
  "name": "jsonresume-theme-paper_en",
  "version": "0.1.15",
  "description": "A theme for JSON Resume",
  "author": {
    "name": "Tim Daubensch\xFCtz"
  },
  "repository": {
    "type": "git",
					...
					{{#if resume.education.length}}
				        ...
				        <div class="row">
				          ...
				          <div class="content-text work-listing education-listing">
										{{#if institution}}
											{{#if $first}}
						            <p class="heading" style="margin-top:1.35em;">{{institution}}</p>
						            {{else}}
				            	...
				            	{{/if}}
				            		...
				            		<p class="highlight"> 
									    Award\uFF1A	
										{{#if award}}
									    <strong>{{award}}</strong> Awarded by <strong>{{awardPublisher}}</strong>
				            		 </p>
									 {{/if}}
				            	         {{/if}}
				          </div>
				          ...
				          <div class="content-cat big-text">
				            {{#if $first}}
				            	...
				            	<p>{{publisher}}</p>
										...
										{{#if date}}
				            	<p style="margin-top:0.1em;">{{date}}</p>
										{{/if}}
