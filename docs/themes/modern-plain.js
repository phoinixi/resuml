var Mi=Object.create;var Le=Object.defineProperty;var Ai=Object.getOwnPropertyDescriptor;var Oi=Object.getOwnPropertyNames;var Ii=Object.getPrototypeOf,Ni=Object.prototype.hasOwnProperty;var dt=(t,e)=>()=>(t&&(e=t(t=0)),e);var v=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),fn=(t,e)=>{for(var n in e)Le(t,n,{get:e[n],enumerable:!0})},dn=(t,e,n,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Oi(e))!Ni.call(t,i)&&i!==n&&Le(t,i,{get:()=>e[i],enumerable:!(r=Ai(e,i))||r.enumerable});return t};var Ri=(t,e,n)=>(n=t!=null?Mi(Ii(t)):{},dn(e||!t||!t.__esModule?Le(n,"default",{value:t,enumerable:!0}):n,t)),mn=t=>dn(Le({},"__esModule",{value:!0}),t);var p=dt(()=>{});var Ln={};fn(Ln,{createReadStream:()=>Cn,createWriteStream:()=>Pn,default:()=>Di,existsSync:()=>yn,lstatSync:()=>kn,mkdirSync:()=>Sn,readFileSync:()=>vn,readdirSync:()=>_n,rmdirSync:()=>xn,statSync:()=>vt,unlinkSync:()=>wn,writeFileSync:()=>bn});function gt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function gn(t){var e=gt(t);if(Ee[e]!==void 0)return Ee[e];for(var n=Object.keys(Ee),r=0;r<n.length;r++)if(e.endsWith("/"+n[r])||e===n[r])return Ee[n[r]]}function mt(t){var e=gt(t);if(Me[e]!==void 0)return Me[e];for(var n=Object.keys(Me),r=0;r<n.length;r++)if(e.endsWith("/"+n[r])||e===n[r])return Me[n[r]]}var Ee,Me,vn,_n,yn,bn,Sn,vt,kn,wn,xn,Cn,Pn,Di,En=dt(()=>{"use strict";p();Ee={"package.json":`{
