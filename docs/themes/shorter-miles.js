var uh=Object.create;var un=Object.defineProperty;var ch=Object.getOwnPropertyDescriptor;var hh=Object.getOwnPropertyNames;var fh=Object.getPrototypeOf,dh=Object.prototype.hasOwnProperty;var is=(n=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(t,i)=>(typeof require<"u"?require:t)[i]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var ss=(n,t)=>()=>(n&&(t=n(n=0)),t);var L=(n,t)=>()=>(t||n((t={exports:{}}).exports,t),t.exports),ph=(n,t)=>{for(var i in t)un(n,i,{get:t[i],enumerable:!0})},as=(n,t,i,a)=>{if(t&&typeof t=="object"||typeof t=="function")for(let l of hh(t))!dh.call(n,l)&&l!==i&&un(n,l,{get:()=>t[l],enumerable:!(a=ch(t,l))||a.enumerable});return n};var mh=(n,t,i)=>(i=n!=null?uh(fh(n)):{},as(t||!n||!n.__esModule?un(i,"default",{value:n,enumerable:!0}):i,n)),gh=n=>as(un({},"__esModule",{value:!0}),n);var k=ss(()=>{});var vs={};ph(vs,{createReadStream:()=>gs,createWriteStream:()=>_s,default:()=>_h,existsSync:()=>cs,lstatSync:()=>ds,mkdirSync:()=>fs,readFileSync:()=>ls,readdirSync:()=>us,rmdirSync:()=>ms,statSync:()=>vr,unlinkSync:()=>ps,writeFileSync:()=>hs});function _r(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function os(n){var t=_r(n);if(cn[t]!==void 0)return cn[t];for(var i=Object.keys(cn),a=0;a<i.length;a++)if(t.endsWith("/"+i[a])||t===i[a])return cn[i[a]]}function gr(n){var t=_r(n);if(hn[t]!==void 0)return hn[t];for(var i=Object.keys(hn),a=0;a<i.length;a++)if(t.endsWith("/"+i[a])||t===i[a])return hn[i[a]]}var cn,hn,ls,us,cs,hs,fs,vr,ds,ps,ms,gs,_s,_h,ys=ss(()=>{"use strict";k();cn={"package.json":`{
