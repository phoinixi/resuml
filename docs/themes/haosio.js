...
var tn=Object.create;var Y=Object.defineProperty;var en=Object.getOwnPropertyDescriptor;var nn=Object.getOwnPropertyNames;var sn=Object.getPrototypeOf,rn=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var pt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Wt=(t,e)=>{for(var n in e)Y(t,n,{get:e[n],enumerable:!0})},Ut=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of nn(e))!rn.call(t,s)&&s!==n&&Y(t,s,{get:()=>e[s],enumerable:!(i=en(e,s))||i.enumerable});return t};var an=(t,e,n)=>(n=t!=null?tn(sn(t)):{},Ut(e||!t||!t.__esModule?Y(n,"default",{value:t,enumerable:!0}):n,t)),ft=t=>Ut(Y({},"__esModule",{value:!0}),t);var u=pt(()=>{});var vt={};Wt(vt,{createReadStream:()=>te,createWriteStream:()=>ee,default:()=>on,existsSync:()=>Jt,lstatSync:()=>Qt,mkdirSync:()=>Xt,readFileSync:()=>zt,readdirSync:()=>Kt,rmdirSync:()=>$t,statSync:()=>gt,unlinkSync:()=>Zt,writeFileSync:()=>Yt});function mt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Gt(t){var e=mt(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}function dt(t){var e=mt(t);if((e===""||e===".")&&q["."]!==void 0)return q["."];if(q[e]!==void 0)return q[e];for(var n=Object.keys(q),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return q[n[i]]}var X,q,zt,Kt,Jt,Yt,Xt,gt,Qt,Zt,$t,te,ee,on,kt=pt(()=>{"use strict";u();X={"package.json":`{
