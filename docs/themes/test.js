var ti=Object.create;var J=Object.defineProperty;var ei=Object.getOwnPropertyDescriptor;var ii=Object.getOwnPropertyNames;var ni=Object.getPrototypeOf,si=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,i)=>(typeof require<"u"?require:e)[i]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var pt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Ut=(t,e)=>{for(var i in e)J(t,i,{get:e[i],enumerable:!0})},Wt=(t,e,i,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of ii(e))!si.call(t,s)&&s!==i&&J(t,s,{get:()=>e[s],enumerable:!(n=ei(e,s))||n.enumerable});return t};var ri=(t,e,i)=>(i=t!=null?ti(ni(t)):{},Wt(e||!t||!t.__esModule?J(i,"default",{value:t,enumerable:!0}):i,t)),ft=t=>Wt(J({},"__esModule",{value:!0}),t);var c=pt(()=>{});var vt={};Ut(vt,{createReadStream:()=>te,createWriteStream:()=>ee,default:()=>ai,existsSync:()=>Jt,lstatSync:()=>Zt,mkdirSync:()=>Xt,readFileSync:()=>zt,readdirSync:()=>Kt,rmdirSync:()=>$t,statSync:()=>gt,unlinkSync:()=>Qt,writeFileSync:()=>Yt});function mt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Gt(t){var e=mt(t);if(Y[e]!==void 0)return Y[e];for(var i=Object.keys(Y),n=0;n<i.length;n++)if(e.endsWith("/"+i[n])||e===i[n])return Y[i[n]]}function dt(t){var e=mt(t);if(X[e]!==void 0)return X[e];for(var i=Object.keys(X),n=0;n<i.length;n++)if(e.endsWith("/"+i[n])||e===i[n])return X[i[n]]}var Y,X,zt,Kt,Jt,Yt,Xt,gt,Zt,Qt,$t,te,ee,ai,kt=pt(()=>{"use strict";c();Y={"package.json":`{
  "name": "jsonresume-theme-test",
  "version": "0.1.3",
