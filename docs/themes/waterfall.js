var B=Object.create;var u=Object.defineProperty;var J=Object.getOwnPropertyDescriptor;var H=Object.getOwnPropertyNames;var q=Object.getPrototypeOf,Q=Object.prototype.hasOwnProperty;var w=(e,n)=>()=>(e&&(n=e(e=0)),n);var U=(e,n)=>()=>(n||e((n={exports:{}}).exports,n),n.exports),K=(e,n)=>{for(var i in n)u(e,i,{get:n[i],enumerable:!0})},S=(e,n,i,r)=>{if(n&&typeof n=="object"||typeof n=="function")for(let a of H(n))!Q.call(e,a)&&a!==i&&u(e,a,{get:()=>n[a],enumerable:!(r=J(n,a))||r.enumerable});return e};var V=(e,n,i)=>(i=e!=null?B(q(e)):{},S(n||!e||!e.__esModule?u(i,"default",{value:e,enumerable:!0}):i,e)),X=e=>S(u({},"__esModule",{value:!0}),e);var p=w(()=>{});var R={};K(R,{createReadStream:()=>M,createWriteStream:()=>O,default:()=>Y,existsSync:()=>A,lstatSync:()=>z,mkdirSync:()=>I,readFileSync:()=>j,readdirSync:()=>_,rmdirSync:()=>N,statSync:()=>x,unlinkSync:()=>C,writeFileSync:()=>E});function y(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function D(e){var n=y(e);if(h[n]!==void 0)return h[n];for(var i=Object.keys(h),r=0;r<i.length;r++)if(n.endsWith("/"+i[r])||n===i[r])return h[i[r]]}function g(e){var n=y(e);if(f[n]!==void 0)return f[n];for(var i=Object.keys(f),r=0;r<i.length;r++)if(n.endsWith("/"+i[r])||n===i[r])return f[i[r]]}var h,f,j,_,A,E,I,x,z,C,N,M,O,Y,G=w(()=>{"use strict";p();h={"index.css":`@import url('https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Inter&display=swap');
