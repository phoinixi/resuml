var Ve=Object.create;var K=Object.defineProperty;var Fe=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Bt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)K(t,n,{get:e[n],enumerable:!0})},qt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of je(e))!Ue.call(t,s)&&s!==n&&K(t,s,{get:()=>e[s],enumerable:!(i=Fe(e,s))||i.enumerable});return t};var Je=(t,e,n)=>(n=t!=null?Ve(ze(t)):{},qt(e||!t||!t.__esModule?K(n,"default",{value:t,enumerable:!0}):n,t)),Vt=t=>qt(K({},"__esModule",{value:!0}),t);var p=Bt(()=>{});var ft={};We(ft,{createReadStream:()=>Yt,createWriteStream:()=>Qt,default:()=>Ge,existsSync:()=>Ut,lstatSync:()=>Gt,mkdirSync:()=>Jt,readFileSync:()=>jt,readdirSync:()=>zt,rmdirSync:()=>Xt,statSync:()=>ut,unlinkSync:()=>Kt,writeFileSync:()=>Wt});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ft(t){var e=pt(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}function ct(t){var e=pt(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}var X,Y,jt,zt,Ut,Wt,Jt,ut,Gt,Kt,Xt,Yt,Qt,Ge,dt=Bt(()=>{"use strict";p();X={"package.json":`{
