...
var Ve=Object.create;var X=Object.defineProperty;var Fe=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Bt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)X(t,n,{get:e[n],enumerable:!0})},qt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of je(e))!Ue.call(t,s)&&s!==n&&X(t,s,{get:()=>e[s],enumerable:!(i=Fe(e,s))||i.enumerable});return t};var Je=(t,e,n)=>(n=t!=null?Ve(ze(t)):{},qt(e||!t||!t.__esModule?X(n,"default",{value:t,enumerable:!0}):n,t)),Vt=t=>qt(X({},"__esModule",{value:!0}),t);var p=Bt(()=>{});var ft={};We(ft,{createReadStream:()=>Yt,createWriteStream:()=>Qt,default:()=>Ge,existsSync:()=>Ut,lstatSync:()=>Gt,mkdirSync:()=>Jt,readFileSync:()=>jt,readdirSync:()=>zt,rmdirSync:()=>Xt,statSync:()=>ut,unlinkSync:()=>Kt,writeFileSync:()=>Wt});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ft(t){var e=pt(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}function ct(t){var e=pt(t);if((e===""||e===".")&&B["."]!==void 0)return B["."];if(B[e]!==void 0)return B[e];for(var n=Object.keys(B),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return B[n[i]]}var Y,B,jt,zt,Ut,Wt,Jt,ut,Gt,Kt,Xt,Yt,Qt,Ge,dt=Bt(()=>{"use strict";p();Y={"package.json":`{
  "name": "jsonresume-theme-short-nderkach",
  "version": "0.1.9",
  "description": "Simple to the point theme for JSON Resume",
  "author": "Nikolay Derkach",
  "repository": {
    "type": "git",
    "url": "https://github.com/nderkach/jsonresume-theme-short-nderkach"
  },
  "license": "MIT",
  "dependencies": {
...
#education .item {
	...
	<section class="heading">
		<header>
			<h1>Nikolay Derkach</h1>
			<div class="contact">
				<span class="detail">
					<a href="mailto:nikolay@derka.ch">nikolay@derka.ch</a>
				</span>
				<span class="detail">
					(415) 939-8626
				</span>
				<span class="detail">
					<a href="https://derka.ch">https://derka.ch</a>
				</span>
			</div>
		</header>


		<p><p>Nikolay is a product-focused iOS expert with a background in security. He has worked extensively on building iOS apps, helping clients with product strategy, and advising on UX design. His passion is to work with startups to help them bring the first iteration of their product to the market.</p></p>
			...
			<div class="profile">
				...
				<span class="username">
					<a href="https://www.linkedin.com/in/nderk">nderk</a>
				</span>
			</div>
			<div class="profile">
				<span class="network">
				...
				<span class="username">
					<a href="https://github.com/nderkach">nderkach</a>
				</span>
			</div>
			<div class="profile">
				<span class="network">
				...
				<span class="username">
					<a href="https://medium.com/@nderkach">@nderkach</a>
				</span>
			</div>
...
<!-- 	
	...
	<section class="experience">
		...
		<section class="item">
			...
			<ul class="highlights">
				<li>Worked on MVP for an enterprise end-to-end communication software leading product development and engineering for iOS</li>
				<li>Developed a product management process in collaboration with designers and developers</li>
				<li>Consulted designers on UX and Apple HIG best practices</li>
				<li>Implemented encrypted chat protocols using a modified Signal protocol (Double Ratchet Algorithm and Diffie-Hellman key exchange with post-quantum cyphers)</li>
				<li>Technologies: Swift, Objective-C, Cocoa Touch, XCTest, Qt/C++, End-to-end Encryption, Signal, Realm, Xcode, Xcode Server</li>
			</ul>
		</section>
		<section class="item">
			<span class="position">
			...
			<ul class="highlights">
				<li>Made key decisions in screening hundreds of highly-skilled software developers from all over the world through a three-step screening process (online timed algorithmic test, live coding interview, and test project review)</li>
				<li>Helped develop algorithmic challenges used to test potential candidates</li>
		...
		<section class="item">
			...
			<ul class="highlights">
				<li>Worked on the project as a solo engineer full-stack (Swift+Objective-C and Node.js on the backend)</li>
				<li>Took over the existing legacy code base and almost completely revamped the front-end, as well as added new features to the backend</li>
				<li>Technologies: Node.js, iOS, Swift, Objective-C, MapKit, MongoDB, PubNub, Keystone.js</li>
			</ul>
		</section>
		<section class="item">
			<span class="position">
			...
			<ul class="highlights">
				<li>Successfully reverse-engineered and created scripts to automatically solve CAPTCHAs, bypass bot detection and fingerprinting by major e-commerce sites</li>
				<li>Built a cluster of jailbroken iPhone device to automatically intercept and decrypt APNS messages, and serve security tokens via an API</li>
				<li>Technologies: Reverse-engineering, Python, Flask, iOS System Internals, Jailbreak, React.js</li>
			</ul>
		</section>
	</section>
	...
	<section id="education">
		...
		<div class="item">
			<header>
					<h3 class="name">Bauman Moscow State University</h3>
			</header>
