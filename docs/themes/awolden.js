var Be=Object.create;var J=Object.defineProperty;var Fe=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Mt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)J(t,n,{get:e[n],enumerable:!0})},qt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of je(e))!Ue.call(t,s)&&s!==n&&J(t,s,{get:()=>e[s],enumerable:!(i=Fe(e,s))||i.enumerable});return t};var Ge=(t,e,n)=>(n=t!=null?Be(ze(t)):{},qt(e||!t||!t.__esModule?J(n,"default",{value:t,enumerable:!0}):n,t)),Vt=t=>qt(J({},"__esModule",{value:!0}),t);var p=Mt(()=>{});var ut={};We(ut,{createReadStream:()=>Yt,createWriteStream:()=>Xt,default:()=>Ke,existsSync:()=>zt,lstatSync:()=>Gt,mkdirSync:()=>Wt,readFileSync:()=>Ft,readdirSync:()=>jt,rmdirSync:()=>Jt,statSync:()=>pt,unlinkSync:()=>Kt,writeFileSync:()=>Ut});function ct(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Bt(t){var e=ct(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}function lt(t){var e=ct(t);if(X[e]!==void 0)return X[e];for(var n=Object.keys(X),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return X[n[i]]}var Y,X,Ft,jt,zt,Ut,Wt,pt,Gt,Kt,Jt,Yt,Xt,Ke,ft=Mt(()=>{"use strict";p();Y={"package.json":`{
  "name": "jsonresume-theme-awolden",
  "version": "0.3.10",
  "description": "A theme for JSON Resume based off of http://github.com/erming/jsonresume-theme-flat",
  "author": "Alex Wolden",
  "repository": {
    "type": "git",
    "url": "http://github.com/awolden/jsonresume-theme-awolden"
  },
  "scripts": {
    "start": "resume serve"
  },
...
`,"style.css":`@import url(https://fonts.googleapis.com/css?family=Lato:400,700
);
body {
    background: #fff;
