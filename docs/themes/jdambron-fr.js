...
`,"theme/partials/awards.hbs":`{{#if resume.awards.length}}
  <section class="section">
    <header>
      <h2 class="section-title">R\xE9compenses <span class="item-count">({{resume.awards.length}})</span></h2>
    </header>
    <section id="awards">
      {{#each resume.awards}}
...
`,"theme/partials/basics.hbs":`{{#resume.basics}}
    ...
    <header>
      <h2 class="section-title">R\xE9sum\xE9</h2>
    </header>
...
`,"theme/partials/date.hbs":`{{#if startDate}}
  <div class="date">
    ...
    {{else}}
      <span class="endDate">- Actuellement</span>
    {{/if}}
  </div>
{{/if}}
...
<section class="section">\r
  <header>\r
    <h2 class='section-title'>Langues <span class="item-count">({{resume.languages.length}})</span></h2>\r
  </header>\r
...
<section class="section">
  <header>
    <h2 class='section-title'>Volontariat</h2>
  </header>
