var Kr=Object.create;var He=Object.defineProperty;var Zr=Object.getOwnPropertyDescriptor;var Qr=Object.getOwnPropertyNames;var Yr=Object.getPrototypeOf,Xr=Object.prototype.hasOwnProperty;var Pt=(n,e)=>()=>(n&&(e=n(n=0)),e);var w=(n,e)=>()=>(e||n((e={exports:{}}).exports,e),e.exports),$r=(n,e)=>{for(var i in e)He(n,i,{get:e[i],enumerable:!0})},Ft=(n,e,i,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Qr(e))!Xr.call(n,r)&&r!==i&&He(n,r,{get:()=>e[r],enumerable:!(t=Zr(e,r))||t.enumerable});return n};var es=(n,e,i)=>(i=n!=null?Kr(Yr(n)):{},Ft(e||!n||!n.__esModule?He(i,"default",{value:n,enumerable:!0}):i,n)),ns=n=>Ft(He({},"__esModule",{value:!0}),n);var m=Pt(()=>{});var Gt={};$r(Gt,{createReadStream:()=>zt,createWriteStream:()=>qt,default:()=>ts,existsSync:()=>Lt,lstatSync:()=>Rt,mkdirSync:()=>Tt,readFileSync:()=>It,readdirSync:()=>Mt,rmdirSync:()=>Ht,statSync:()=>Bn,unlinkSync:()=>Nt,writeFileSync:()=>Ot});function Fn(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Bt(n){var e=Fn(n);if(ze[e]!==void 0)return ze[e];for(var i=Object.keys(ze),t=0;t<i.length;t++)if(e.endsWith("/"+i[t])||e===i[t])return ze[i[t]]}function Pn(n){var e=Fn(n);if(qe[e]!==void 0)return qe[e];for(var i=Object.keys(qe),t=0;t<i.length;t++)if(e.endsWith("/"+i[t])||e===i[t])return qe[i[t]]}var ze,qe,It,Mt,Lt,Ot,Tt,Bn,Rt,Nt,Ht,zt,qt,ts,Ut=Pt(()=>{"use strict";m();ze={"index.html":`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
