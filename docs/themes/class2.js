var je=Object.create;var K=Object.defineProperty;var ze=Object.getOwnPropertyDescriptor;var Ue=Object.getOwnPropertyNames;var We=Object.getPrototypeOf,Ge=Object.prototype.hasOwnProperty;var V=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,r)=>(typeof require<"u"?require:e)[r]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var qt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Je=(t,e)=>{for(var r in e)K(t,r,{get:e[r],enumerable:!0})},Bt=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Ue(e))!Ge.call(t,i)&&i!==r&&K(t,i,{get:()=>e[i],enumerable:!(n=ze(e,i))||n.enumerable});return t};var Ke=(t,e,r)=>(r=t!=null?je(We(t)):{},Bt(e||!t||!t.__esModule?K(r,"default",{value:t,enumerable:!0}):r,t)),Ft=t=>Bt(K({},"__esModule",{value:!0}),t);var c=qt(()=>{});var pt={};Je(pt,{createReadStream:()=>Xt,createWriteStream:()=>Qt,default:()=>Ye,existsSync:()=>Ut,lstatSync:()=>Jt,mkdirSync:()=>Gt,readFileSync:()=>jt,readdirSync:()=>zt,rmdirSync:()=>Yt,statSync:()=>ct,unlinkSync:()=>Kt,writeFileSync:()=>Wt});function ut(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Vt(t){var e=ut(t);if(Y[e]!==void 0)return Y[e];for(var r=Object.keys(Y),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return Y[r[n]]}function lt(t){var e=ut(t);if(X[e]!==void 0)return X[e];for(var r=Object.keys(X),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return X[r[n]]}var Y,X,jt,zt,Ut,Wt,Gt,ct,Jt,Kt,Yt,Xt,Qt,Ye,ft=qt(()=>{"use strict";c();Y={"package.json":`{\r
