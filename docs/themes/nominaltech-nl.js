var Ji=Object.create;var bn=Object.defineProperty;var Vi=Object.getOwnPropertyDescriptor;var Qi=Object.getOwnPropertyNames;var Xi=Object.getPrototypeOf,Zi=Object.prototype.hasOwnProperty;var Oe=(p,m)=>()=>(p&&(m=p(p=0)),m);var Dt=(p,m)=>()=>(m||p((m={exports:{}}).exports,m),m.exports),ki=(p,m)=>{for(var S in m)bn(p,S,{get:m[S],enumerable:!0})},Ee=(p,m,S,T)=>{if(m&&typeof m=="object"||typeof m=="function")for(let _ of Qi(m))!Zi.call(p,_)&&_!==S&&bn(p,_,{get:()=>m[_],enumerable:!(T=Vi(m,_))||T.enumerable});return p};var tu=(p,m,S)=>(S=p!=null?Ji(Xi(p)):{},Ee(m||!p||!p.__esModule?bn(S,"default",{value:p,enumerable:!0}):S,p)),nu=p=>Ee(bn({},"__esModule",{value:!0}),p);var z=Oe(()=>{});var qe={};ki(qe,{createReadStream:()=>Pe,createWriteStream:()=>Le,default:()=>eu,existsSync:()=>je,lstatSync:()=>Fe,mkdirSync:()=>Ue,readFileSync:()=>De,readdirSync:()=>Te,rmdirSync:()=>Ne,statSync:()=>Vn,unlinkSync:()=>Me,writeFileSync:()=>Ie});function Jn(p){return String(p).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Se(p){var m=Jn(p);if(xn[m]!==void 0)return xn[m];for(var S=Object.keys(xn),T=0;T<S.length;T++)if(m.endsWith("/"+S[T])||m===S[T])return xn[S[T]]}function Gn(p){var m=Jn(p);if(Rn[m]!==void 0)return Rn[m];for(var S=Object.keys(Rn),T=0;T<S.length;T++)if(m.endsWith("/"+S[T])||m===S[T])return Rn[S[T]]}var xn,Rn,De,Te,je,Ie,Ue,Vn,Fe,Me,Ne,Pe,Le,eu,ze=Oe(()=>{"use strict";z();xn={"package.json":`{
