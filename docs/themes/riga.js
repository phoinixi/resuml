...
var zt=Object.create;var q=Object.defineProperty;var Lt=Object.getOwnPropertyDescriptor;var jt=Object.getOwnPropertyNames;var vt=Object.getPrototypeOf,bt=Object.prototype.hasOwnProperty;var v=(A=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(A,{get:(t,B)=>(typeof require<"u"?require:t)[B]}):A)(function(A){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+A+'" is not supported')});var PA=(A,t)=>()=>(A&&(t=A(A=0)),t);var C=(A,t)=>()=>(t||A((t={exports:{}}).exports,t),t.exports),Kt=(A,t)=>{for(var B in t)q(A,B,{get:t[B],enumerable:!0})},OA=(A,t,B,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let g of jt(t))!bt.call(A,g)&&g!==B&&q(A,g,{get:()=>t[g],enumerable:!(n=Lt(t,g))||n.enumerable});return A};var Xt=(A,t,B)=>(B=A!=null?zt(vt(A)):{},OA(t||!A||!A.__esModule?q(B,"default",{value:A,enumerable:!0}):B,A)),zA=A=>OA(q({},"__esModule",{value:!0}),A);var o=PA(()=>{});var hA={};Kt(hA,{createReadStream:()=>qA,createWriteStream:()=>_A,default:()=>Vt,existsSync:()=>bA,lstatSync:()=>VA,mkdirSync:()=>XA,readFileSync:()=>jA,readdirSync:()=>vA,rmdirSync:()=>ZA,statSync:()=>aA,unlinkSync:()=>WA,writeFileSync:()=>KA});function oA(A){return String(A).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function LA(A){var t=oA(A);if(_[t]!==void 0)return _[t];for(var B=Object.keys(_),n=0;n<B.length;n++)if(t.endsWith("/"+B[n])||t===B[n])return _[B[n]]}function QA(A){var t=oA(A);if((t===""||t===".")&&O["."]!==void 0)return O["."];if(O[t]!==void 0)return O[t];for(var B=Object.keys(O),n=0;n<B.length;n++)if(t.endsWith("/"+B[n])||t===B[n])return O[B[n]]}var _,O,jA,vA,bA,KA,XA,aA,VA,WA,ZA,qA,_A,Vt,wA=PA(()=>{"use strict";o();_={"package.json":`{
