...
var Be=Object.create;var X=Object.defineProperty;var Fe=Object.getOwnPropertyDescriptor;var Ve=Object.getOwnPropertyNames;var je=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Mt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)X(t,n,{get:e[n],enumerable:!0})},qt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Ve(e))!Ue.call(t,s)&&s!==n&&X(t,s,{get:()=>e[s],enumerable:!(i=Fe(e,s))||i.enumerable});return t};var Ge=(t,e,n)=>(n=t!=null?Be(je(t)):{},qt(e||!t||!t.__esModule?X(n,"default",{value:t,enumerable:!0}):n,t)),Bt=t=>qt(X({},"__esModule",{value:!0}),t);var p=Mt(()=>{});var ut={};We(ut,{createReadStream:()=>Xt,createWriteStream:()=>Yt,default:()=>Ke,existsSync:()=>Ut,lstatSync:()=>Kt,mkdirSync:()=>Gt,readFileSync:()=>Vt,readdirSync:()=>jt,rmdirSync:()=>Jt,statSync:()=>pt,unlinkSync:()=>zt,writeFileSync:()=>Wt});function ct(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Ft(t){var e=ct(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}function ht(t){var e=ct(t);if((e===""||e===".")&&q["."]!==void 0)return q["."];if(q[e]!==void 0)return q[e];for(var n=Object.keys(q),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return q[n[i]]}var Y,q,Vt,jt,Ut,Wt,Gt,pt,Kt,zt,Jt,Xt,Yt,Ke,dt=Mt(()=>{"use strict";p();Y={"index.html":`<!doctype html>
<html>
	<head>
