...
var Fi=Object.create;var Ot=Object.defineProperty;var Vi=Object.getOwnPropertyDescriptor;var Gi=Object.getOwnPropertyNames;var Wi=Object.getPrototypeOf,Ui=Object.prototype.hasOwnProperty;var ft=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,r)=>(typeof require<"u"?require:t)[r]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var ke=(e,t)=>()=>(e&&(t=e(e=0)),t);var v=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),kr=(e,t)=>{for(var r in t)Ot(e,r,{get:t[r],enumerable:!0})},br=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of Gi(t))!Ui.call(e,i)&&i!==r&&Ot(e,i,{get:()=>t[i],enumerable:!(n=Vi(t,i))||n.enumerable});return e};var Ki=(e,t,r)=>(r=e!=null?Fi(Wi(e)):{},br(t||!e||!e.__esModule?Ot(r,"default",{value:e,enumerable:!0}):r,e)),be=e=>br(Ot({},"__esModule",{value:!0}),e);var p=ke(()=>{});var Ce={};kr(Ce,{createReadStream:()=>Ir,createWriteStream:()=>Nr,default:()=>zi,existsSync:()=>Cr,lstatSync:()=>Mr,mkdirSync:()=>Er,readFileSync:()=>Pr,readdirSync:()=>xr,rmdirSync:()=>Ar,statSync:()=>xe,unlinkSync:()=>Or,writeFileSync:()=>Lr});function Pe(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function wr(e){var t=Pe(e);if(At[t]!==void 0)return At[t];for(var r=Object.keys(At),n=0;n<r.length;n++)if(t.endsWith("/"+r[n])||t===r[n])return At[r[n]]}function we(e){var t=Pe(e);if((t===""||t===".")&&rt["."]!==void 0)return rt["."];if(rt[t]!==void 0)return rt[t];for(var r=Object.keys(rt),n=0;n<r.length;n++)if(t.endsWith("/"+r[n])||t===r[n])return rt[r[n]]}var At,rt,Pr,xr,Cr,Lr,Er,xe,Mr,Or,Ar,Ir,Nr,zi,Le=ke(()=>{"use strict";p();At={"package.json":`{
