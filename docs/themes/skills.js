var ds=Object.create;var Re=Object.defineProperty;var gs=Object.getOwnPropertyDescriptor;var ms=Object.getOwnPropertyNames;var vs=Object.getPrototypeOf,bs=Object.prototype.hasOwnProperty;var we=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,n)=>(typeof require<"u"?require:t)[n]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+e+'" is not supported')});var ct=(e,t)=>()=>(e&&(t=e(e=0)),t);var _=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),hn=(e,t)=>{for(var n in t)Re(e,n,{get:t[n],enumerable:!0})},un=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of ms(t))!bs.call(e,s)&&s!==n&&Re(e,s,{get:()=>t[s],enumerable:!(i=gs(t,s))||i.enumerable});return e};var ys=(e,t,n)=>(n=e!=null?ds(vs(e)):{},un(t||!e||!e.__esModule?Re(n,"default",{value:e,enumerable:!0}):n,e)),pt=e=>un(Re({},"__esModule",{value:!0}),e);var m=ct(()=>{});var dt={};hn(dt,{createReadStream:()=>xn,createWriteStream:()=>Sn,default:()=>ks,existsSync:()=>mn,lstatSync:()=>yn,mkdirSync:()=>bn,readFileSync:()=>dn,readdirSync:()=>gn,rmdirSync:()=>wn,statSync:()=>ft,unlinkSync:()=>kn,writeFileSync:()=>vn});function ut(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function fn(e){var t=ut(e);if(Te[t]!==void 0)return Te[t];for(var n=Object.keys(Te),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return Te[n[i]]}function ht(e){var t=ut(e);if(Me[t]!==void 0)return Me[t];for(var n=Object.keys(Me),i=0;i<n.length;i++)if(t.endsWith("/"+n[i])||t===n[i])return Me[n[i]]}var Te,Me,dn,gn,mn,vn,bn,ft,yn,kn,wn,xn,Sn,ks,gt=ct(()=>{"use strict";m();Te={"package.json":`{
