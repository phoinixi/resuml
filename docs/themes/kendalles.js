...
var Ji=Object.create;var Me=Object.defineProperty;var Qi=Object.getOwnPropertyDescriptor;var Zi=Object.getOwnPropertyNames;var ji=Object.getPrototypeOf,ki=Object.prototype.hasOwnProperty;var It=(d,y)=>()=>(d&&(y=d(d=0)),y);var Fn=(d,y)=>()=>(y||d((y={exports:{}}).exports,y),y.exports),ns=(d,y)=>{for(var E in y)Me(d,E,{get:y[E],enumerable:!0})},Ut=(d,y,E,p)=>{if(y&&typeof y=="object"||typeof y=="function")for(let R of Zi(y))!ki.call(d,R)&&R!==E&&Me(d,R,{get:()=>y[R],enumerable:!(p=Qi(y,R))||p.enumerable});return d};var es=(d,y,E)=>(E=d!=null?Ji(ji(d)):{},Ut(y||!d||!d.__esModule?Me(E,"default",{value:d,enumerable:!0}):E,d)),ts=d=>Ut(Me({},"__esModule",{value:!0}),d);var q=It(()=>{});var Kt={};ns(Kt,{createReadStream:()=>Ot,createWriteStream:()=>Ht,default:()=>rs,existsSync:()=>Pt,lstatSync:()=>At,mkdirSync:()=>Lt,readFileSync:()=>Ft,readdirSync:()=>zt,rmdirSync:()=>Yt,statSync:()=>et,unlinkSync:()=>qt,writeFileSync:()=>Nt});function nt(d){return String(d).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Bt(d){var y=nt(d);if(Ie[y]!==void 0)return Ie[y];for(var E=Object.keys(Ie),p=0;p<E.length;p++)if(y.endsWith("/"+E[p])||y===E[p])return Ie[E[p]]}function ke(d){var y=nt(d);if((y===""||y===".")&&Zn["."]!==void 0)return Zn["."];if(Zn[y]!==void 0)return Zn[y];for(var E=Object.keys(Zn),p=0;p<E.length;p++)if(y.endsWith("/"+E[p])||y===E[p])return Zn[E[p]]}var Ie,Zn,Ft,zt,Pt,Nt,Lt,et,At,qt,Yt,Ot,Ht,rs,Vt=It(()=>{"use strict";q();Ie={"package.json":`{
