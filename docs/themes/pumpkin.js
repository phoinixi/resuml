var Go=Object.create;var ve=Object.defineProperty;var Ko=Object.getOwnPropertyDescriptor;var Jo=Object.getOwnPropertyNames;var Qo=Object.getPrototypeOf,Zo=Object.prototype.hasOwnProperty;var gi=(e,t)=>()=>(e&&(t=e(e=0)),t);var C=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Yo=(e,t)=>{for(var n in t)ve(e,n,{get:t[n],enumerable:!0})},vi=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of Jo(t))!Zo.call(e,s)&&s!==n&&ve(e,s,{get:()=>t[s],enumerable:!(r=Ko(t,s))||r.enumerable});return e};var Xo=(e,t,n)=>(n=e!=null?Go(Qo(e)):{},vi(t||!e||!e.__esModule?ve(n,"default",{value:e,enumerable:!0}):n,e)),jo=e=>vi(ve({},"__esModule",{value:!0}),e);var _=gi(()=>{});var Mi={};Yo(Mi,{createReadStream:()=>Ei,createWriteStream:()=>Li,default:()=>$o,existsSync:()=>ki,lstatSync:()=>Pi,mkdirSync:()=>bi,readFileSync:()=>_i,readdirSync:()=>Si,rmdirSync:()=>xi,statSync:()=>En,unlinkSync:()=>Ci,writeFileSync:()=>wi});function xn(e){return String(e).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function yi(e){var t=xn(e);if(ye[t]!==void 0)return ye[t];for(var n=Object.keys(ye),r=0;r<n.length;r++)if(t.endsWith("/"+n[r])||t===n[r])return ye[n[r]]}function Cn(e){var t=xn(e);if(_e[t]!==void 0)return _e[t];for(var n=Object.keys(_e),r=0;r<n.length;r++)if(t.endsWith("/"+n[r])||t===n[r])return _e[n[r]]}var ye,_e,_i,Si,ki,wi,bi,En,Pi,Ci,xi,Ei,Li,$o,Ai=gi(()=>{"use strict";_();ye={"package.json":`{
...
`+m+"}",x}function io(i,a,f){a=Kt(a);var d=a.length;if(!d)return G(f)?f.call(i):f;for(var g=0;g<d;g++){var m=i?.[a[g]];m===void 0&&(m=f,g=d),i=G(m)?m.call(i):m}return i}var so=0;function ao(i){var a=++so+"";return i?i+a:a}function oo(i){var a=A(i);return a._chain=!0,a}function Zr(i,a,f,d,g){if(!(d instanceof a))return i.apply(f,g);var m=Wr(i.prototype),y=i.apply(m,g);return Q(y)?y:m}var Ot=M(function(i,a){var f=Ot.placeholder,d=function(){for(var g=0,m=a.length,y=Array(m),k=0;k<m;k++)y[k]=a[k]===f?arguments[g++]:a[k];for(;g<arguments.length;)y.push(arguments[g++]);return Zr(i,d,this,this,y)};return d});Ot.placeholder=A;var Yr=M(function(i,a,f){if(!G(i))throw new TypeError("Bind must be called on a function");var d=M(function(g){return Zr(i,d,a,this,f.concat(g))});return d}),$=Mr(F);function Dt(i,a,f){!a&&a!==0&&(a=1/0);for(var d=[],g=0,m=0,y=F(i)||0,k=[];;){if(m>=y){if(!k.length)break;var x=k.pop();m=x.i,i=x.v,y=F(i);continue}var L=i[m++];k.length>=a?d[g++]=L:$(L)&&(St(L)||nn(L))?(k.push({i:m,v:i}),m=0,i=L,y=F(i)):f||(d[g++]=L)}return d}var lo=M(function(i,a){a=Dt(a,!1,!1);var f=a.length;if(f<1)throw new Error("bindAll must be passed function names");for(;f--;){var d=a[f];i[d]=Yr(i[d],i)}return i});function uo(i,a){var f=function(d){var g=f.cache,m=""+(a?a.apply(this,arguments):d);return gt(g,m)||(g[m]=i.apply(this,arguments)),g[m]};return f.cache={},f}var Xr=M(function(i,a,f){return setTimeout(function(){return i.apply(null,f)},a)}),co=Ot(Xr,A,1);function ho(i,a,f){var d,g,m,y,k=0;f||(f={});var x=function(){k=f.leading===!1?0:Zt(),d=null,y=i.apply(g,m),d||(g=m=null)},L=function(){var R=Zt();!k&&f.leading===!1&&(k=R);var K=a-(R-k);return g=this,m=arguments,K<=0||K>a?(d&&(clearTimeout(d),d=null),k=R,y=i.apply(g,m),d||(g=m=null)):!d&&f.trailing!==!1&&(d=setTimeout(x,K)),y};return L.cancel=function(){clearTimeout(d),k=0,d=g=m=null},L}function fo(i,a,f){var d,g,m,y,k,x=function(){var R=Zt()-g;a>R?d=setTimeout(x,a-R):(d=null,f||(y=i.apply(k,m)),d||(m=k=null))},L=M(function(R){return k=this,m=R,g=Zt(),d||(d=setTimeout(x,a),f&&(y=i.apply(k,m))),y});return L.cancel=function(){clearTimeout(d),d=m=k=null},L}function po(i,a){return Ot(a,i)}function mn(i){return function(){return!i.apply(this,arguments)}}function mo(){var i=arguments,a=i.length-1;return function(){for(var f=a,d=i[a].apply(this,arguments);f--;)d=i[f].call(this,d);return d}}function go(i,a){return function(){if(--i<1)return a.apply(this,arguments)}}function jr(i,a){var f;return function(){return--i>0&&(f=a.apply(this,arguments)),i<=1&&(a=null),f}}var vo=Ot(jr,2);function $r(i,a,f){a=Z(a,f);for(var d=q(i),g,m=0,y=d.length;m<y;m++)if(g=d[m],a(i[g],g,i))return g}function ti(i){return function(a,f,d){f=Z(f,d);for(var g=F(a),m=i>0?0:g-1;m>=0&&m<g;m+=i)if(f(a[m],m,a))return m;return-1}}var gn=ti(1),ei=ti(-1);function ni(i,a,f,d){f=Z(f,d,1);for(var g=f(a),m=0,y=F(i);m<y;){var k=Math.floor((m+y)/2);f(i[k])<g?m=k+1:y=k}return m}function ri(i,a,f){return function(d,g,m){var y=0,k=F(d);if(typeof m=="number")i>0?y=m>=0?m:Math.max(m+k,y):k=m>=0?Math.min(m+1,k):m+k+1;else if(f&&m&&k)return m=f(d,g),d[m]===g?m:-1;if(g!==g)return m=a(o.call(d,y,k),Er),m>=0?m+y:-1;for(m=i>0?y:k-1;m>=0&&m<k;m+=i)if(d[m]===g)return m;return-1}}var ii=ri(1,gn,ni),yo=ri(-1,ei);function vn(i,a,f){var d=$(i)?gn:$r,g=d(i,a,f);if(g!==void 0&&g!==-1)return i[g]}function _o(i,a){return vn(i,Jt(a))}function ct(i,a,f){a=Qt(a,f);var d,g;if($(i))for(d=0,g=i.length;d<g;d++)a(i[d],d,i);else{var m=q(i);for(d=0,g=m.length;d<g;d++)a(i[m[d]],m[d],i)}return i}function kt(i,a,f){a=Z(a,f);for(var d=!$(i)&&q(i),g=(d||i).length,m=Array(g),y=0;y<g;y++){var k=d?d[y]:y;m[y]=a(i[k],k,i)}return m}function si(i){var a=function(f,d,g,m){var y=!$(f)&&q(f),k=(y||f).length,x=i>0?0:k-1;for(m||(g=f[y?y[x]:x],x+=i);x>=0&&x<k;x+=i){var L=y?y[x]:x;g=d(g,f[L],L,f)}return g};return function(f,d,g,m){var y=arguments.length>=3;return a(f,Qt(d,m,4),g,y)}}var yn=si(1),ai=si(-1);function Nt(i,a,f){var d=[];return a=Z(a,f),ct(i,function(g,m,y){a(g,m,y)&&d.push(g)}),d}function So(i,a,f){return Nt(i,mn(Z(a)),f)}function oi(i,a,f){a=Z(a,f);for(var d=!$(i)&&q(i),g=(d||i).length,m=0;m<g;m++){var y=d?d[m]:m;if(!a(i[y],y,i))return!1}return!0}function li(i,a,f){a=Z(a,f);for(var d=!$(i)&&q(i),g=(d||i).length,m=0;m<g;m++){var y=d?d[m]:m;if(a(i[y],y,i))return!0}return!1}function ht(i,a,f,d){return $(i)||(i=At(i)),(typeof f!="number"||d)&&(f=0),ii(i,a,f)>=0}var ko=M(function(i,a,f){var d,g;return G(a)?g=a:(a=Kt(a),d=a.slice(0,-1),a=a[a.length-1]),kt(i,function(m){var y=g;if(!y){if(d&&d.length&&(m=un(m,d)),m==null)return;y=m[a]}return y==null?y:y.apply(m,f)})});function _n(i,a){return kt(i,hn(a))}function wo(i,a){return Nt(i,Jt(a))}function ui(i,a,f){var d=-1/0,g=-1/0,m,y;if(a==null||typeof a=="number"&&typeof i[0]!="object"&&i!=null){i=$(i)?i:At(i);for(var k=0,x=i.length;k<x;k++)m=i[k],m!=null&&m>d&&(d=m)}else a=Z(a,f),ct(i,function(L,R,K){y=a(L,R,K),(y>g||y===-1/0&&d===-1/0)&&(d=L,g=y)});return d}function bo(i,a,f){var d=1/0,g=1/0,m,y;if(a==null||typeof a=="number"&&typeof i[0]!="object"&&i!=null){i=$(i)?i:At(i);for(var k=0,x=i.length;k<x;k++)m=i[k],m!=null&&m<d&&(d=m)}else a=Z(a,f),ct(i,function(L,R,K){y=a(L,R,K),(y<g||y===1/0&&d===1/0)&&(d=L,g=y)});return d}var Po=/[^\ud800-\udfff]|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udfff]/g;function ci(i){return i?St(i)?o.call(i):X(i)?i.match(Po):$(i)?kt(i,cn):At(i):[]}function hi(i,a,f){if(a==null||f)return $(i)||(i=At(i)),i[pn(i.length-1)];var d=ci(i),g=F(d);a=Math.max(Math.min(a,g),0);for(var m=g-1,y=0;y<a;y++){var k=pn(y,m),x=d[y];d[y]=d[k],d[k]=x}return d.slice(0,a)}function Co(i){return hi(i,1/0)}function xo(i,a,f){var d=0;return a=Z(a,f),_n(kt(i,function(g,m,y){return{value:g,index:d++,criteria:a(g,m,y)}}).sort(function(g,m){var y=g.criteria,k=m.criteria;if(y!==k){if(y>k||y===void 0)return 1;if(y<k||k===void 0)return-1}return g.index-m.index}),"value")}function de(i,a){return function(f,d,g){var m=a?[[],[]]:{};return d=Z(d,g),ct(f,function(y,k){var x=d(y,k,f);i(m,y,x)}),m}}var Eo=de(function(i,a,f){gt(i,f)?i[f].push(a):i[f]=[a]}),Lo=de(function(i,a,f){i[f]=a}),Mo=de(function(i,a,f){gt(i,f)?i[f]++:i[f]=1}),Ao=de(function(i,a,f){i[f?0:1].push(a)},!0);function Oo(i){return i==null?0:$(i)?i.length:q(i).length}function Do(i,a,f){return a in f}var fi=M(function(i,a){var f={},d=a[0];if(i==null)return f;G(d)?(a.length>1&&(d=Qt(d,a[1])),a=Gt(i)):(d=Do,a=Dt(a,!1,!1),i=Object(i));for(var g=0,m=a.length;g<m;g++){var y=a[g],k=i[y];d(k,y,i)&&(f[y]=k)}return f}),No=M(function(i,a){var f=a[0],d;return G(f)?(f=mn(f),a.length>1&&(d=a[1])):(a=kt(Dt(a,!1,!1),String),f=function(g,m){return!ht(a,m)}),fi(i,f,d)});function pi(i,a,f){return o.call(i,0,Math.max(0,i.length-(a==null||f?1:a)))}function Sn(i,a,f){return i==null||i.length<1?a==null||f?void 0:[]:a==null||f?i[0]:pi(i,i.length-a)}function me(i,a,f){return o.call(i,a==null||f?1:a)}function Io(i,a,f){return i==null||i.length<1?a==null||f?void 0:[]:a==null||f?i[i.length-1]:me(i,Math.max(0,i.length-a))}function Ro(i){return Nt(i,Boolean)}function Bo(i,a){return Dt(i,a,!1)}var di=M(function(i,a){return a=Dt(a,!0,!0),Nt(i,function(f){return!ht(a,f)})}),To=M(function(i,a){return di(i,a)});function kn(i,a,f,d){zt(a)||(d=f,f=a,a=!1),f!=null&&(f=Z(f,d));for(var g=[],m=[],y=0,k=F(i);y<k;y++){var x=i[y],L=f?f(x,y,i):x;a&&!f?((!y||m!==L)&&g.push(x),m=L):f?ht(m,L)||(m.push(L),g.push(x)):ht(g,x)||g.push(x)}return g}var qo=M(function(i){return kn(Dt(i,!0,!0))});function Ho(i){for(var a=[],f=arguments.length,d=0,g=F(i);d<g;d++){var m=i[d];if(!ht(a,m)){var y;for(y=1;y<f&&ht(arguments[y],m);y++);y===f&&a.push(m)}}return a}function wn(i){for(var a=i&&ui(i,F).length||0,f=Array(a),d=0;d<a;d++)f[d]=_n(i,d);return f}var Fo=M(wn);function Vo(i,a){for(var f={},d=0,g=F(i);d<g;d++)a?f[i[d]]=a[d]:f[i[d][0]]=i[d][1];return f}function Wo(i,a,f){a==null&&(a=i||0,i=0),f||(f=a<i?-1:1);for(var d=Math.max(Math.ceil((a-i)/f),0),g=Array(d),m=0;m<d;m++,i+=f)g[m]=i;return g}function zo(i,a){if(a==null||a<1)return[];for(var f=[],d=0,g=i.length;d<g;)f.push(o.call(i,d,d+=a));return f}function bn(i,a){return i._chain?A(a).chain():a}function mi(i){return ct(on(i),function(a){var f=A[a]=i[a];A.prototype[a]=function(){var d=[this._wrapped];return l.apply(d,arguments),bn(this,f.apply(A,d))}}),A}ct(["pop","push","reverse","shift","sort","splice","unshift"],function(i){var a=n[i];A.prototype[i]=function(){var f=this._wrapped;return f!=null&&(a.apply(f,arguments),(i==="shift"||i==="splice")&&f.length===0&&delete f[0]),bn(this,f)}}),ct(["concat","join","slice"],function(i){var a=n[i];A.prototype[i]=function(){var f=this._wrapped;return f!=null&&(f=a.apply(f,arguments)),bn(this,f)}});var Uo={__proto__:null,VERSION:e,restArguments:M,isObject:Q,isNull:nt,isUndefined:T,isBoolean:zt,isElement:_t,isString:X,isNumber:rt,isDate:ce,isRegExp:Mt,isError:Ut,isSymbol:j,isArrayBuffer:br,isDataView:he,isArray:St,isFunction:G,isArguments:nn,isFinite:Ea,isNaN:Er,isTypedArray:Or,isEmpty:Da,isMatch:Nr,isEqual:Na,isMap:Ba,isWeakMap:Ta,isSet:qa,isWeakSet:Ha,keys:q,allKeys:Gt,values:At,pairs:Fa,invert:Hr,functions:on,methods:on,extend:Fr,extendOwn:pe,assign:pe,defaults:Vr,create:Wa,clone:za,tap:Ua,get:Ur,has:Ga,mapObject:Ka,identity:cn,constant:Lr,noop:Kr,toPath:zr,property:hn,propertyOf:Ja,matcher:Jt,matches:Jt,times:Qa,random:pn,now:Zt,escape:Za,unescape:Xa,templateSettings:ja,template:ro,result:io,uniqueId:ao,chain:oo,iteratee:fn,partial:Ot,bind:Yr,bindAll:lo,memoize:uo,delay:Xr,defer:co,throttle:ho,debounce:fo,wrap:po,negate:mn,compose:mo,after:go,before:jr,once:vo,findKey:$r,findIndex:gn,findLastIndex:ei,sortedIndex:ni,indexOf:ii,lastIndexOf:yo,find:vn,detect:vn,findWhere:_o,each:ct,forEach:ct,map:kt,collect:kt,reduce:yn,foldl:yn,inject:yn,reduceRight:ai,foldr:ai,filter:Nt,select:Nt,reject:So,every:oi,all:oi,some:li,any:li,contains:ht,includes:ht,include:ht,invoke:ko,pluck:_n,where:wo,max:ui,min:bo,shuffle:Co,sample:hi,sortBy:xo,groupBy:Eo,indexBy:Lo,countBy:Mo,partition:Ao,toArray:ci,size:Oo,pick:fi,omit:No,first:Sn,head:Sn,take:Sn,initial:pi,last:Io,rest:me,tail:me,drop:me,compact:Ro,flatten:Bo,without:To,uniq:kn,unique:kn,union:qo,intersection:Ho,difference:di,unzip:wn,transpose:wn,zip:Fo,object:Vo,range:Wo,chunk:zo,mixin:mi,default:A},Pn=mi(Uo);return Pn._=Pn,Pn}))});var wa=C((of,ka)=>{_();var Sa=(Ai(),jo(Mi)),$e=ga(),Vc=ya(),Wc=_a();ka.exports={render:zc};function zc(e){var t=Sa.readFileSync("//style.css","utf-8"),n=Sa.readFileSync("//resume.hbs","utf-8");return $e.compile(n)({css:t,resume:e})}$e.registerHelper("nl2br",function(e){return(e||"").replace(/\n/g,"</p><p>")});$e.registerHelper("formatDate",function(e,t){return e===null?"Present":Vc(e,t)});$e.registerHelper("everyNth",function(e,t,n){var r=n.fn,s=n.inverse,l="";if(e&&e.length>0)for(var o=0,c=e.length;o<c;o++){var h=o%t===0;l=l+r(Wc.extend({},e[o],{isModZero:h,isModZeroNotFirst:h&&o>0,isLast:o===e.length-1}))}else l=s(this);return l})});_();var Lt=Xo(wa(),1),ba=Lt.default??Lt,uf=ba.render??Lt.render,cf=ba.pdfRenderOptions??Lt.pdfRenderOptions;export{cf as pdfRenderOptions,uf as render};
