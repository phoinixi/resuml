var Ue=Object.create;var K=Object.defineProperty;var We=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var Ge=Object.getPrototypeOf,Je=Object.prototype.hasOwnProperty;var q=(n=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(e,t)=>(typeof require<"u"?require:e)[t]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var Tn=(n,e)=>()=>(n&&(e=n(n=0)),e);var m=(n,e)=>()=>(e||n((e={exports:{}}).exports,e),e.exports),ze=(n,e)=>{for(var t in e)K(n,t,{get:e[t],enumerable:!0})},Fn=(n,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of je(e))!Je.call(n,i)&&i!==t&&K(n,i,{get:()=>e[i],enumerable:!(s=We(e,i))||s.enumerable});return n};var Ke=(n,e,t)=>(t=n!=null?Ue(Ge(n)):{},Fn(e||!n||!n.__esModule?K(t,"default",{value:n,enumerable:!0}):t,n)),Vn=n=>Fn(K({},"__esModule",{value:!0}),n);var h=Tn(()=>{});var dn={};ze(dn,{createReadStream:()=>Yn,createWriteStream:()=>Xn,default:()=>Qe,existsSync:()=>jn,lstatSync:()=>zn,mkdirSync:()=>Jn,readFileSync:()=>Un,readdirSync:()=>Wn,rmdirSync:()=>Qn,statSync:()=>un,unlinkSync:()=>Kn,writeFileSync:()=>Gn});function hn(n){return String(n).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function qn(n){var e=hn(n);if(Q[e]!==void 0)return Q[e];for(var t=Object.keys(Q),s=0;s<t.length;s++)if(e.endsWith("/"+t[s])||e===t[s])return Q[t[s]]}function cn(n){var e=hn(n);if(Y[e]!==void 0)return Y[e];for(var t=Object.keys(Y),s=0;s<t.length;s++)if(e.endsWith("/"+t[s])||e===t[s])return Y[t[s]]}var Q,Y,Un,Wn,jn,Gn,Jn,un,zn,Kn,Qn,Yn,Xn,Qe,fn=Tn(()=>{"use strict";h();Q={"package.json":`{
