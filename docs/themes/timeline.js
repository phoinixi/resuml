...
var pi=Object.create;var zt=Object.defineProperty;var si=Object.getOwnPropertyDescriptor;var ci=Object.getOwnPropertyNames;var bi=Object.getPrototypeOf,hi=Object.prototype.hasOwnProperty;var Pt=(p,u)=>()=>(p&&(u=p(p=0)),u);var Gn=(p,u)=>()=>(u||p((u={exports:{}}).exports,u),u.exports),Ie=(p,u)=>{for(var A in u)zt(p,A,{get:u[A],enumerable:!0})},Ge=(p,u,A,G)=>{if(u&&typeof u=="object"||typeof u=="function")for(let I of ci(u))!hi.call(p,I)&&I!==A&&zt(p,I,{get:()=>u[I],enumerable:!(G=si(u,I))||G.enumerable});return p};var gi=(p,u,A)=>(A=p!=null?pi(bi(p)):{},Ge(u||!p||!p.__esModule?zt(A,"default",{value:p,enumerable:!0}):A,p)),Ne=p=>Ge(zt({},"__esModule",{value:!0}),p);var T=Pt(()=>{});var Fe={};Ie(Fe,{createReadStream:()=>Be,createWriteStream:()=>We,default:()=>fi,existsSync:()=>Ee,lstatSync:()=>Se,mkdirSync:()=>Ye,readFileSync:()=>Ze,readdirSync:()=>De,rmdirSync:()=>Ce,statSync:()=>Kt,unlinkSync:()=>Te,writeFileSync:()=>Ue});function _t(p){return String(p).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Re(p){var u=_t(p);if(qt[u]!==void 0)return qt[u];for(var A=Object.keys(qt),G=0;G<A.length;G++)if(u.endsWith("/"+A[G])||u===A[G])return qt[A[G]]}function Xt(p){var u=_t(p);if((u===""||u===".")&&Qn["."]!==void 0)return Qn["."];if(Qn[u]!==void 0)return Qn[u];for(var A=Object.keys(Qn),G=0;G<A.length;G++)if(u.endsWith("/"+A[G])||u===A[G])return Qn[A[G]]}var qt,Qn,Ze,De,Ee,Ue,Ye,Kt,Se,Te,Ce,Be,We,fi,Ve=Pt(()=>{"use strict";T();qt={"css/bootstrap.css":`
html {
...
*/`;try{var cn=V(i,"return "+y+Q).apply(p,l)}catch(hn){throw hn.source=y,hn}return t?cn(t):(cn.source=y,cn)}function ei(n,t,e){n=(n=+n)>-1?n:0;var o=-1,r=R(n);for(t=sn(t,e,1);++o<n;)r[o]=t(o);return r}function oi(n){return n==null?"":Zn(n).replace(Yo,Eo)}function ri(n){var t=++G;return Zn(n??"")+t}function ii(n){return n=new Sn(n),n.__chain__=!0,n}function ai(n,t){return t(n),n}function li(){return this.__chain__=!0,this}function di(){return Zn(this.__wrapped__)}function je(){return this.__wrapped__}return a.after=Ur,a.assign=vt,a.at=lr,a.bind=ze,a.bindAll=Yr,a.bindKey=Sr,a.chain=ii,a.compact=yr,a.compose=Tr,a.constant=Hr,a.countBy=dr,a.create=Bo,a.createCallback=Pr,a.curry=Cr,a.debounce=qe,a.defaults=Ct,a.defer=Br,a.delay=Wr,a.difference=wr,a.filter=yt,a.flatten=qr,a.forEach=ln,a.forEachRight=wt,a.forIn=In,a.forInRight=Vo,a.forOwn=J,a.forOwnRight=pe,a.functions=ot,a.groupBy=sr,a.indexBy=cr,a.initial=Mr,a.intersection=Ar,a.invert=se,a.invoke=br,a.keys=rn,a.map=it,a.mapValues=tr,a.max=ge,a.memoize=Fr,a.merge=er,a.min=hr,a.omit=or,a.once=Vr,a.pairs=rr,a.partial=Lr,a.partialRight=Qr,a.pick=ir,a.pluck=Ft,a.property=Ae,a.pull=Gr,a.range=Nr,a.reject=gr,a.remove=Rr,a.rest=Qt,a.shuffle=ue,a.sortBy=mr,a.tap=ai,a.throttle=Jr,a.times=ei,a.toArray=vr,a.transform=ar,a.union=Zr,a.uniq=ye,a.values=xt,a.where=xr,a.without=Dr,a.wrap=Or,a.xor=Er,a.zip=we,a.zipObject=ke,a.collect=it,a.drop=Qt,a.each=ln,a.eachRight=wt,a.extend=vt,a.methods=ot,a.object=ke,a.select=yt,a.tail=Qt,a.unique=ye,a.unzip=we,Ot(a),a.clone=To,a.cloneDeep=Co,a.contains=be,a.escape=Xr,a.every=he,a.find=Wt,a.findIndex=kr,a.findKey=Wo,a.findLast=pr,a.findLastIndex=zr,a.findLastKey=Fo,a.has=Lo,a.identity=Jt,a.indexOf=ve,a.isArguments=mt,a.isArray=K,a.isBoolean=Qo,a.isDate=Jo,a.isElement=Oo,a.isEmpty=Ho,a.isEqual=Po,a.isFinite=Xo,a.isFunction=P,a.isNaN=_o,a.isNull=Ko,a.isNumber=ce,a.isObject=an,a.isPlainObject=Bt,a.isRegExp=$o,a.isString=rt,a.isUndefined=nr,a.lastIndexOf=Ir,a.mixin=Ot,a.noConflict=_r,a.noop=Me,a.now=Tn,a.parseInt=Kr,a.random=$r,a.reduce=Vt,a.reduceRight=fe,a.result=ni,a.runInContext=Nt,a.size=ur,a.some=me,a.sortedIndex=xe,a.template=ti,a.unescape=oi,a.uniqueId=ri,a.all=he,a.any=me,a.detect=Wt,a.findWhere=Wt,a.foldl=Vt,a.foldr=fe,a.include=be,a.inject=Vt,Ot((function(){var n={};return J(a,function(t,e){a.prototype[e]||(n[e]=t)}),n})(),!1),a.first=Lt,a.last=jr,a.sample=fr,a.take=Lt,a.head=Lt,J(a,function(n,t){var e=t!=="sample";a.prototype[t]||(a.prototype[t]=function(o,r){var i=this.__chain__,l=n(this.__wrapped__,o,r);return!i&&(o==null||r&&!(e&&typeof o=="function"))?l:new Sn(l,i)})}),a.VERSION="2.4.2",a.prototype.chain=li,a.prototype.toString=di,a.prototype.value=je,a.prototype.valueOf=je,ln(["join","pop","shift"],function(n){var t=Fn[n];a.prototype[n]=function(){var e=this.__chain__,o=t.apply(this.__wrapped__,arguments);return e?new Sn(o,e):o}}),ln(["push","reverse","sort","unshift"],function(n){var t=Fn[n];a.prototype[n]=function(){return t.apply(this.__wrapped__,arguments),this}}),ln(["concat","slice","splice"],function(n){var t=Fn[n];a.prototype[n]=function(){return new Sn(t.apply(this.__wrapped__,arguments),this.__chain__)}}),a}var Rn=Nt();typeof define=="function"&&typeof define.amd=="object"&&define.amd?(C._=Rn,define(function(){return Rn})):O&&mn?Hn?(mn.exports=Rn)._=Rn:O._=Rn:C._=Rn}).call(Jn)});var no=Gn(st=>{T();(function(p,u){if(typeof st=="object"&&st)u(st);else{var A={};u(A),typeof define=="function"&&define.amd?define(A):p.Mustache=A}})(st,function(p){var u=RegExp.prototype.test;function A(v,x){return u.call(v,x)}var G=/\S/;function I(v){return!A(G,v)}var D=Object.prototype.toString,U=Array.isArray||function(v){return D.call(v)==="[object Array]"};function Y(v){return typeof v=="function"}function $(v){return v.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&")}var gn={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"};function fn(v){return String(v).replace(/[&<>"'\/]/g,function(x){return gn[x]})}function wn(v){if(!U(v)||v.length!==2)throw new Error("Invalid tags: "+v);return[new RegExp($(v[0])+"\\s*"),new RegExp("\\s*"+$(v[1]))]}var Mn=/\s*/,_=/\s+/,nn=/\s*=/,Bn=/\s*\}/,Nn=/#|\^|\/|>|\{|&|=|!/;function Un(v,x){x=x||p.tags,v=v||"",typeof x=="string"&&(x=x.split(_));var k=wn(x),d=new b(v),c=[],m=[],f=[],S=!1,Z=!1;function W(){if(S&&!Z)for(;f.length;)delete m[f.pop()];else f=[];S=!1,Z=!1}for(var un,C,O,mn,Hn,tn;!d.eos();){if(un=d.pos,O=d.scanUntil(k[0]),O)for(var kn=0,Wn=O.length;kn<Wn;++kn)mn=O.charAt(kn),I(mn)?f.push(m.length):Z=!0,m.push(["text",mn,un,un+1]),un+=1,mn===`
`&&W();if(!d.scan(k[0]))break;if(S=!0,C=d.scan(Nn)||"name",d.scan(Mn),C==="="?(O=d.scanUntil(nn),d.scan(nn),d.scanUntil(k[1])):C==="{"?(O=d.scanUntil(new RegExp("\\s*"+$("}"+x[1]))),d.scan(Bn),d.scanUntil(k[1]),C="&"):O=d.scanUntil(k[1]),!d.scan(k[1]))throw new Error("Unclosed tag at "+d.pos);if(Hn=[C,O,un,d.pos],m.push(Hn),C==="#"||C==="^")c.push(Hn);else if(C==="/"){if(tn=c.pop(),!tn)throw new Error('Unopened section "'+O+'" at '+un);if(tn[1]!==O)throw new Error('Unclosed section "'+tn[1]+'" at '+un)}else C==="name"||C==="{"||C==="&"?Z=!0:C==="="&&(k=wn(x=O.split(_)))}if(tn=c.pop(),tn)throw new Error('Unclosed section "'+tn[1]+'" at '+d.pos);return Yn(On(m))}function On(v){for(var x=[],k,d,c=0,m=v.length;c<m;++c)k=v[c],k&&(k[0]==="text"&&d&&d[0]==="text"?(d[1]+=k[1],d[3]=k[3]):(x.push(k),d=k));return x}function Yn(v){for(var x=[],k=x,d=[],c,m,f=0,S=v.length;f<S;++f)switch(c=v[f],c[0]){case"#":case"^":k.push(c),d.push(c),k=c[4]=[];break;case"/":m=d.pop(),m[5]=c[2],k=d.length>0?d[d.length-1][4]:x;break;default:k.push(c)}return x}function b(v){this.string=v,this.tail=v,this.pos=0}b.prototype.eos=function(){return this.tail===""},b.prototype.scan=function(v){var x=this.tail.match(v);if(x&&x.index===0){var k=x[0];return this.tail=this.tail.substring(k.length),this.pos+=k.length,k}return""},b.prototype.scanUntil=function(v){var x=this.tail.search(v),k;switch(x){case-1:k=this.tail,this.tail="";break;case 0:k="";break;default:k=this.tail.substring(0,x),this.tail=this.tail.substring(x)}return this.pos+=k.length,k};function q(v,x){this.view=v??{},this.cache={".":this.view},this.parent=x}q.prototype.push=function(v){return new q(v,this)},q.prototype.lookup=function(v){var x;if(v in this.cache)x=this.cache[v];else{for(var k=this;k;){if(v.indexOf(".")>0){x=k.view;for(var d=v.split("."),c=0;x!=null&&c<d.length;)x=x[d[c++]]}else x=k.view[v];if(x!=null)break;k=k.parent}this.cache[v]=x}return Y(x)&&(x=x.call(this.view)),x};function h(){this.cache={}}h.prototype.clearCache=function(){this.cache={}},h.prototype.parse=function(v,x){var k=this.cache,d=k[v];return d==null&&(d=k[v]=Un(v,x)),d},h.prototype.render=function(v,x,k){var d=this.parse(v),c=x instanceof q?x:new q(x);return this.renderTokens(d,c,k,v)},h.prototype.renderTokens=function(v,x,k,d){var c="",m=this;function f(mn){return m.render(mn,x,k)}for(var S,Z,W=0,un=v.length;W<un;++W)switch(S=v[W],S[0]){case"#":if(Z=x.lookup(S[1]),!Z)continue;if(U(Z))for(var C=0,O=Z.length;C<O;++C)c+=this.renderTokens(S[4],x.push(Z[C]),k,d);else if(typeof Z=="object"||typeof Z=="string")c+=this.renderTokens(S[4],x.push(Z),k,d);else if(Y(Z)){if(typeof d!="string")throw new Error("Cannot use higher-order sections without the original template");Z=Z.call(x.view,d.slice(S[3],S[5]),f),Z!=null&&(c+=Z)}else c+=this.renderTokens(S[4],x,k,d);break;case"^":Z=x.lookup(S[1]),(!Z||U(Z)&&Z.length===0)&&(c+=this.renderTokens(S[4],x,k,d));break;case">":if(!k)continue;Z=Y(k)?k(S[1]):k[S[1]],Z!=null&&(c+=this.renderTokens(this.parse(Z),x,k,Z));break;case"&":Z=x.lookup(S[1]),Z!=null&&(c+=Z);break;case"name":Z=x.lookup(S[1]),Z!=null&&(c+=p.escape(Z));break;case"text":c+=S[1];break}return c},p.name="mustache.js",p.version="0.8.1",p.tags=["{{","}}"];var N=new h;p.clearCache=function(){return N.clearCache()},p.parse=function(v,x){return N.parse(v,x)},p.render=function(v,x,k){return N.render(v,x,k)},p.to_html=function(v,x,k,d){var c=p.render(v,x,k);if(Y(d))d(c);else return c},p.escape=fn,p.Scanner=b,p.Context=q,p.Writer=h})});var eo=Gn((to,jt)=>{T();(function(p){"use strict";function u(b,q){var h=(b&65535)+(q&65535),N=(b>>16)+(q>>16)+(h>>16);return N<<16|h&65535}function A(b,q){return b<<q|b>>>32-q}function G(b,q,h,N,v,x){return u(A(u(u(q,b),u(N,x)),v),h)}function I(b,q,h,N,v,x,k){return G(q&h|~q&N,b,q,v,x,k)}function D(b,q,h,N,v,x,k){return G(q&N|h&~N,b,q,v,x,k)}function U(b,q,h,N,v,x,k){return G(q^h^N,b,q,v,x,k)}function Y(b,q,h,N,v,x,k){return G(h^(q|~N),b,q,v,x,k)}function $(b,q){b[q>>5]|=128<<q%32,b[(q+64>>>9<<4)+14]=q;var h,N,v,x,k,d=1732584193,c=-271733879,m=-1732584194,f=271733878;for(h=0;h<b.length;h+=16)N=d,v=c,x=m,k=f,d=I(d,c,m,f,b[h],7,-680876936),f=I(f,d,c,m,b[h+1],12,-389564586),m=I(m,f,d,c,b[h+2],17,606105819),c=I(c,m,f,d,b[h+3],22,-1044525330),d=I(d,c,m,f,b[h+4],7,-176418897),f=I(f,d,c,m,b[h+5],12,1200080426),m=I(m,f,d,c,b[h+6],17,-1473231341),c=I(c,m,f,d,b[h+7],22,-45705983),d=I(d,c,m,f,b[h+8],7,1770035416),f=I(f,d,c,m,b[h+9],12,-1958414417),m=I(m,f,d,c,b[h+10],17,-42063),c=I(c,m,f,d,b[h+11],22,-1990404162),d=I(d,c,m,f,b[h+12],7,1804603682),f=I(f,d,c,m,b[h+13],12,-40341101),m=I(m,f,d,c,b[h+14],17,-1502002290),c=I(c,m,f,d,b[h+15],22,1236535329),d=D(d,c,m,f,b[h+1],5,-165796510),f=D(f,d,c,m,b[h+6],9,-1069501632),m=D(m,f,d,c,b[h+11],14,643717713),c=D(c,m,f,d,b[h],20,-373897302),d=D(d,c,m,f,b[h+5],5,-701558691),f=D(f,d,c,m,b[h+10],9,38016083),m=D(m,f,d,c,b[h+15],14,-660478335),c=D(c,m,f,d,b[h+4],20,-405537848),d=D(d,c,m,f,b[h+9],5,568446438),f=D(f,d,c,m,b[h+14],9,-1019803690),m=D(m,f,d,c,b[h+3],14,-187363961),c=D(c,m,f,d,b[h+8],20,1163531501),d=D(d,c,m,f,b[h+13],5,-1444681467),f=D(f,d,c,m,b[h+2],9,-51403784),m=D(m,f,d,c,b[h+7],14,1735328473),c=D(c,m,f,d,b[h+12],20,-1926607734),d=U(d,c,m,f,b[h+5],4,-378558),f=U(f,d,c,m,b[h+8],11,-2022574463),m=U(m,f,d,c,b[h+11],16,1839030562),c=U(c,m,f,d,b[h+14],23,-35309556),d=U(d,c,m,f,b[h+1],4,-1530992060),f=U(f,d,c,m,b[h+4],11,1272893353),m=U(m,f,d,c,b[h+7],16,-155497632),c=U(c,m,f,d,b[h+10],23,-1094730640),d=U(d,c,m,f,b[h+13],4,681279174),f=U(f,d,c,m,b[h],11,-358537222),m=U(m,f,d,c,b[h+3],16,-722521979),c=U(c,m,f,d,b[h+6],23,76029189),d=U(d,c,m,f,b[h+9],4,-640364487),f=U(f,d,c,m,b[h+12],11,-421815835),m=U(m,f,d,c,b[h+15],16,530742520),c=U(c,m,f,d,b[h+2],23,-995338651),d=Y(d,c,m,f,b[h],6,-198630844),f=Y(f,d,c,m,b[h+7],10,1126891415),m=Y(m,f,d,c,b[h+14],15,-1416354905),c=Y(c,m,f,d,b[h+5],21,-57434055),d=Y(d,c,m,f,b[h+12],6,1700485571),f=Y(f,d,c,m,b[h+3],10,-1894986606),m=Y(m,f,d,c,b[h+10],15,-1051523),c=Y(c,m,f,d,b[h+1],21,-2054922799),d=Y(d,c,m,f,b[h+8],6,1873313359),f=Y(f,d,c,m,b[h+15],10,-30611744),m=Y(m,f,d,c,b[h+6],15,-1560198380),c=Y(c,m,f,d,b[h+13],21,1309151649),d=Y(d,c,m,f,b[h+4],6,-145523070),f=Y(f,d,c,m,b[h+11],10,-1120210379),m=Y(m,f,d,c,b[h+2],15,718787259),c=Y(c,m,f,d,b[h+9],21,-343485551),d=u(d,N),c=u(c,v),m=u(m,x),f=u(f,k);return[d,c,m,f]}function gn(b){var q,h="",N=b.length*32;for(q=0;q<N;q+=8)h+=String.fromCharCode(b[q>>5]>>>q%32&255);return h}function fn(b){var q,h=[];for(h[(b.length>>2)-1]=void 0,q=0;q<h.length;q+=1)h[q]=0;var N=b.length*8;for(q=0;q<N;q+=8)h[q>>5]|=(b.charCodeAt(q/8)&255)<<q%32;return h}function wn(b){return gn($(fn(b),b.length*8))}function Mn(b,q){var h,N=fn(b),v=[],x=[],k;for(v[15]=x[15]=void 0,N.length>16&&(N=$(N,b.length*8)),h=0;h<16;h+=1)v[h]=N[h]^909522486,x[h]=N[h]^1549556828;return k=$(v.concat(fn(q)),512+q.length*8),gn($(x.concat(k),640))}function _(b){var q="0123456789abcdef",h="",N,v;for(v=0;v<b.length;v+=1)N=b.charCodeAt(v),h+=q.charAt(N>>>4&15)+q.charAt(N&15);return h}function nn(b){return unescape(encodeURIComponent(b))}function Bn(b){return wn(nn(b))}function Nn(b){return _(Bn(b))}function Un(b,q){return Mn(nn(b),nn(q))}function On(b,q){return _(Un(b,q))}function Yn(b,q,h){return q?h?Un(q,b):On(q,b):h?Bn(b):Nn(b)}typeof define=="function"&&define.amd?define(function(){return Yn}):typeof jt=="object"&&jt.exports?jt.exports=Yn:p.md5=Yn})(to)});var ro=Gn((Ei,oo)=>{"use strict";T();function mi(p,u){return Object.prototype.hasOwnProperty.call(p,u)}oo.exports=function(p,u,A,G){u=u||"&",A=A||"=";var I={};if(typeof p!="string"||p.length===0)return I;var D=/\+/g;p=p.split(u);var U=1e3;G&&typeof G.maxKeys=="number"&&(U=G.maxKeys);var Y=p.length;U>0&&Y>U&&(Y=U);for(var $=0;$<Y;++$){var gn=p[$].replace(D,"%20"),fn=gn.indexOf(A),wn,Mn,_,nn;fn>=0?(wn=gn.substr(0,fn),Mn=gn.substr(fn+1)):(wn=gn,Mn=""),_=decodeURIComponent(wn),nn=decodeURIComponent(Mn),mi(I,_)?Array.isArray(I[_])?I[_].push(nn):I[_]=[I[_],nn]:I[_]=nn}return I}});var ao=Gn((Yi,io)=>{"use strict";T();var ct=function(p){switch(typeof p){case"string":return p;case"boolean":return p?"true":"false";case"number":return isFinite(p)?p:"";default:return""}};io.exports=function(p,u,A,G){return u=u||"&",A=A||"=",p===null&&(p=void 0),typeof p=="object"?Object.keys(p).map(function(I){var D=encodeURIComponent(ct(I))+A;return Array.isArray(p[I])?p[I].map(function(U){return D+encodeURIComponent(ct(U))}).join(u):D+encodeURIComponent(ct(p[I]))}).join(u):G?encodeURIComponent(ct(G))+A+encodeURIComponent(ct(p)):""}});var lo=Gn(bt=>{"use strict";T();bt.decode=bt.parse=ro();bt.encode=bt.stringify=ao()});var ho=Gn((Wi,bo)=>{T();var vi=eo(),xi=lo(),yi=/^[0-9a-f]{32}$/;function wi(p){var u={},A={protocol:1,format:1};for(var G in p)A[G]||(u[G]=p[G]);return u}function po(p,u){if(p)return typeof p.protocol=="boolean"?p.protocol:p.protocol==="http"?!1:p.protocol==="https"?!0:void 0}function so(p){return p=typeof p=="string"?p.trim().toLowerCase():"unspecified",p.match(yi)?p:vi(p)}function co(p){var u=xi.stringify(wi(p));return u&&"?"+u||""}var Bi=bo.exports={url:function(p,u,A){var G="//www.gravatar.com/avatar/";u&&u.cdn?(G=u.cdn+"/avatar/",delete u.cdn):(u&&u.protocol&&(A=po(u)),typeof A<"u"&&(G=A?"https://s.gravatar.com/avatar/":"http://www.gravatar.com/avatar/"));var I=co(u);return G+so(p)+I},profile_url:function(p,u,A){var G=u!=null&&u.format!=null?String(u.format):"json",I;if(u&&u.cdn)I=u.cdn+"/",delete u.cdn;else{u&&u.protocol&&(A=po(u));var I=A&&"https://secure.gravatar.com/"||"http://www.gravatar.com/"}var D=co(u);return I+so(p)+"."+G+D}}});var fo=Gn((Vi,go)=>{T();go.exports=ho()});var xo=Gn((Ji,vo)=>{T();var uo=(Ve(),Ne(Fe)),mo=(Ke(),Ne(_e)),Qi=$e(),ki=no(),zi=fo();function qi(p){var u=uo.readFileSync(mo.resolve("/","css","theme.css"),"utf8"),A=uo.readFileSync(mo.resolve("/","index.html"),"utf8");p.bio&&p.bio.email&&p.bio.email.personal&&(p.bio.gravatar=zi.url(p.bio.email.personal,{s:"200",r:"pg",d:"mm"}));var G=ki.render(A,{resume:p,csstheme:u});return G}vo.exports={render:qi}});T();var Cn=gi(xo(),1),yo=Cn.default??Cn,Hi=yo.render??Cn.render,Pi=yo.pdfRenderOptions??Cn.pdfRenderOptions;export{Pi as pdfRenderOptions,Hi as render};
