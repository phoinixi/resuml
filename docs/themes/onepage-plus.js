...
var tr=Object.create;var Y=Object.defineProperty;var er=Object.getOwnPropertyDescriptor;var rr=Object.getOwnPropertyNames;var nr=Object.getPrototypeOf,ir=Object.prototype.hasOwnProperty;var j=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,r)=>(typeof require<"u"?require:e)[r]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var ut=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Wt=(t,e)=>{for(var r in e)Y(t,r,{get:e[r],enumerable:!0})},zt=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of rr(e))!ir.call(t,i)&&i!==r&&Y(t,i,{get:()=>e[i],enumerable:!(n=er(e,i))||n.enumerable});return t};var sr=(t,e,r)=>(r=t!=null?tr(nr(t)):{},zt(e||!t||!t.__esModule?Y(r,"default",{value:t,enumerable:!0}):r,t)),ft=t=>zt(Y({},"__esModule",{value:!0}),t);var p=ut(()=>{});var vt={};Wt(vt,{createReadStream:()=>ee,createWriteStream:()=>re,default:()=>ar,existsSync:()=>Yt,lstatSync:()=>Zt,mkdirSync:()=>Qt,readFileSync:()=>Kt,readdirSync:()=>Jt,rmdirSync:()=>te,statSync:()=>gt,unlinkSync:()=>$t,writeFileSync:()=>Xt});function mt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Gt(t){var e=mt(t);if(X[e]!==void 0)return X[e];for(var r=Object.keys(X),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return X[r[n]]}function dt(t){var e=mt(t);if((e===""||e===".")&&M["."]!==void 0)return M["."];if(M[e]!==void 0)return M[e];for(var r=Object.keys(M),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return M[r[n]]}var X,M,Kt,Jt,Yt,Xt,Qt,gt,Zt,$t,te,ee,re,ar,kt=ut(()=>{"use strict";p();X={"package.json":`{\r
