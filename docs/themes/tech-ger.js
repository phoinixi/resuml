...
var gi=Object.create;var Ee=Object.defineProperty;var mi=Object.getOwnPropertyDescriptor;var vi=Object.getOwnPropertyNames;var _i=Object.getPrototypeOf,yi=Object.prototype.hasOwnProperty;var or=(t,e)=>()=>(t&&(e=t(t=0)),e);var v=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Si=(t,e)=>{for(var r in e)Ee(t,r,{get:e[r],enumerable:!0})},lr=(t,e,r,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of vi(e))!yi.call(t,i)&&i!==r&&Ee(t,i,{get:()=>e[i],enumerable:!(n=mi(e,i))||n.enumerable});return t};var ki=(t,e,r)=>(r=t!=null?gi(_i(t)):{},lr(e||!t||!t.__esModule?Ee(r,"default",{value:t,enumerable:!0}):r,t)),bi=t=>lr(Ee({},"__esModule",{value:!0}),t);var p=or(()=>{});var Sr={};Si(Sr,{createReadStream:()=>_r,createWriteStream:()=>yr,default:()=>Ci,existsSync:()=>pr,lstatSync:()=>gr,mkdirSync:()=>dr,readFileSync:()=>cr,readdirSync:()=>hr,rmdirSync:()=>vr,statSync:()=>ft,unlinkSync:()=>mr,writeFileSync:()=>fr});function pt(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function ur(t){var e=pt(t);if(Le[e]!==void 0)return Le[e];for(var r=Object.keys(Le),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return Le[r[n]]}function ht(t){var e=pt(t);if((e===""||e===".")&&te["."]!==void 0)return te["."];if(te[e]!==void 0)return te[e];for(var r=Object.keys(te),n=0;n<r.length;n++)if(e.endsWith("/"+r[n])||e===r[n])return te[r[n]]}var Le,te,cr,hr,pr,fr,dr,ft,gr,mr,vr,_r,yr,Ci,kr=or(()=>{"use strict";p();Le={"package.json":`{
