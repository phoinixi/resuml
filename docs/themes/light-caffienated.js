var Vi=Object.create;var xe=Object.defineProperty;var Yi=Object.getOwnPropertyDescriptor;var Zi=Object.getOwnPropertyNames;var ki=Object.getPrototypeOf,nf=Object.prototype.hasOwnProperty;var Ot=(l,v)=>()=>(l&&(v=l(l=0)),v);var On=(l,v)=>()=>(v||l((v={exports:{}}).exports,v),v.exports),ef=(l,v)=>{for(var S in v)xe(l,S,{get:v[S],enumerable:!0})},Rt=(l,v,S,D)=>{if(v&&typeof v=="object"||typeof v=="function")for(let R of Zi(v))!nf.call(l,R)&&R!==S&&xe(l,R,{get:()=>v[R],enumerable:!(D=Yi(v,R))||D.enumerable});return l};var tf=(l,v,S)=>(S=l!=null?Vi(ki(l)):{},Rt(v||!l||!l.__esModule?xe(S,"default",{value:l,enumerable:!0}):S,l)),rf=l=>Rt(xe({},"__esModule",{value:!0}),l);var A=Ot(()=>{});var At={};ef(At,{createReadStream:()=>zt,createWriteStream:()=>Nt,default:()=>ff,existsSync:()=>Tt,lstatSync:()=>Mt,mkdirSync:()=>It,readFileSync:()=>St,readdirSync:()=>Ft,rmdirSync:()=>Pt,statSync:()=>Je,unlinkSync:()=>Ut,writeFileSync:()=>jt});function Qe(l){return String(l).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Dt(l){var v=Qe(l);if(Ce[v]!==void 0)return Ce[v];for(var S=Object.keys(Ce),D=0;D<S.length;D++)if(v.endsWith("/"+S[D])||v===S[D])return Ce[S[D]]}function Ge(l){var v=Qe(l);if(Ee[v]!==void 0)return Ee[v];for(var S=Object.keys(Ee),D=0;D<S.length;D++)if(v.endsWith("/"+S[D])||v===S[D])return Ee[S[D]]}var Ce,Ee,St,Ft,Tt,jt,It,Je,Mt,Ut,Pt,zt,Nt,ff,qt=Ot(()=>{"use strict";A();Ce={"package.json":`{
