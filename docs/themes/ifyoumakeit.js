var Be=Object.create;var J=Object.defineProperty;var Ve=Object.getOwnPropertyDescriptor;var Fe=Object.getOwnPropertyNames;var ze=Object.getPrototypeOf,je=Object.prototype.hasOwnProperty;var F=(t=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(t,{get:(e,n)=>(typeof require<"u"?require:e)[n]}):t)(function(t){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+t+'" is not supported')});var Tt=(t,e)=>()=>(t&&(e=t(t=0)),e);var m=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),We=(t,e)=>{for(var n in e)J(t,n,{get:e[n],enumerable:!0})},qt=(t,e,n,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Fe(e))!je.call(t,s)&&s!==n&&J(t,s,{get:()=>e[s],enumerable:!(i=Ve(e,s))||i.enumerable});return t};var Ue=(t,e,n)=>(n=t!=null?Be(ze(t)):{},qt(e||!t||!t.__esModule?J(n,"default",{value:t,enumerable:!0}):n,t)),Bt=t=>qt(J({},"__esModule",{value:!0}),t);var u=Tt(()=>{});var pt={};We(pt,{createReadStream:()=>Yt,createWriteStream:()=>Zt,default:()=>Ge,existsSync:()=>jt,lstatSync:()=>Gt,mkdirSync:()=>Ut,readFileSync:()=>Ft,readdirSync:()=>zt,rmdirSync:()=>Jt,statSync:()=>ut,unlinkSync:()=>Kt,writeFileSync:()=>Wt});function ht(t){return String(t).replace(/[\\]+/g,"/").replace(/^\/+/,"")}function Vt(t){var e=ht(t);if(Y[e]!==void 0)return Y[e];for(var n=Object.keys(Y),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Y[n[i]]}function ct(t){var e=ht(t);if(Z[e]!==void 0)return Z[e];for(var n=Object.keys(Z),i=0;i<n.length;i++)if(e.endsWith("/"+n[i])||e===n[i])return Z[n[i]]}var Y,Z,Ft,zt,jt,Wt,Ut,ut,Gt,Kt,Jt,Yt,Zt,Ge,ft=Tt(()=>{"use strict";u();Y={"index.html":`
<!doctype html>
<html>
	<head>
